module tt_um_mng2_2ncos (clk,
 ...
 sky130_fd_sc_hd__inv_2 _0734_ (.A(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0014_));
 sky130_fd_sc_hd__inv_2 _0735_ (.A(\inst_sine_B.phase[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0736_ (.A(net49),
    ...
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__inv_2 _0737_ (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__inv_2 _0738_ (.A(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0094_));
 sky130_fd_sc_hd__xor2_2 _0739_ (.A(net31),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__xnor2_2 _0740_ (.A(net31),
    .B(\inst_sine_A.phase[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0096_));
 sky130_fd_sc_hd__xor2_2 _0741_ (.A(net31),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__xnor2_2 _0742_ (.A(net32),
    .B(\inst_sine_A.phase[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0098_));
 sky130_fd_sc_hd__xor2_2 _0743_ (.A(net31),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__xnor2_2 _0744_ (.A(net32),
    .B(\inst_sine_A.phase[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__xnor2_2 _0745_ (.A(net32),
    ...
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__inv_2 _0746_ (.A(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__xnor2_2 _0747_ (.A(net32),
 ...
 sky130_fd_sc_hd__nor2_2 _0748_ (.A(_0102_),
    ...
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__xnor2_2 _0749_ (.A(net30),
    ...
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__inv_2 _0750_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__nor2_2 _0751_ (.A(_0101_),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__a21o_2 _0752_ (.A1(net26),
    .A2(_0106_),
    .B1(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__nor2_2 _0753_ (.A(net27),
    .B(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__nor2_2 _0754_ (.A(_0101_),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__or2_2 _0755_ (.A(_0101_),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__or2_2 _0756_ (.A(_0099_),
    .B(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__nor2_2 _0757_ (.A(_0110_),
    .B(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__a21oi_2 _0758_ (.A1(_0102_),
    .A2(net25),
    .B1(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__o21ai_2 _0759_ (.A1(_0113_),
    .A2(_0114_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__or2_2 _0760_ (.A(net29),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__nand2_2 _0761_ (.A(_0101_),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__or3b_2 _0762_ (.A(_0104_),
    .B(_0110_),
    .C_N(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__o2111a_2 _0763_ (.A1(net25),
    .A2(_0112_),
    .B1(_0118_),
    .C1(net29),
    .D1(_0096_),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__a21o_2 _0764_ (.A1(_0099_),
    .A2(_0103_),
    .B1(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0120_));
 sky130_fd_sc_hd__nor2_2 _0765_ (.A(_0095_),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__a32o_2 _0766_ (.A1(_0095_),
    .A2(_0115_),
    .A3(_0116_),
    .B1(_0120_),
    .B2(_0121_),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__nor2_2 _0767_ (.A(_0119_),
    .B(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _0768_ (.A(net119),
    .B(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__or3_2 _0769_ (.A(\product[8] ),
    .B(\product[7] ),
    .C(net89),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__o21ai_2 _0770_ (.A1(\product[8] ),
    .A2(net83),
    .B1(net89),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__nand2_2 _0771_ (.A(_0123_),
    .B(net90),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__or2_2 _0772_ (.A(\product[10] ),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__nand2_2 _0773_ (.A(net114),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__nand2_2 _0774_ (.A(_0125_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0017_));
 sky130_fd_sc_hd__xnor2_2 _0775_ (.A(net118),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__or3_2 _0776_ (.A(\product[11] ),
    .B(\product[12] ),
    .C(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__o21ai_2 _0777_ (.A1(\product[11] ),
    .A2(_0125_),
    .B1(net84),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__nand2_2 _0778_ (.A(_0127_),
    .B(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0019_));
 sky130_fd_sc_hd__nor2_2 _0779_ (.A(\product[13] ),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__nand2_2 _0780_ (.A(net117),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__nand2b_2 _0781_ (.A_N(_0129_),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__xnor2_2 _0782_ (.A(net87),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__a22o_2 _0783_ (.A1(\sine_Areg[0] ),
    .A2(net48),
    .B1(net50),
    .B2(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__nand2_2 _0784_ (.A(\sine_Areg[0] ),
    .B(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__nand2_2 _0785_ (.A(net46),
    .B(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__nor2_2 _0786_ (.A(_0132_),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__o21ai_2 _0787_ (.A1(_0132_),
    .A2(_0133_),
    .B1(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__nand2_2 _0788_ (.A(net41),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__and4_2 _0789_ (.A(net45),
    .B(net52),
    .C(net43),
    .D(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__a22oi_2 _0790_ (.A1(net45),
    .A2(net52),
    .B1(net43),
    .B2(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__nor2_2 _0791_ (.A(_0137_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__xnor2_2 _0792_ (.A(_0136_),
    .B(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0140_));
 sky130_fd_sc_hd__nand2b_2 _0793_ (.A_N(_0135_),
    .B(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__xor2_2 _0794_ (.A(_0135_),
    .B(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__and2_2 _0795_ (.A(net43),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__nand4_2 _0796_ (.A(net46),
    .B(net45),
    .C(net52),
    .D(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__a22o_2 _0797_ (.A1(net46),
    .A2(net52),
    .B1(net54),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__nand2_2 _0798_ (.A(_0144_),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__xnor2_2 _0799_ (.A(_0143_),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__nand2b_2 _0800_ (.A_N(_0132_),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__or2_2 _0801_ (.A(_0142_),
    .B(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__xnor2_2 _0802_ (.A(_0142_),
    .B(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__and4_2 _0803_ (.A(net42),
    .B(net40),
    .C(net56),
    .D(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__a21bo_2 _0804_ (.A1(_0143_),
    .A2(_0145_),
    .B1_N(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__a22o_2 _0805_ (.A1(net40),
    .A2(net56),
    .B1(net38),
    .B2(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__and4_2 _0806_ (.A(net40),
    .B(net56),
    .C(net38),
    .D(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__inv_2 _0807_ (.A(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__and3_2 _0808_ (.A(_0152_),
    .B(_0153_),
    .C(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__a21oi_2 _0809_ (.A1(_0153_),
    .A2(_0155_),
    .B1(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__nor2_2 _0810_ (.A(_0156_),
    .B(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__xnor2_2 _0811_ (.A(_0151_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__xnor2_2 _0812_ (.A(_0150_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_2 _0813_ (.A(_0132_),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__inv_2 _0814_ (.A(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__and4_2 _0815_ (.A(net44),
    .B(net42),
    .C(net56),
    .D(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__nand4_2 _0816_ (.A(net44),
    .B(net42),
    .C(net56),
    .D(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__and4_2 _0817_ (.A(\sine_Areg[0] ),
    .B(net46),
    .C(net52),
    .D(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__nand2_2 _0818_ (.A(\sine_Areg[2] ),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__a22o_2 _0819_ (.A1(\sine_Areg[0] ),
    .A2(net52),
    .B1(net54),
    .B2(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__nand2b_2 _0820_ (.A_N(_0165_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0168_));
 sky130_fd_sc_hd__a31o_2 _0821_ (.A1(\sine_Areg[2] ),
    .A2(net55),
    .A3(_0167_),
    .B1(_0165_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__a22oi_2 _0822_ (.A1(net42),
    .A2(net57),
    .B1(net59),
    .B2(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__nor2_2 _0823_ (.A(_0151_),
    .B(_0170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__nand2_2 _0824_ (.A(_0169_),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0172_));
 sky130_fd_sc_hd__or2_2 _0825_ (.A(_0169_),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__and2_2 _0826_ (.A(_0172_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__xnor2_2 _0827_ (.A(_0163_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__nor2_2 _0828_ (.A(_0162_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__a21bo_2 _0829_ (.A1(_0163_),
    .A2(_0173_),
    .B1_N(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__xnor2_2 _0830_ (.A(_0160_),
    .B(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__nand2_2 _0831_ (.A(_0177_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__o31a_2 _0832_ (.A1(_0160_),
    .A2(_0162_),
    .A3(_0175_),
    .B1(_0179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__a21o_2 _0833_ (.A1(_0151_),
    .A2(_0158_),
    .B1(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__a31o_2 _0834_ (.A1(net42),
    .A2(net55),
    .A3(_0139_),
    .B1(_0137_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__a22o_2 _0835_ (.A1(net56),
    .A2(net38),
    .B1(net58),
    .B2(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__and4_2 _0836_ (.A(net56),
    .B(net38),
    .C(net58),
    .D(\sine_Areg[7] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _0837_ (.A(_0184_),
    ...
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__and3_2 _0838_ (.A(net49),
    .B(_0183_),
    .C(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0186_));
 sky130_fd_sc_hd__a21oi_2 _0839_ (.A1(_0183_),
    .A2(_0185_),
    .B1(net49),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _0840_ (.A(_0186_),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__nand2b_2 _0841_ (.A_N(_0188_),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__xnor2_2 _0842_ (.A(_0182_),
    .B(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0190_));
 sky130_fd_sc_hd__xnor2_2 _0843_ (.A(_0154_),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__nand2_2 _0844_ (.A(net55),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__and4_2 _0845_ (.A(net51),
    .B(net43),
    .C(net53),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__a22oi_2 _0846_ (.A1(net51),
    .A2(net43),
    .B1(net53),
    .B2(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0194_));
 sky130_fd_sc_hd__nor2_2 _0847_ (.A(_0193_),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0195_));
 sky130_fd_sc_hd__xnor2_2 _0848_ (.A(_0192_),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__nand2_2 _0849_ (.A(\sine_Breg[5] ),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__and2b_2 _0850_ (.A_N(\sine_Areg[0] ),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__and3_2 _0851_ (.A(net46),
    .B(net48),
    .C(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__xnor2_2 _0852_ (.A(_0133_),
    .B(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__xnor2_2 _0853_ (.A(_0197_),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__and2_2 _0854_ (.A(_0134_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__or2_2 _0855_ (.A(_0134_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__xor2_2 _0856_ (.A(_0134_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__xnor2_2 _0857_ (.A(_0196_),
    .B(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__or2_2 _0858_ (.A(_0141_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__and2_2 _0859_ (.A(_0141_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__xor2_2 _0860_ (.A(_0141_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__xnor2_2 _0861_ (.A(_0191_),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__o21a_2 _0862_ (.A1(_0150_),
    .A2(_0159_),
    .B1(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__and2b_2 _0863_ (.A_N(_0210_),
    .B(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__xnor2_2 _0864_ (.A(_0209_),
    .B(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__xor2_2 _0865_ (.A(_0181_),
    .B(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__and2b_2 _0866_ (.A_N(_0180_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__xnor2_2 _0867_ (.A(_0180_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__and2_2 _0868_ (.A(_0162_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__nor2_2 _0869_ (.A(_0176_),
    .B(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0217_));
 sky130_fd_sc_hd__and4_2 _0870_ (.A(\sine_Areg[0] ),
    .B(net46),
    .C(net54),
    .D(net55),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__a22o_2 _0871_ (.A1(net44),
    .A2(net57),
    .B1(net59),
    .B2(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0219_));
 sky130_fd_sc_hd__and3_2 _0872_ (.A(_0164_),
    .B(_0218_),
    .C(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__and2_2 _0873_ (.A(\sine_Areg[2] ),
    .B(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__nand3_2 _0874_ (.A(net44),
    .B(net57),
    .C(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0222_));
 sky130_fd_sc_hd__a21oi_2 _0875_ (.A1(_0164_),
    .A2(_0219_),
    .B1(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__or2_2 _0876_ (.A(_0220_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__nor2_2 _0877_ (.A(_0222_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__o21ai_2 _0878_ (.A1(_0220_),
    .A2(_0225_),
    .B1(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__xnor2_2 _0879_ (.A(_0177_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__and2_2 _0880_ (.A(_0222_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__or2_2 _0881_ (.A(_0225_),
    .B(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__xnor2_2 _0882_ (.A(_0166_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0230_));
 sky130_fd_sc_hd__or2_2 _0883_ (.A(_0229_),
    .B(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__a22oi_2 _0884_ (.A1(\sine_Areg[0] ),
    .A2(net54),
    .B1(\sine_Breg[2] ),
    .B2(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__nor2_2 _0885_ (.A(_0218_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__and3_2 _0886_ (.A(\sine_Areg[1] ),
    .B(net57),
    .C(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__a22o_2 _0887_ (.A1(\sine_Areg[2] ),
    .A2(net57),
    .B1(net59),
    .B2(net44),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__nand3_2 _0888_ (.A(_0222_),
    .B(_0234_),
    .C(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__a21o_2 _0889_ (.A1(_0222_),
    .A2(_0235_),
    .B1(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__a21oi_2 _0890_ (.A1(_0236_),
    .A2(_0237_),
    .B1(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__a21oi_2 _0891_ (.A1(\sine_Areg[1] ),
    .A2(net57),
    .B1(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0239_));
 sky130_fd_sc_hd__a21oi_2 _0892_ (.A1(_0093_),
    .A2(net59),
    .B1(\sine_Breg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__or4b_2 _0893_ (.A(_0238_),
    .B(_0239_),
    .C(_0240_),
    .D_N(\sine_Areg[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__nand2_2 _0894_ (.A(_0233_),
    .B(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__and4_2 _0895_ (.A(_0231_),
    .B(_0236_),
    .C(_0241_),
    .D(_0242_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__or2_2 _0896_ (.A(_0236_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__a311o_2 _0897_ (.A1(_0229_),
    .A2(_0230_),
    .A3(_0244_),
    .B1(_0243_),
    .C1(_0227_),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__nor3_2 _0898_ (.A(_0217_),
    .B(_0220_),
    .C(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__o22a_2 _0899_ (.A1(_0231_),
    .A2(_0244_),
    .B1(_0246_),
    .B2(_0227_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__a21oi_2 _0900_ (.A1(_0226_),
    .A2(_0245_),
    .B1(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0248_));
 sky130_fd_sc_hd__xor2_2 _0901_ (.A(_0215_),
    .B(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__a21bo_2 _0902_ (.A1(_0154_),
    .A2(_0190_),
    .B1_N(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__or2_2 _0903_ (.A(_0184_),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__a31o_2 _0904_ (.A1(net55),
    .A2(net40),
    .A3(_0195_),
    .B1(_0193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__o21ai_2 _0905_ (.A1(net56),
    .A2(net58),
    .B1(\sine_Areg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__o21a_2 _0906_ (.A1(net56),
    .A2(net58),
    .B1(\sine_Areg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__a21o_2 _0907_ (.A1(net56),
    .A2(net58),
    .B1(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__and2b_2 _0908_ (.A_N(_0254_),
    .B(_0251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__xnor2_2 _0909_ (.A(_0251_),
    .B(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0256_));
 sky130_fd_sc_hd__xnor2_2 _0910_ (.A(_0250_),
    .B(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0257_));
 sky130_fd_sc_hd__and4_2 _0911_ (.A(net51),
    .B(net53),
    .C(net41),
    .D(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__a22oi_2 _0912_ (.A1(net51),
    .A2(net41),
    .B1(net39),
    .B2(net53),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0259_));
 sky130_fd_sc_hd__nor2_2 _0913_ (.A(_0258_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0260_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(net55),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__xnor2_2 _0915_ (.A(_0260_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__nand2_2 _0916_ (.A(\sine_Breg[5] ),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__and2b_2 _0917_ (.A_N(net46),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__nand2_2 _0918_ (.A(net48),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__and3_2 _0919_ (.A(net48),
    .B(net45),
    .C(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__xnor2_2 _0920_ (.A(_0264_),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__xnor2_2 _0921_ (.A(_0263_),
    .B(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__a31o_2 _0922_ (.A1(\sine_Breg[5] ),
    .A2(net45),
    .A3(_0200_),
    .B1(_0199_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__nand2_2 _0923_ (.A(_0268_),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0270_));
 sky130_fd_sc_hd__xor2_2 _0924_ (.A(_0268_),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__xnor2_2 _0925_ (.A(_0262_),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__a21oi_2 _0926_ (.A1(_0196_),
    .A2(_0203_),
    .B1(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0273_));
 sky130_fd_sc_hd__or2_2 _0927_ (.A(_0272_),
    .B(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__xnor2_2 _0928_ (.A(_0272_),
    .B(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__xor2_2 _0929_ (.A(_0257_),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__o21a_2 _0930_ (.A1(_0191_),
    .A2(_0207_),
    .B1(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__and2b_2 _0931_ (.A_N(_0277_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__xnor2_2 _0932_ (.A(_0276_),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__xnor2_2 _0933_ (.A(_0249_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__a21oi_2 _0934_ (.A1(_0181_),
    .A2(_0212_),
    .B1(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__nor2_2 _0935_ (.A(_0280_),
    .B(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__and2_2 _0936_ (.A(_0280_),
    .B(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__or2_2 _0937_ (.A(_0282_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__a21oi_2 _0938_ (.A1(_0215_),
    .A2(_0248_),
    .B1(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__xor2_2 _0939_ (.A(_0284_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__a21o_2 _0940_ (.A1(_0249_),
    .A2(_0279_),
    .B1(_0278_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__a21oi_2 _0941_ (.A1(_0250_),
    .A2(_0256_),
    .B1(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__o21ba_2 _0942_ (.A1(_0259_),
    .A2(_0261_),
    .B1_N(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__nor2_2 _0943_ (.A(_0252_),
    .B(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0289_));
 sky130_fd_sc_hd__and2_2 _0944_ (.A(_0252_),
    .B(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__nor2_2 _0945_ (.A(_0289_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__and4_2 _0946_ (.A(net51),
    .B(net53),
    .C(net39),
    .D(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__a22oi_2 _0947_ (.A1(net51),
    .A2(net39),
    .B1(net38),
    .B2(net53),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0293_));
 sky130_fd_sc_hd__nor2_2 _0948_ (.A(_0292_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0294_));
 sky130_fd_sc_hd__nand2_2 _0949_ (.A(net55),
    .B(\sine_Areg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__xnor2_2 _0950_ (.A(_0294_),
    .B(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _0951_ (.A(net50),
    ...
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__and2b_2 _0952_ (.A_N(net45),
    .B(\sine_Breg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__nand2_2 _0953_ (.A(net47),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__and3_2 _0954_ (.A(net47),
    .B(net43),
    .C(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__xnor2_2 _0955_ (.A(_0298_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__xnor2_2 _0956_ (.A(_0297_),
    .B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__a31o_2 _0957_ (.A1(\sine_Breg[5] ),
    .A2(net43),
    .A3(_0267_),
    .B1(_0266_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__nand2_2 _0958_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__xor2_2 _0959_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__xnor2_2 _0960_ (.A(_0296_),
    .B(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0306_));
 sky130_fd_sc_hd__a21boi_2 _0961_ (.A1(_0262_),
    .A2(_0271_),
    .B1_N(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__xnor2_2 _0962_ (.A(_0306_),
    .B(_0307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__xnor2_2 _0963_ (.A(_0291_),
    .B(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__o21a_2 _0964_ (.A1(_0257_),
    .A2(_0275_),
    .B1(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__nand2b_2 _0965_ (.A_N(_0310_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__xnor2_2 _0966_ (.A(_0309_),
    .B(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0312_));
 sky130_fd_sc_hd__nand2b_2 _0967_ (.A_N(_0287_),
    .B(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__xnor2_2 _0968_ (.A(_0287_),
    .B(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0314_));
 sky130_fd_sc_hd__nor2_2 _0969_ (.A(_0286_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__nand2_2 _0970_ (.A(_0286_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__nand2b_2 _0971_ (.A_N(_0315_),
    .B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__o21ba_2 _0972_ (.A1(_0284_),
    .A2(_0285_),
    .B1_N(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__xor2_2 _0973_ (.A(_0317_),
    .B(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__o21ba_2 _0974_ (.A1(_0293_),
    .A2(_0295_),
    .B1_N(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__nor2_2 _0975_ (.A(_0252_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__and2_2 _0976_ (.A(_0252_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__nor2_2 _0977_ (.A(_0320_),
    .B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__a22oi_2 _0978_ (.A1(net51),
    .A2(net37),
    .B1(net36),
    .B2(net53),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__and4_2 _0979_ (.A(net51),
    .B(net53),
    .C(net37),
    .D(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__nor2_2 _0980_ (.A(_0323_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__xnor2_2 _0981_ (.A(_0295_),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0326_));
 sky130_fd_sc_hd__nand2_2 _0982_ (.A(net50),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__and2b_2 _0983_ (.A_N(net43),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__nand2_2 _0984_ (.A(net47),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__and3_2 _0985_ (.A(net47),
    .B(net41),
    .C(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__xnor2_2 _0986_ (.A(_0328_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__xnor2_2 _0987_ (.A(_0327_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__a31o_2 _0988_ (.A1(net50),
    .A2(net41),
    .A3(_0301_),
    .B1(_0300_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__and2_2 _0989_ (.A(_0332_),
    .B(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__xor2_2 _0990_ (.A(_0332_),
    .B(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__xnor2_2 _0991_ (.A(_0326_),
    .B(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__a21boi_2 _0992_ (.A1(_0296_),
    .A2(_0305_),
    .B1_N(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__xnor2_2 _0993_ (.A(_0336_),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__xnor2_2 _0994_ (.A(_0322_),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__o32a_2 _0995_ (.A1(_0289_),
    .A2(_0290_),
    .A3(_0308_),
    .B1(_0307_),
    .B2(_0306_),
    ...
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__nand2b_2 _0996_ (.A_N(_0340_),
    .B(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__xnor2_2 _0997_ (.A(_0339_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__nand2_2 _0998_ (.A(_0289_),
    .B(_0342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__or2_2 _0999_ (.A(_0289_),
    .B(_0342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__nand2_2 _1000_ (.A(_0343_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__nand3_2 _1001_ (.A(_0311_),
    .B(_0313_),
    .C(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__a21oi_2 _1002_ (.A1(_0311_),
    .A2(_0313_),
    .B1(_0345_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1003_ (.A(_0347_),
    ...
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__nand2_2 _1004_ (.A(_0346_),
    .B(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__o31a_2 _1005_ (.A1(_0280_),
    .A2(_0281_),
    .A3(_0315_),
    .B1(_0316_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__o31ai_2 _1006_ (.A1(_0284_),
    .A2(_0285_),
    .A3(_0317_),
    .B1(_0350_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _1007_ (.A(_0349_),
    ...
    .VPWR(VPWR),
    .Y(_0022_));
 sky130_fd_sc_hd__o21ba_2 _1008_ (.A1(_0295_),
    .A2(_0323_),
    .B1_N(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__nor2_2 _1009_ (.A(_0252_),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__and2_2 _1010_ (.A(_0252_),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0354_));
 sky130_fd_sc_hd__or2_2 _1011_ (.A(_0353_),
    .B(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__o21ai_2 _1012_ (.A1(net51),
    .A2(net53),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__and3_2 _1013_ (.A(net51),
    .B(net53),
    .C(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__or2_2 _1014_ (.A(_0356_),
    .B(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__nor2_2 _1015_ (.A(_0295_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__and2_2 _1016_ (.A(_0295_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__nor2_2 _1017_ (.A(_0359_),
    .B(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__inv_2 _1018_ (.A(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__nand2_2 _1019_ (.A(net50),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0363_));
 sky130_fd_sc_hd__and2b_2 _1020_ (.A_N(net41),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__nand2_2 _1021_ (.A(net48),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__and3_2 _1022_ (.A(net48),
    .B(net39),
    .C(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__xnor2_2 _1023_ (.A(_0364_),
    .B(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__xnor2_2 _1024_ (.A(_0363_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__a31o_2 _1025_ (.A1(net50),
    .A2(net39),
    .A3(_0331_),
    .B1(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__and2_2 _1026_ (.A(_0368_),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__xor2_2 _1027_ (.A(_0368_),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__xnor2_2 _1028_ (.A(_0361_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__a21oi_2 _1029_ (.A1(_0326_),
    .A2(_0335_),
    .B1(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__xnor2_2 _1030_ (.A(_0372_),
    .B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__nor2_2 _1031_ (.A(_0355_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0375_));
 sky130_fd_sc_hd__and2_2 _1032_ (.A(_0355_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__nor2_2 _1033_ (.A(_0375_),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0377_));
 sky130_fd_sc_hd__o32a_2 _1034_ (.A1(_0320_),
    .A2(_0321_),
    .A3(_0338_),
    .B1(_0337_),
    .B2(_0336_),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__and2b_2 _1035_ (.A_N(_0378_),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__xnor2_2 _1036_ (.A(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__xnor2_2 _1037_ (.A(_0320_),
    .B(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__a21oi_2 _1038_ (.A1(_0341_),
    .A2(_0343_),
    .B1(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__nand3_2 _1039_ (.A(_0341_),
    .B(_0343_),
    .C(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__and2b_2 _1040_ (.A_N(_0382_),
    .B(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__a21oi_2 _1041_ (.A1(_0346_),
    .A2(net18),
    .B1(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__xnor2_2 _1042_ (.A(_0384_),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0023_));
 sky130_fd_sc_hd__or3_2 _1043_ (.A(_0253_),
    .B(_0357_),
    .C(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__o21a_2 _1044_ (.A1(_0357_),
    .A2(_0359_),
    .B1(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__inv_2 _1045_ (.A(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__nand2_2 _1046_ (.A(_0386_),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__inv_2 _1047_ (.A(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__o2bb2a_2 _1048_ (.A1_N(net47),
    .A2_N(net37),
    .B1(net39),
    .B2(_0092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__and4b_2 _1049_ (.A_N(net39),
    .B(net37),
    .C(net49),
    .D(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__nor2_2 _1050_ (.A(_0391_),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__and2_2 _1051_ (.A(net50),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__nand2_2 _1052_ (.A(net50),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__xnor2_2 _1053_ (.A(_0393_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__a31oi_2 _1054_ (.A1(net50),
    .A2(net37),
    .A3(_0367_),
    .B1(_0366_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__and2b_2 _1055_ (.A_N(_0397_),
    .B(_0396_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__xor2_2 _1056_ (.A(_0396_),
    .B(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__nor2_2 _1057_ (.A(_0362_),
    .B(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__xnor2_2 _1058_ (.A(_0362_),
    .B(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0401_));
 sky130_fd_sc_hd__a21o_2 _1059_ (.A1(_0361_),
    .A2(_0371_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__and2b_2 _1060_ (.A_N(_0401_),
    .B(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__xor2_2 _1061_ (.A(_0401_),
    .B(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__xnor2_2 _1062_ (.A(_0390_),
    .B(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__o21ba_2 _1063_ (.A1(_0372_),
    .A2(_0373_),
    .B1_N(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__nand2b_2 _1064_ (.A_N(_0406_),
    .B(_0405_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__xnor2_2 _1065_ (.A(_0405_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__nand2_2 _1066_ (.A(_0353_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__xnor2_2 _1067_ (.A(_0353_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0410_));
 sky130_fd_sc_hd__a21oi_2 _1068_ (.A1(_0320_),
    .A2(_0380_),
    .B1(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__nor2_2 _1069_ (.A(_0410_),
    .B(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__xnor2_2 _1070_ (.A(_0410_),
    .B(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__inv_2 _1071_ (.A(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0414_));
 sky130_fd_sc_hd__a21o_2 _1072_ (.A1(_0346_),
    .A2(_0383_),
    .B1(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__o31a_2 _1073_ (.A1(_0347_),
    .A2(net18),
    .A3(_0382_),
    .B1(_0415_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__nor2_2 _1074_ (.A(_0414_),
    .B(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__o311a_2 _1075_ (.A1(_0347_),
    .A2(net18),
    .A3(_0382_),
    .B1(_0414_),
    .C1(_0415_),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__nor2_2 _1076_ (.A(_0417_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0024_));
 sky130_fd_sc_hd__o2bb2a_2 _1077_ (.A1_N(net47),
    .A2_N(net36),
    .B1(net37),
    .B2(_0092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__and4b_2 _1078_ (.A_N(net37),
    .B(net36),
    .C(net49),
    .D(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__or3_2 _1079_ (.A(_0395_),
    .B(_0419_),
    .C(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__o21ai_2 _1080_ (.A1(_0419_),
    .A2(_0420_),
    .B1(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0422_));
 sky130_fd_sc_hd__a21o_2 _1081_ (.A1(_0393_),
    .A2(_0394_),
    .B1(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__and3_2 _1082_ (.A(_0421_),
    .B(_0422_),
    .C(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__a21oi_2 _1083_ (.A1(_0421_),
    .A2(_0422_),
    .B1(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__nor2_2 _1084_ (.A(_0424_),
    .B(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _1085_ (.A(_0361_),
    ...
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__o21ba_2 _1086_ (.A1(_0398_),
    .A2(_0400_),
    .B1_N(_0427_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__or3b_2 _1087_ (.A(_0398_),
    .B(_0400_),
    .C_N(_0427_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__and2b_2 _1088_ (.A_N(_0428_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__xnor2_2 _1089_ (.A(_0389_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__o21ba_2 _1090_ (.A1(_0389_),
    .A2(_0404_),
    .B1_N(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__and2b_2 _1091_ (.A_N(_0432_),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__xnor2_2 _1092_ (.A(_0431_),
    .B(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__xnor2_2 _1093_ (.A(_0387_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__a21oi_2 _1094_ (.A1(_0407_),
    .A2(_0409_),
    .B1(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0436_));
 sky130_fd_sc_hd__nand3_2 _1095_ (.A(_0407_),
    .B(_0409_),
    .C(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0437_));
 sky130_fd_sc_hd__and2b_2 _1096_ (.A_N(_0436_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__nor2_2 _1097_ (.A(_0412_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__xnor2_2 _1098_ (.A(_0438_),
    .B(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0025_));
 sky130_fd_sc_hd__o31a_2 _1099_ (.A1(_0412_),
    .A2(_0418_),
    .A3(_0436_),
    .B1(_0437_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a21o_2 _1100_ (.A1(_0387_),
    .A2(_0434_),
    .B1(_0433_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__a21o_2 _1101_ (.A1(_0390_),
    .A2(_0429_),
    .B1(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__mux2_1 _1102_ (.A0(_0424_),
    .A1(_0425_),
    .S(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__mux2_1 _1103_ (.A0(net49),
    .A1(net47),
    .S(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__o21ba_2 _1104_ (.A1(_0394_),
    .A2(_0444_),
    .B1_N(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__a22o_2 _1105_ (.A1(net47),
    .A2(_0394_),
    .B1(_0421_),
    .B2(_0445_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__xor2_2 _1106_ (.A(_0386_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__xnor2_2 _1107_ (.A(_0443_),
    .B(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0448_));
 sky130_fd_sc_hd__xnor2_2 _1108_ (.A(_0442_),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__xnor2_2 _1109_ (.A(_0441_),
    .B(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__xnor2_2 _1110_ (.A(_0440_),
    .B(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0026_));
 sky130_fd_sc_hd__mux2_1 _1111_ (.A0(net124),
    .A1(net129),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__mux2_1 _1112_ (.A0(net130),
    .A1(net131),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__mux2_1 _1113_ (.A0(net127),
    .A1(\boxcar_filter[4] ),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1114_ (.A0(net120),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__mux2_1 _1115_ (.A0(\mixer_out[4] ),
    .A1(net125),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__mux2_1 _1116_ (.A0(\mixer_out[5] ),
    .A1(net132),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__mux2_1 _1117_ (.A0(\mixer_out[6] ),
    .A1(net133),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__mux2_1 _1118_ (.A0(\mixer_out[7] ),
    .A1(net122),
    .S(filter_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__xor2_2 _1119_ (.A(\inst_sine_B.phase[5] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__xnor2_2 _1120_ (.A(\inst_sine_B.phase[5] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0452_));
 sky130_fd_sc_hd__xor2_2 _1121_ (.A(\inst_sine_B.phase[4] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__xnor2_2 _1122_ (.A(\inst_sine_B.phase[4] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__xor2_2 _1123_ (.A(\inst_sine_B.phase[3] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__xnor2_2 _1124_ (.A(\inst_sine_B.phase[3] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0456_));
 sky130_fd_sc_hd__xnor2_2 _1125_ (.A(\inst_sine_B.phase[0] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0457_));
 sky130_fd_sc_hd__inv_2 _1126_ (.A(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0458_));
 sky130_fd_sc_hd__xor2_2 _1127_ (.A(\inst_sine_B.phase[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__or2_2 _1128_ (.A(net21),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__xor2_2 _1129_ (.A(\inst_sine_B.phase[2] ),
    .B(\inst_sine_B.phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__xnor2_2 _1130_ (.A(\inst_sine_B.phase[2] ),
    .B(\inst_sine_B.phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__nand2_2 _1131_ (.A(net21),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0463_));
 sky130_fd_sc_hd__a21o_2 _1132_ (.A1(_0460_),
    .A2(_0463_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__nand2_2 _1133_ (.A(_0459_),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__nand2_2 _1134_ (.A(net22),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__or2_2 _1135_ (.A(_0455_),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__a21o_2 _1136_ (.A1(net20),
    .A2(_0462_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__o21ai_2 _1137_ (.A1(net21),
    .A2(_0466_),
    .B1(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0469_));
 sky130_fd_sc_hd__mux2_1 _1138_ (.A0(_0464_),
    .A1(_0469_),
    .S(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__nor2_2 _1139_ (.A(_0462_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0471_));
 sky130_fd_sc_hd__a311o_2 _1140_ (.A1(_0460_),
    .A2(_0465_),
    .A3(_0467_),
    .B1(_0454_),
    .C1(_0451_),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__mux2_1 _1141_ (.A0(net22),
    .A1(_0466_),
    .S(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__o32a_2 _1142_ (.A1(_0451_),
    .A2(_0453_),
    .A3(_0473_),
    .B1(_0472_),
    .B2(_0471_),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__o21a_2 _1143_ (.A1(_0452_),
    .A2(_0470_),
    .B1(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__nor2_2 _1144_ (.A(lowamp_B),
    .B(bypass_B),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0476_));
 sky130_fd_sc_hd__or2_2 _1145_ (.A(lowamp_B),
    .B(bypass_B),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__and2_2 _1146_ (.A(\inst_sine_B.phase[7] ),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__nand2_2 _1147_ (.A(net21),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _1148_ (.A(_0460_),
    ...
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__nor2_2 _1149_ (.A(net20),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__or2_2 _1150_ (.A(net20),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__a21oi_2 _1151_ (.A1(net19),
    .A2(_0480_),
    .B1(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__nand2_2 _1152_ (.A(_0464_),
    .B(_0483_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__nand2_2 _1153_ (.A(net23),
    .B(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__nand2_2 _1154_ (.A(_0455_),
    .B(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__nand2_2 _1155_ (.A(_0456_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__and3_2 _1156_ (.A(_0454_),
    .B(_0486_),
    .C(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__a31o_2 _1157_ (.A1(_0453_),
    .A2(_0484_),
    .A3(_0485_),
    .B1(_0488_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__or4bb_2 _1158_ (.A(net22),
    .B(_0483_),
    .C_N(_0479_),
    .D_N(_0463_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__and3_2 _1159_ (.A(_0454_),
    .B(_0467_),
    .C(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__a31o_2 _1160_ (.A1(_0453_),
    .A2(_0485_),
    .A3(_0487_),
    .B1(_0452_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__o2bb2a_2 _1161_ (.A1_N(_0452_),
    .A2_N(_0489_),
    .B1(_0491_),
    .B2(_0492_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__xnor2_2 _1162_ (.A(_0478_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__o21ai_2 _1163_ (.A1(bypass_B),
    .A2(_0494_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__o21a_2 _1164_ (.A1(_0475_),
    .A2(_0477_),
    .B1(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__nor2_2 _1165_ (.A(_0454_),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__nor2_2 _1166_ (.A(_0458_),
    .B(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__and2_2 _1167_ (.A(_0458_),
    .B(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__inv_2 _1168_ (.A(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__o211a_2 _1169_ (.A1(net19),
    .A2(_0497_),
    .B1(_0499_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__a21o_2 _1170_ (.A1(net22),
    .A2(_0480_),
    .B1(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__a22o_2 _1171_ (.A1(_0482_),
    .A2(_0496_),
    .B1(_0501_),
    .B2(_0454_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__nand2_2 _1172_ (.A(net21),
    .B(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__a21oi_2 _1173_ (.A1(_0499_),
    .A2(_0503_),
    .B1(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0504_));
 sky130_fd_sc_hd__a311o_2 _1174_ (.A1(_0461_),
    .A2(_0499_),
    .A3(_0503_),
    .B1(_0504_),
    .C1(net24),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__or3b_2 _1175_ (.A(_0455_),
    .B(net19),
    .C_N(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__o311a_2 _1176_ (.A1(_0458_),
    .A2(_0462_),
    .A3(_0487_),
    .B1(_0506_),
    .C1(_0453_),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__a21oi_2 _1177_ (.A1(_0490_),
    .A2(_0507_),
    .B1(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0508_));
 sky130_fd_sc_hd__a22o_2 _1178_ (.A1(_0451_),
    .A2(_0502_),
    .B1(_0505_),
    .B2(_0508_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__inv_2 _1179_ (.A(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0510_));
 sky130_fd_sc_hd__or2_2 _1180_ (.A(_0475_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__nand2_2 _1181_ (.A(\inst_sine_B.phase[7] ),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__xnor2_2 _1182_ (.A(_0509_),
    .B(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0513_));
 sky130_fd_sc_hd__o21a_2 _1183_ (.A1(bypass_B),
    .A2(_0513_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__a21oi_2 _1184_ (.A1(_0476_),
    .A2(_0494_),
    .B1(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0009_));
 sky130_fd_sc_hd__mux2_1 _1185_ (.A0(_0465_),
    .A1(net19),
    .S(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__and3_2 _1186_ (.A(_0454_),
    .B(_0482_),
    .C(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__and3_2 _1187_ (.A(net24),
    .B(net22),
    .C(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__o21a_2 _1188_ (.A1(_0516_),
    .A2(_0517_),
    .B1(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__and3_2 _1189_ (.A(_0460_),
    .B(_0463_),
    .C(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__mux2_1 _1190_ (.A0(_0468_),
    .A1(_0455_),
    .S(_0519_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__or3_2 _1191_ (.A(net23),
    .B(net19),
    .C(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0521_));
 sky130_fd_sc_hd__o211ai_2 _1192_ (.A1(net23),
    .A2(_0465_),
    .B1(_0521_),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__o22a_2 _1193_ (.A1(net24),
    .A2(_0520_),
    .B1(_0522_),
    .B2(_0500_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__a21o_2 _1194_ (.A1(_0452_),
    .A2(_0523_),
    .B1(_0518_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__o21ai_2 _1195_ (.A1(_0510_),
    .A2(_0511_),
    .B1(\inst_sine_B.phase[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__xnor2_2 _1196_ (.A(_0524_),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__o21a_2 _1197_ (.A1(bypass_B),
    .A2(_0526_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__a21oi_2 _1198_ (.A1(_0476_),
    .A2(_0513_),
    .B1(_0527_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0010_));
 sky130_fd_sc_hd__a21o_2 _1199_ (.A1(net24),
    .A2(_0466_),
    .B1(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__a21o_2 _1200_ (.A1(_0454_),
    .A2(_0521_),
    .B1(_0452_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__o211a_2 _1201_ (.A1(net22),
    .A2(_0462_),
    .B1(_0528_),
    .C1(_0529_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__o31a_2 _1202_ (.A1(net23),
    .A2(_0462_),
    .A3(_0497_),
    .B1(_0485_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0531_));
 sky130_fd_sc_hd__a31o_2 _1203_ (.A1(_0452_),
    .A2(_0454_),
    .A3(_0531_),
    .B1(_0530_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0532_));
 sky130_fd_sc_hd__and3b_2 _1204_ (.A_N(_0511_),
    .B(_0524_),
    .C(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__nor2_2 _1205_ (.A(_0091_),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0534_));
 sky130_fd_sc_hd__xor2_2 _1206_ (.A(_0532_),
    .B(_0534_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0535_));
 sky130_fd_sc_hd__o21a_2 _1207_ (.A1(bypass_B),
    .A2(_0535_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0536_));
 sky130_fd_sc_hd__a21oi_2 _1208_ (.A1(_0476_),
    .A2(_0526_),
    .B1(_0536_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0011_));
 sky130_fd_sc_hd__and3_2 _1209_ (.A(_0454_),
    .B(_0455_),
    .C(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0537_));
 sky130_fd_sc_hd__a211o_2 _1210_ (.A1(_0451_),
    .A2(_0521_),
    .B1(_0537_),
    .C1(_0496_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0538_));
 sky130_fd_sc_hd__mux2_1 _1211_ (.A0(_0091_),
    .A1(_0534_),
    .S(_0538_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0539_));
 sky130_fd_sc_hd__o21a_2 _1212_ (.A1(bypass_B),
    .A2(_0539_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0540_));
 sky130_fd_sc_hd__a21oi_2 _1213_ (.A1(_0476_),
    .A2(_0535_),
    .B1(_0540_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0012_));
 sky130_fd_sc_hd__xnor2_2 _1214_ (.A(\inst_sine_B.phase[7] ),
    .B(_0528_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0541_));
 sky130_fd_sc_hd__o21a_2 _1215_ (.A1(bypass_B),
    .A2(_0541_),
    .B1(lowamp_B),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0542_));
 sky130_fd_sc_hd__a21oi_2 _1216_ (.A1(_0476_),
    .A2(_0539_),
    .B1(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__nand2_2 _1217_ (.A(\inst_sine_A.phase[7] ),
    ...
    .VPWR(VPWR),
    .Y(_0543_));
 sky130_fd_sc_hd__nor2_2 _1218_ (.A(_0102_),
    .B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0544_));
 sky130_fd_sc_hd__nand2_2 _1219_ (.A(_0099_),
    .B(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0545_));
 sky130_fd_sc_hd__and2_2 _1220_ (.A(_0102_),
    .B(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0546_));
 sky130_fd_sc_hd__or2_2 _1221_ (.A(_0104_),
    .B(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0547_));
 sky130_fd_sc_hd__nor2_2 _1222_ (.A(net25),
    .B(_0547_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0548_));
 sky130_fd_sc_hd__o31a_2 _1223_ (.A1(_0109_),
    .A2(_0544_),
    .A3(_0548_),
    .B1(_0545_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0549_));
 sky130_fd_sc_hd__or2_2 _1224_ (.A(_0099_),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0550_));
 sky130_fd_sc_hd__o21a_2 _1225_ (.A1(net27),
    .A2(_0547_),
    .B1(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0551_));
 sky130_fd_sc_hd__mux2_1 _1226_ (.A0(_0549_),
    .A1(_0551_),
    .S(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0552_));
 sky130_fd_sc_hd__a21oi_2 _1227_ (.A1(_0104_),
    .A2(_0105_),
    .B1(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0553_));
 sky130_fd_sc_hd__o211a_2 _1228_ (.A1(_0100_),
    .A2(_0553_),
    .B1(_0112_),
    .C1(_0098_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0554_));
 sky130_fd_sc_hd__a31o_2 _1229_ (.A1(net29),
    .A2(_0545_),
    .A3(_0550_),
    .B1(_0096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__o2bb2a_2 _1230_ (.A1_N(_0096_),
    .A2_N(_0552_),
    .B1(_0554_),
    .B2(_0555_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0556_));
 sky130_fd_sc_hd__xnor2_2 _1231_ (.A(_0543_),
    .B(_0556_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\inst_sine_A.sample[1] ));
 sky130_fd_sc_hd__or3_2 _1232_ (.A(_0099_),
    .B(_0106_),
    .C(_0547_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0557_));
 sky130_fd_sc_hd__or2_2 _1233_ (.A(net25),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0558_));
 sky130_fd_sc_hd__a21oi_2 _1234_ (.A1(_0117_),
    .A2(_0558_),
    .B1(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0559_));
 sky130_fd_sc_hd__inv_2 _1235_ (.A(_0559_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0560_));
 sky130_fd_sc_hd__o211a_2 _1236_ (.A1(_0099_),
    .A2(_0547_),
    .B1(_0560_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__a21oi_2 _1237_ (.A1(net27),
    .A2(_0111_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0562_));
 sky130_fd_sc_hd__a2111o_2 _1238_ (.A1(net29),
    .A2(_0544_),
    .B1(_0561_),
    .C1(_0562_),
    .D1(_0096_),
    ...
    .VPWR(VPWR),
    .X(_0563_));
 sky130_fd_sc_hd__nand2_2 _1239_ (.A(net26),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0564_));
 sky130_fd_sc_hd__nand2_2 _1240_ (.A(net25),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0565_));
 sky130_fd_sc_hd__nand2_2 _1241_ (.A(_0558_),
    .B(_0565_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0566_));
 sky130_fd_sc_hd__mux2_1 _1242_ (.A0(_0105_),
    .A1(_0566_),
    .S(_0564_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__o21ai_2 _1243_ (.A1(_0100_),
    .A2(_0553_),
    .B1(_0557_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0568_));
 sky130_fd_sc_hd__a311o_2 _1244_ (.A1(_0100_),
    .A2(_0103_),
    .A3(_0110_),
    .B1(_0568_),
    .C1(_0098_),
    ...
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__o21ai_2 _1245_ (.A1(_0097_),
    .A2(_0567_),
    .B1(_0569_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0570_));
 sky130_fd_sc_hd__o21ai_2 _1246_ (.A1(_0095_),
    .A2(_0570_),
    .B1(_0563_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0571_));
 sky130_fd_sc_hd__o21a_2 _1247_ (.A1(\inst_sine_A.sample[0] ),
    .A2(_0556_),
    ...
    .VPWR(VPWR),
    .X(_0572_));
 sky130_fd_sc_hd__xnor2_2 _1248_ (.A(_0571_),
    .B(_0572_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3b_2 _1249_ (.A(\inst_sine_A.sample[0] ),
    .B(_0556_),
    .C_N(_0571_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0573_));
 sky130_fd_sc_hd__nand2_2 _1250_ (.A(\inst_sine_A.phase[7] ),
    .B(_0573_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0574_));
 sky130_fd_sc_hd__and3_2 _1251_ (.A(net29),
    .B(net27),
    .C(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0575_));
 sky130_fd_sc_hd__mux2_1 _1252_ (.A0(_0106_),
    .A1(_0566_),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0576_));
 sky130_fd_sc_hd__a21oi_2 _1253_ (.A1(net28),
    .A2(_0576_),
    .B1(_0575_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0577_));
 sky130_fd_sc_hd__nand2_2 _1254_ (.A(_0108_),
    .B(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0578_));
 sky130_fd_sc_hd__mux2_1 _1255_ (.A0(net27),
    .A1(_0114_),
    .S(_0578_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__or3_2 _1256_ (.A(_0099_),
    .B(_0106_),
    .C(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__o2111a_2 _1257_ (.A1(_0099_),
    .A2(_0111_),
    .B1(_0560_),
    .C1(_0580_),
    .D1(net29),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__a211o_2 _1258_ (.A1(net28),
    .A2(_0579_),
    .B1(_0581_),
    .C1(_0095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0582_));
 sky130_fd_sc_hd__o21ai_2 _1259_ (.A1(_0096_),
    .A2(_0577_),
    .B1(_0582_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0583_));
 sky130_fd_sc_hd__xor2_2 _1260_ (.A(_0574_),
    .B(_0583_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\inst_sine_A.sample[3] ));
 sky130_fd_sc_hd__or3b_2 _1261_ (.A(_0099_),
    .B(net25),
    .C_N(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0584_));
 sky130_fd_sc_hd__or2_2 _1262_ (.A(_0095_),
    .B(_0562_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0585_));
 sky130_fd_sc_hd__a21o_2 _1263_ (.A1(net28),
    .A2(_0580_),
    .B1(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0586_));
 sky130_fd_sc_hd__o211a_2 _1264_ (.A1(net27),
    .A2(net25),
    .B1(_0585_),
    .C1(_0586_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0587_));
 sky130_fd_sc_hd__a31o_2 _1265_ (.A1(_0121_),
    .A2(_0545_),
    .A3(_0584_),
    .B1(_0587_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0588_));
 sky130_fd_sc_hd__nand2b_2 _1266_ (.A_N(_0573_),
    .B(_0583_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0589_));
 sky130_fd_sc_hd__nand2_2 _1267_ (.A(\inst_sine_A.phase[7] ),
    .B(_0589_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0590_));
 sky130_fd_sc_hd__xor2_2 _1268_ (.A(_0588_),
    .B(_0590_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_2 _1269_ (.A1(net27),
    .A2(_0544_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0591_));
 sky130_fd_sc_hd__a2bb2o_2 _1270_ (.A1_N(_0562_),
    .A2_N(_0591_),
    .B1(_0580_),
    .B2(_0095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0592_));
 sky130_fd_sc_hd__nand2_2 _1271_ (.A(_0589_),
    .B(_0592_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0593_));
 sky130_fd_sc_hd__mux2_1 _1272_ (.A0(_0592_),
    .A1(_0593_),
 ...
 sky130_fd_sc_hd__xor2_2 _1273_ (.A(\inst_sine_A.phase[7] ),
    .B(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\inst_sine_A.sample[6] ));
 sky130_fd_sc_hd__nor2_2 _1274_ (.A(_0091_),
    .B(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0030_));
 sky130_fd_sc_hd__nor2_2 _1275_ (.A(lowamp_B),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0594_));
 sky130_fd_sc_hd__a211o_2 _1276_ (.A1(\inst_sine_B.phase[7] ),
    .A2(lowamp_B),
    .B1(bypass_B),
    .C1(_0594_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__and2b_2 _1277_ (.A_N(\boxcar_storage[4][0] ),
    .B(\boxcar_filter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0595_));
 sky130_fd_sc_hd__and2b_2 _1278_ (.A_N(\boxcar_filter[0] ),
    ...
    .VPWR(VPWR),
    .X(_0596_));
 sky130_fd_sc_hd__or3_2 _1279_ (.A(\mixer_out[0] ),
    .B(_0595_),
    .C(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0597_));
 sky130_fd_sc_hd__o21ai_2 _1280_ (.A1(_0595_),
    .A2(_0596_),
    .B1(\mixer_out[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0598_));
 sky130_fd_sc_hd__and3_2 _1281_ (.A(net61),
    .B(_0597_),
    .C(_0598_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__and2b_2 _1282_ (.A_N(\boxcar_storage[4][1] ),
    .B(\mixer_out[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0599_));
 sky130_fd_sc_hd__xnor2_2 _1283_ (.A(\boxcar_storage[4][1] ),
    .B(\mixer_out[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0600_));
 sky130_fd_sc_hd__xnor2_2 _1284_ (.A(\boxcar_filter[1] ),
    .B(_0600_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0601_));
 sky130_fd_sc_hd__or2_2 _1285_ (.A(_0596_),
    .B(_0601_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0602_));
 sky130_fd_sc_hd__xnor2_2 _1286_ (.A(_0596_),
    .B(_0601_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0603_));
 sky130_fd_sc_hd__nand2_2 _1287_ (.A(_0598_),
    .B(_0603_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0604_));
 sky130_fd_sc_hd__or2_2 _1288_ (.A(_0598_),
    .B(_0603_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0605_));
 sky130_fd_sc_hd__and3_2 _1289_ (.A(net61),
    .B(_0604_),
    .C(_0605_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__and2b_2 _1290_ (.A_N(\boxcar_storage[4][2] ),
    .B(\mixer_out[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0606_));
 sky130_fd_sc_hd__xnor2_2 _1291_ (.A(\boxcar_storage[4][2] ),
    .B(\mixer_out[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0607_));
 sky130_fd_sc_hd__xnor2_2 _1292_ (.A(\boxcar_filter[2] ),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0608_));
 sky130_fd_sc_hd__a21oi_2 _1293_ (.A1(\boxcar_filter[1] ),
    .A2(_0600_),
    .B1(_0599_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__nor2_2 _1294_ (.A(_0608_),
    .B(_0609_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0610_));
 sky130_fd_sc_hd__and2_2 _1295_ (.A(_0608_),
    .B(_0609_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0611_));
 sky130_fd_sc_hd__or2_2 _1296_ (.A(_0610_),
    .B(_0611_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0612_));
 sky130_fd_sc_hd__a21oi_2 _1297_ (.A1(_0602_),
    .A2(_0605_),
    .B1(_0612_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0613_));
 sky130_fd_sc_hd__a31o_2 _1298_ (.A1(_0602_),
    .A2(_0605_),
    .A3(_0612_),
    .B1(_0094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0614_));
 sky130_fd_sc_hd__nor2_2 _1299_ (.A(_0613_),
    .B(_0614_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0034_));
 sky130_fd_sc_hd__and2b_2 _1300_ (.A_N(\boxcar_storage[4][3] ),
    .B(\mixer_out[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0615_));
 sky130_fd_sc_hd__and2b_2 _1301_ (.A_N(\mixer_out[3] ),
    .B(\boxcar_storage[4][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0616_));
 sky130_fd_sc_hd__nor2_2 _1302_ (.A(_0615_),
    .B(_0616_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0617_));
 sky130_fd_sc_hd__xnor2_2 _1303_ (.A(\boxcar_filter[3] ),
    .B(_0617_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0618_));
 sky130_fd_sc_hd__a21oi_2 _1304_ (.A1(\boxcar_filter[2] ),
    .A2(_0607_),
    .B1(_0606_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0619_));
 sky130_fd_sc_hd__xnor2_2 _1305_ (.A(_0618_),
    .B(_0619_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0620_));
 sky130_fd_sc_hd__or3b_2 _1306_ (.A(_0610_),
    .B(_0613_),
    .C_N(_0620_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0621_));
 sky130_fd_sc_hd__o21ba_2 _1307_ (.A1(_0610_),
    .A2(_0613_),
    .B1_N(_0620_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0622_));
 sky130_fd_sc_hd__and3b_2 _1308_ (.A_N(_0622_),
    .B(net64),
    .C(_0621_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__nand2b_2 _1309_ (.A_N(\boxcar_storage[4][4] ),
    .B(\mixer_out[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0623_));
 sky130_fd_sc_hd__xnor2_2 _1310_ (.A(\boxcar_storage[4][4] ),
    .B(\mixer_out[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0624_));
 sky130_fd_sc_hd__nand2_2 _1311_ (.A(\boxcar_filter[4] ),
    .B(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0625_));
 sky130_fd_sc_hd__xnor2_2 _1312_ (.A(\boxcar_filter[4] ),
    .B(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0626_));
 sky130_fd_sc_hd__a21oi_2 _1313_ (.A1(\boxcar_filter[3] ),
    .A2(_0617_),
    .B1(_0615_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0627_));
 sky130_fd_sc_hd__xnor2_2 _1314_ (.A(_0626_),
    .B(_0627_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0628_));
 sky130_fd_sc_hd__o21ba_2 _1315_ (.A1(_0618_),
    .A2(_0619_),
    .B1_N(_0622_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0629_));
 sky130_fd_sc_hd__nor2_2 _1316_ (.A(_0628_),
    .B(_0629_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0630_));
 sky130_fd_sc_hd__o21ai_2 _1317_ (.A1(_0628_),
    .A2(_0629_),
    .B1(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__a21oi_2 _1318_ (.A1(_0628_),
    .A2(_0629_),
    .B1(_0631_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0036_));
 sky130_fd_sc_hd__o21bai_2 _1319_ (.A1(_0626_),
    .A2(_0627_),
    .B1_N(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0632_));
 sky130_fd_sc_hd__nand2b_2 _1320_ (.A_N(\boxcar_storage[4][5] ),
    .B(\mixer_out[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0633_));
 sky130_fd_sc_hd__xnor2_2 _1321_ (.A(\boxcar_storage[4][5] ),
    .B(\mixer_out[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0634_));
 sky130_fd_sc_hd__nand2_2 _1322_ (.A(\boxcar_filter[5] ),
    .B(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0635_));
 sky130_fd_sc_hd__or2_2 _1323_ (.A(\boxcar_filter[5] ),
    .B(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0636_));
 sky130_fd_sc_hd__nand2_2 _1324_ (.A(_0635_),
    .B(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0637_));
 sky130_fd_sc_hd__a21o_2 _1325_ (.A1(_0623_),
    .A2(_0625_),
    .B1(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0638_));
 sky130_fd_sc_hd__nand3_2 _1326_ (.A(_0623_),
    .B(_0625_),
    .C(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0639_));
 sky130_fd_sc_hd__nand2_2 _1327_ (.A(_0632_),
    .B(_0639_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0640_));
 sky130_fd_sc_hd__nand2b_2 _1328_ (.A_N(_0640_),
    .B(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0641_));
 sky130_fd_sc_hd__a21o_2 _1329_ (.A1(_0638_),
    .A2(_0639_),
    .B1(_0632_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0642_));
 sky130_fd_sc_hd__and3_2 _1330_ (.A(net63),
    .B(_0641_),
    .C(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__nand2b_2 _1331_ (.A_N(\boxcar_storage[4][6] ),
    .B(\mixer_out[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0643_));
 sky130_fd_sc_hd__xnor2_2 _1332_ (.A(\boxcar_storage[4][6] ),
    .B(\mixer_out[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0644_));
 sky130_fd_sc_hd__nand2_2 _1333_ (.A(\boxcar_filter[6] ),
    .B(_0644_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0645_));
 sky130_fd_sc_hd__or2_2 _1334_ (.A(\boxcar_filter[6] ),
    .B(_0644_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0646_));
 sky130_fd_sc_hd__nand2_2 _1335_ (.A(_0645_),
    .B(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0647_));
 sky130_fd_sc_hd__a21o_2 _1336_ (.A1(_0633_),
    .A2(_0635_),
    .B1(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0648_));
 sky130_fd_sc_hd__nand3_2 _1337_ (.A(_0633_),
    .B(_0635_),
    .C(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0649_));
 sky130_fd_sc_hd__nand2_2 _1338_ (.A(_0648_),
    .B(_0649_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0650_));
 sky130_fd_sc_hd__nand3_2 _1339_ (.A(_0638_),
    .B(_0640_),
    .C(_0650_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0651_));
 sky130_fd_sc_hd__a21o_2 _1340_ (.A1(_0638_),
    .A2(_0640_),
    .B1(_0650_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0652_));
 sky130_fd_sc_hd__and3_2 _1341_ (.A(net63),
    .B(_0651_),
    .C(_0652_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__and2b_2 _1342_ (.A_N(\boxcar_storage[4][7] ),
    .B(\mixer_out[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0653_));
 sky130_fd_sc_hd__and2b_2 _1343_ (.A_N(\mixer_out[7] ),
    .B(\boxcar_storage[4][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__nor2_2 _1344_ (.A(_0653_),
    .B(_0654_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0655_));
 sky130_fd_sc_hd__xnor2_2 _1345_ (.A(\boxcar_filter[7] ),
    .B(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0656_));
 sky130_fd_sc_hd__a21o_2 _1346_ (.A1(_0643_),
    .A2(_0645_),
    .B1(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0657_));
 sky130_fd_sc_hd__nand3_2 _1347_ (.A(_0643_),
    .B(_0645_),
    .C(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0658_));
 sky130_fd_sc_hd__nand2_2 _1348_ (.A(_0657_),
    .B(_0658_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0659_));
 sky130_fd_sc_hd__nand3_2 _1349_ (.A(_0648_),
    .B(_0652_),
    .C(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0660_));
 sky130_fd_sc_hd__a21o_2 _1350_ (.A1(_0648_),
    .A2(_0652_),
    .B1(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0661_));
 sky130_fd_sc_hd__and3_2 _1351_ (.A(net63),
    .B(_0660_),
    .C(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__a21oi_2 _1352_ (.A1(\boxcar_filter[7] ),
    .A2(_0655_),
    .B1(_0653_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0662_));
 sky130_fd_sc_hd__or2_2 _1353_ (.A(\boxcar_filter[8] ),
    .B(_0662_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0663_));
 sky130_fd_sc_hd__nand2_2 _1354_ (.A(\boxcar_filter[8] ),
    .B(_0662_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0664_));
 sky130_fd_sc_hd__nand2_2 _1355_ (.A(_0663_),
    .B(_0664_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0665_));
 sky130_fd_sc_hd__nand3_2 _1356_ (.A(_0657_),
    .B(_0661_),
    .C(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0666_));
 sky130_fd_sc_hd__a21o_2 _1357_ (.A1(_0657_),
    .A2(_0661_),
    .B1(_0665_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_2 _1358_ (.A(net63),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__xor2_2 _1359_ (.A(\boxcar_filter[8] ),
    .B(\boxcar_filter[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0668_));
 sky130_fd_sc_hd__and3_2 _1360_ (.A(_0663_),
    .B(_0667_),
    .C(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0669_));
 sky130_fd_sc_hd__a21o_2 _1361_ (.A1(_0663_),
    .A2(_0667_),
    .B1(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0670_));
 sky130_fd_sc_hd__and3b_2 _1362_ (.A_N(_0669_),
    .B(_0670_),
    .C(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__and2_2 _1363_ (.A(net124),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and2_2 _1364_ (.A(net130),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__and2_2 _1365_ (.A(net127),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__and2_2 _1366_ (.A(net120),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__and2_2 _1367_ (.A(net134),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__and2_2 _1368_ (.A(\mixer_out[5] ),
    .B(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__and2_2 _1369_ (.A(\mixer_out[6] ),
    .B(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__and2_2 _1370_ (.A(net126),
    .B(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__and2_2 _1371_ (.A(net60),
    .B(net108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__and2_2 _1372_ (.A(net64),
    .B(net96),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__and2_2 _1373_ (.A(net64),
    .B(net109),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__and2_2 _1374_ (.A(net60),
    .B(net99),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__and2_2 _1375_ (.A(net60),
    .B(net107),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__and2_2 _1376_ (.A(net62),
    .B(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__and2_2 _1377_ (.A(net62),
    .B(net104),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__and2_2 _1378_ (.A(net62),
    .B(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__and2_2 _1379_ (.A(net60),
    .B(net92),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__and2_2 _1380_ (.A(net64),
    .B(net110),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__and2_2 _1381_ (.A(net65),
    .B(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__and2_2 _1382_ (.A(net60),
    .B(net111),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__and2_2 _1383_ (.A(net60),
    .B(net97),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__and2_2 _1384_ (.A(net62),
    .B(net102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__and2_2 _1385_ (.A(net62),
    .B(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__and2_2 _1386_ (.A(net62),
    .B(net100),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__and2_2 _1387_ (.A(net60),
    .B(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__and2_2 _1388_ (.A(net64),
    .B(net95),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__and2_2 _1389_ (.A(net65),
    .B(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__and2_2 _1390_ (.A(net61),
    .B(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__and2_2 _1391_ (.A(net61),
    .B(net98),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__and2_2 _1392_ (.A(net62),
    .B(net103),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__and2_2 _1393_ (.A(net63),
    .B(net106),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__and2_2 _1394_ (.A(net63),
    .B(net101),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__or2_2 _1395_ (.A(\inst_sine_B.phase[0] ),
    .B(\phase_incr_B[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0671_));
 sky130_fd_sc_hd__nand2_2 _1396_ (.A(\inst_sine_B.phase[0] ),
    .B(\phase_incr_B[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0672_));
 sky130_fd_sc_hd__and3_2 _1397_ (.A(net66),
    .B(_0671_),
    .C(_0672_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__or2_2 _1398_ (.A(\inst_sine_B.phase[1] ),
    .B(\phase_incr_B[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0673_));
 sky130_fd_sc_hd__nand2_2 _1399_ (.A(\inst_sine_B.phase[1] ),
    .B(\phase_incr_B[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0674_));
 sky130_fd_sc_hd__a21bo_2 _1400_ (.A1(_0673_),
    .A2(_0674_),
    .B1_N(_0672_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0675_));
 sky130_fd_sc_hd__and3b_2 _1401_ (.A_N(_0672_),
    .B(_0673_),
    .C(_0674_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0676_));
 sky130_fd_sc_hd__and3b_2 _1402_ (.A_N(_0676_),
    .B(net66),
    .C(_0675_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__or2_2 _1403_ (.A(\inst_sine_B.phase[2] ),
    .B(\phase_incr_B[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0677_));
 sky130_fd_sc_hd__nand2_2 _1404_ (.A(\inst_sine_B.phase[2] ),
    .B(\phase_incr_B[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0678_));
 sky130_fd_sc_hd__a21o_2 _1405_ (.A1(\inst_sine_B.phase[1] ),
    .A2(\phase_incr_B[1] ),
    .B1(_0676_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0679_));
 sky130_fd_sc_hd__a21o_2 _1406_ (.A1(_0677_),
    .A2(_0678_),
    .B1(_0679_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0680_));
 sky130_fd_sc_hd__and3_2 _1407_ (.A(_0677_),
    .B(_0678_),
    .C(_0679_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0681_));
 sky130_fd_sc_hd__and3b_2 _1408_ (.A_N(_0681_),
    .B(net66),
    .C(_0680_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0077_));
 sky130_fd_sc_hd__or2_2 _1409_ (.A(\inst_sine_B.phase[3] ),
    .B(\phase_incr_B[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0682_));
 sky130_fd_sc_hd__nand2_2 _1410_ (.A(\inst_sine_B.phase[3] ),
    .B(\phase_incr_B[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0683_));
 sky130_fd_sc_hd__a21o_2 _1411_ (.A1(\inst_sine_B.phase[2] ),
    .A2(\phase_incr_B[2] ),
    .B1(_0681_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0684_));
 sky130_fd_sc_hd__a21o_2 _1412_ (.A1(_0682_),
    .A2(_0683_),
    .B1(_0684_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0685_));
 sky130_fd_sc_hd__and3_2 _1413_ (.A(_0682_),
    .B(_0683_),
    .C(_0684_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0686_));
 sky130_fd_sc_hd__and3b_2 _1414_ (.A_N(_0686_),
    .B(net67),
    .C(_0685_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__or2_2 _1415_ (.A(\inst_sine_B.phase[4] ),
    .B(\phase_incr_B[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0687_));
 sky130_fd_sc_hd__nand2_2 _1416_ (.A(\inst_sine_B.phase[4] ),
    .B(\phase_incr_B[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0688_));
 sky130_fd_sc_hd__inv_2 _1417_ (.A(_0688_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0689_));
 sky130_fd_sc_hd__a21o_2 _1418_ (.A1(\inst_sine_B.phase[3] ),
    .A2(\phase_incr_B[3] ),
    .B1(_0686_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0690_));
 sky130_fd_sc_hd__a21o_2 _1419_ (.A1(_0687_),
    .A2(_0688_),
    .B1(_0690_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0691_));
 sky130_fd_sc_hd__and3_2 _1420_ (.A(_0687_),
    .B(_0688_),
    .C(_0690_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0692_));
 sky130_fd_sc_hd__and3b_2 _1421_ (.A_N(_0692_),
    .B(net67),
    .C(_0691_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__or2_2 _1422_ (.A(\inst_sine_B.phase[5] ),
    .B(\phase_incr_B[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0693_));
 sky130_fd_sc_hd__and2_2 _1423_ (.A(\inst_sine_B.phase[5] ),
    .B(\phase_incr_B[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0694_));
 sky130_fd_sc_hd__nand2_2 _1424_ (.A(\inst_sine_B.phase[5] ),
    .B(\phase_incr_B[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0695_));
 sky130_fd_sc_hd__a211o_2 _1425_ (.A1(_0693_),
    .A2(_0695_),
    .B1(_0689_),
    .C1(_0692_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0696_));
 sky130_fd_sc_hd__o211a_2 _1426_ (.A1(_0689_),
    .A2(_0692_),
    .B1(_0693_),
    .C1(_0695_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0697_));
 sky130_fd_sc_hd__and3b_2 _1427_ (.A_N(_0697_),
    .B(net67),
    .C(_0696_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__or3_2 _1428_ (.A(net33),
    .B(_0694_),
    .C(_0697_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0698_));
 sky130_fd_sc_hd__o21a_2 _1429_ (.A1(_0694_),
    .A2(_0697_),
    .B1(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0699_));
 sky130_fd_sc_hd__and3b_2 _1430_ (.A_N(_0699_),
    .B(net67),
    .C(_0698_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__a21boi_2 _1431_ (.A1(\inst_sine_B.phase[7] ),
    .A2(_0699_),
    .B1_N(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0700_));
 sky130_fd_sc_hd__o21a_2 _1432_ (.A1(\inst_sine_B.phase[7] ),
    .A2(_0699_),
    .B1(_0700_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0082_));
 sky130_fd_sc_hd__or2_2 _1433_ (.A(\inst_sine_A.phase[0] ),
    .B(\phase_incr_A[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0701_));
 sky130_fd_sc_hd__nand2_2 _1434_ (.A(\inst_sine_A.phase[0] ),
    .B(\phase_incr_A[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0702_));
 sky130_fd_sc_hd__and3_2 _1435_ (.A(net66),
    .B(_0701_),
    .C(_0702_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__or2_2 _1436_ (.A(\inst_sine_A.phase[1] ),
    .B(\phase_incr_A[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0703_));
 sky130_fd_sc_hd__nand2_2 _1437_ (.A(\inst_sine_A.phase[1] ),
    .B(\phase_incr_A[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0704_));
 sky130_fd_sc_hd__a21bo_2 _1438_ (.A1(_0703_),
    .A2(_0704_),
    .B1_N(_0702_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0705_));
 sky130_fd_sc_hd__and3b_2 _1439_ (.A_N(_0702_),
    .B(_0703_),
    .C(_0704_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0706_));
 sky130_fd_sc_hd__and3b_2 _1440_ (.A_N(_0706_),
    .B(net66),
    .C(_0705_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__or2_2 _1441_ (.A(\inst_sine_A.phase[2] ),
    .B(\phase_incr_A[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0707_));
 sky130_fd_sc_hd__nand2_2 _1442_ (.A(\inst_sine_A.phase[2] ),
    .B(\phase_incr_A[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0708_));
 sky130_fd_sc_hd__a21o_2 _1443_ (.A1(\inst_sine_A.phase[1] ),
    .A2(\phase_incr_A[1] ),
    .B1(_0706_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0709_));
 sky130_fd_sc_hd__a21o_2 _1444_ (.A1(_0707_),
    .A2(_0708_),
    .B1(_0709_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0710_));
 sky130_fd_sc_hd__and3_2 _1445_ (.A(_0707_),
    .B(_0708_),
    .C(_0709_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0711_));
 sky130_fd_sc_hd__and3b_2 _1446_ (.A_N(_0711_),
    .B(net66),
    .C(_0710_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__or2_2 _1447_ (.A(\inst_sine_A.phase[3] ),
    .B(\phase_incr_A[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0712_));
 sky130_fd_sc_hd__nand2_2 _1448_ (.A(\inst_sine_A.phase[3] ),
    .B(\phase_incr_A[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0713_));
 sky130_fd_sc_hd__a21o_2 _1449_ (.A1(\inst_sine_A.phase[2] ),
    .A2(\phase_incr_A[2] ),
    .B1(_0711_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0714_));
 sky130_fd_sc_hd__a21o_2 _1450_ (.A1(_0712_),
    .A2(_0713_),
    .B1(_0714_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0715_));
 sky130_fd_sc_hd__and3_2 _1451_ (.A(_0712_),
    .B(_0713_),
    .C(_0714_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0716_));
 sky130_fd_sc_hd__and3b_2 _1452_ (.A_N(_0716_),
    .B(net66),
    .C(_0715_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__or2_2 _1453_ (.A(\inst_sine_A.phase[4] ),
    .B(\phase_incr_A[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0717_));
 sky130_fd_sc_hd__nand2_2 _1454_ (.A(\inst_sine_A.phase[4] ),
    .B(\phase_incr_A[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0718_));
 sky130_fd_sc_hd__a21o_2 _1455_ (.A1(\inst_sine_A.phase[3] ),
    .A2(\phase_incr_A[3] ),
    .B1(_0716_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0719_));
 sky130_fd_sc_hd__a21o_2 _1456_ (.A1(_0717_),
    .A2(_0718_),
    .B1(_0719_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0720_));
 sky130_fd_sc_hd__and3_2 _1457_ (.A(_0717_),
    .B(_0718_),
    .C(_0719_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0721_));
 sky130_fd_sc_hd__and3b_2 _1458_ (.A_N(_0721_),
    .B(net67),
    .C(_0720_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__or2_2 _1459_ (.A(\inst_sine_A.phase[5] ),
    .B(\phase_incr_A[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0722_));
 sky130_fd_sc_hd__nand2_2 _1460_ (.A(\inst_sine_A.phase[5] ),
    .B(\phase_incr_A[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0723_));
 sky130_fd_sc_hd__inv_2 _1461_ (.A(_0723_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0724_));
 sky130_fd_sc_hd__a21o_2 _1462_ (.A1(\inst_sine_A.phase[4] ),
    .A2(\phase_incr_A[4] ),
    .B1(_0721_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0725_));
 sky130_fd_sc_hd__a21o_2 _1463_ (.A1(_0722_),
    .A2(_0723_),
    .B1(_0725_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0726_));
 sky130_fd_sc_hd__and3_2 _1464_ (.A(_0722_),
    .B(_0723_),
    .C(_0725_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0727_));
 sky130_fd_sc_hd__and3b_2 _1465_ (.A_N(_0727_),
    .B(net66),
    .C(_0726_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__or2_2 _1466_ (.A(net30),
    .B(\phase_incr_A[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0728_));
 sky130_fd_sc_hd__nand2_2 _1467_ (.A(\inst_sine_A.phase[6] ),
    .B(\phase_incr_A[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0729_));
 sky130_fd_sc_hd__a211o_2 _1468_ (.A1(_0728_),
    .A2(_0729_),
    .B1(_0724_),
    .C1(_0727_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0730_));
 sky130_fd_sc_hd__o211a_2 _1469_ (.A1(_0724_),
    .A2(_0727_),
    .B1(_0728_),
    .C1(_0729_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0731_));
 sky130_fd_sc_hd__and3b_2 _1470_ (.A_N(_0731_),
    .B(net66),
    .C(_0730_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__a21o_2 _1471_ (.A1(\inst_sine_A.phase[6] ),
    .A2(\phase_incr_A[6] ),
    .B1(_0731_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0732_));
 sky130_fd_sc_hd__a21boi_2 _1472_ (.A1(\inst_sine_A.phase[7] ),
    .A2(_0732_),
    .B1_N(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0733_));
 sky130_fd_sc_hd__o21a_2 _1473_ (.A1(\inst_sine_A.phase[7] ),
    .A2(_0732_),
    .B1(_0733_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__buf_1 _1474_ (.A(\inst_sine_A.phase[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__dfxtp_2 _1475_ (.CLK(clknet_4_8_0_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sine_Breg[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1476_ (.CLK(clknet_4_8_0_clk),
    .D(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1477_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Breg[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1478_ (.CLK(clknet_4_8_0_clk),
    .D(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1480_ (.CLK(clknet_4_9_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Breg[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1481_ (.CLK(clknet_4_9_0_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sine_Breg[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1482_ (.CLK(clknet_4_8_0_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sine_Breg[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1483_ (.CLK(clknet_4_1_0_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1484_ (.CLK(clknet_4_3_0_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1485_ (.CLK(clknet_4_4_0_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1486_ (.CLK(clknet_4_4_0_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1487_ (.CLK(clknet_4_6_0_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1488_ (.CLK(clknet_4_4_0_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1489_ (.CLK(clknet_4_5_0_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\boxcar_filter[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1490_ (.CLK(clknet_4_5_0_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1492_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\boxcar_filter[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1493_ (.CLK(clknet_4_1_0_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1494_ (.CLK(clknet_4_2_0_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1495_ (.CLK(clknet_4_7_0_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1496_ (.CLK(clknet_4_1_0_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1500_ (.CLK(clknet_4_5_0_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1501_ (.CLK(clknet_4_0_0_clk),
    .D(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1502_ (.CLK(clknet_4_3_0_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1503_ (.CLK(clknet_4_6_0_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1504_ (.CLK(clknet_4_1_0_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1505_ (.CLK(clknet_4_4_0_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1506_ (.CLK(clknet_4_4_0_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1507_ (.CLK(clknet_4_5_0_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1508_ (.CLK(clknet_4_5_0_clk),
    .D(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1509_ (.CLK(clknet_4_1_0_clk),
    .D(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1511_ (.CLK(clknet_4_7_0_clk),
    .D(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1512_ (.CLK(clknet_4_1_0_clk),
    .D(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1513_ (.CLK(clknet_4_1_0_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1514_ (.CLK(clknet_4_4_0_clk),
    .D(_0063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1515_ (.CLK(clknet_4_5_0_clk),
    .D(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1518_ (.CLK(clknet_4_3_0_clk),
    .D(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1520_ (.CLK(clknet_4_4_0_clk),
    .D(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1521_ (.CLK(clknet_4_4_0_clk),
    .D(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1522_ (.CLK(clknet_4_5_0_clk),
    .D(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1525_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1526_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1527_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1528_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1529_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1530_ (.CLK(clknet_4_11_0_clk),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1531_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sine_Areg[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1532_ (.CLK(clknet_4_11_0_clk),
    .D(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sine_Areg[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1533_ (.CLK(clknet_4_15_0_clk),
    .D(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1534_ (.CLK(clknet_4_12_0_clk),
    .D(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1535_ (.CLK(clknet_4_12_0_clk),
    .D(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1536_ (.CLK(clknet_4_13_0_clk),
    .D(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1537_ (.CLK(clknet_4_13_0_clk),
    .D(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1538_ (.CLK(clknet_4_13_0_clk),
    .D(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1540_ (.CLK(clknet_4_9_0_clk),
    .D(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1543_ (.CLK(clknet_4_15_0_clk),
    .D(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1544_ (.CLK(clknet_4_14_0_clk),
    .D(_0086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1545_ (.CLK(clknet_4_14_0_clk),
    .D(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1546_ (.CLK(clknet_4_14_0_clk),
    .D(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1547_ (.CLK(clknet_4_14_0_clk),
    .D(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1548_ (.CLK(clknet_4_10_0_clk),
    .D(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1550_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _1551_ (.CLK(clknet_4_7_0_clk),
    .D(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _1552_ (.CLK(clknet_4_6_0_clk),
    .D(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1556_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfxtp_2 _1557_ (.CLK(clknet_4_2_0_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1559_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\product[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1560_ (.CLK(clknet_4_0_0_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\product[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1561_ (.CLK(clknet_4_0_0_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\product[11] ));
 sky130_fd_sc_hd__dfxtp_2 _1562_ (.CLK(clknet_4_0_0_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\product[12] ));
 sky130_fd_sc_hd__dfxtp_2 _1563_ (.CLK(clknet_4_0_0_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\product[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1564_ (.CLK(clknet_4_0_0_clk),
    .D(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\product[14] ));
 sky130_fd_sc_hd__dfxtp_2 _1565_ (.CLK(clknet_4_2_0_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\mixer_out[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1566_ (.CLK(clknet_4_2_0_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\mixer_out[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1567_ (.CLK(clknet_4_2_0_clk),
    .D(net91),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1568_ (.CLK(clknet_4_3_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\mixer_out[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1569_ (.CLK(clknet_4_1_0_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\mixer_out[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1570_ (.CLK(clknet_4_1_0_clk),
    .D(net86),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\mixer_out[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1571_ (.CLK(clknet_4_0_0_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\mixer_out[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1572_ (.CLK(clknet_4_0_0_clk),
    .D(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1573_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(filter_on));
 sky130_fd_sc_hd__dfxtp_2 _1574_ (.CLK(clknet_4_14_0_clk),
    .D(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_A[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1575_ (.CLK(clknet_4_14_0_clk),
    .D(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_A[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1576_ (.CLK(clknet_4_15_0_clk),
    .D(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1578_ (.CLK(clknet_4_15_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\phase_incr_A[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1579_ (.CLK(clknet_4_15_0_clk),
    .D(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1580_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\phase_incr_A[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1581_ (.CLK(clknet_4_13_0_clk),
    .D(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(bypass_B));
 sky130_fd_sc_hd__dfxtp_2 _1582_ (.CLK(clknet_4_13_0_clk),
    .D(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(lowamp_B));
 sky130_fd_sc_hd__dfxtp_2 _1583_ (.CLK(clknet_4_15_0_clk),
    .D(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1584_ (.CLK(clknet_4_12_0_clk),
    .D(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1585_ (.CLK(clknet_4_12_0_clk),
    .D(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1586_ (.CLK(clknet_4_12_0_clk),
    .D(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1587_ (.CLK(clknet_4_9_0_clk),
    .D(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1588_ (.CLK(clknet_4_13_0_clk),
    .D(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\phase_incr_B[5] ));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_68 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net68));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_69 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net69));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_70 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net70));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_71 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net71));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net72));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_73 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net73));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net74));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_75 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net75));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_76 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net76));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_77 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net77));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_78 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net78));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_79 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net79));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_80 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net80));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_81 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net81));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos_82 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net82));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input17 (.A(uio_in[7]),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_2 max_cap18 (.A(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_2 max_cap19 (.A(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__buf_2 max_cap20 (.A(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__buf_2 max_cap21 (.A(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__buf_2 max_cap22 (.A(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkbuf_2 max_cap23 (.A(_0455_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkbuf_2 max_cap24 (.A(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_2 max_cap26 (.A(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 max_cap28 (.A(_0098_),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__buf_2 max_cap29 (.A(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(\inst_sine_A.phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 load_slew31 (.A(net32),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__buf_4 load_slew32 (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(\inst_sine_B.phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__buf_4 load_slew34 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_4 load_slew35 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(\sine_Areg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(net38),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(\sine_Areg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(\sine_Areg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(\sine_Areg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(\sine_Areg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(\sine_Areg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout43 (.A(\sine_Areg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(\sine_Areg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout45 (.A(\sine_Areg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout46 (.A(\sine_Areg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout47 (.A(net48),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout48 (.A(\sine_Breg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(\sine_Breg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout50 (.A(\sine_Breg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout51 (.A(\sine_Breg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout52 (.A(\sine_Breg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout53 (.A(\sine_Breg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout54 (.A(\sine_Breg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout55 (.A(\sine_Breg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout56 (.A(\sine_Breg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout57 (.A(\sine_Breg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout58 (.A(\sine_Breg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout59 (.A(\sine_Breg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout67 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__conb_1 tt_um_mng2_2ncos (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 ...
 sky130_fd_sc_hd__clkinv_2 clkload14 (.A(clknet_4_15_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\product[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\product[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\product[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\product[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\boxcar_storage[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\boxcar_storage[3][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\boxcar_storage[3][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\boxcar_storage[3][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\boxcar_storage[1][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\boxcar_storage[2][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\boxcar_storage[3][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\boxcar_storage[1][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net99));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\boxcar_storage[2][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\boxcar_storage[3][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\boxcar_storage[2][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\boxcar_storage[3][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\boxcar_storage[1][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\boxcar_storage[2][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\boxcar_storage[3][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\boxcar_storage[1][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\boxcar_storage[1][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\boxcar_storage[1][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\boxcar_storage[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\boxcar_storage[2][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\boxcar_storage[2][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\boxcar_storage[1][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\product[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\boxcar_storage[1][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\boxcar_storage[3][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\product[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(\product[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\product[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(\mixer_out[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\boxcar_filter[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\mixer_out[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(\boxcar_filter[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\mixer_out[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\mixer_out[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(\boxcar_filter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\mixer_out[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(\boxcar_filter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\boxcar_filter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\boxcar_filter[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\mixer_out[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_29_223 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_29_229 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
