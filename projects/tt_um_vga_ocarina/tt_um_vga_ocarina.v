module tt_um_vga_ocarina (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0550_ (.A(\driver.decoder.data_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__inv_2 _0551_ (.A(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__inv_2 _0552_ (.A(\driver.decoder.data_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0075_));
 sky130_fd_sc_hd__inv_2 _0553_ (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__inv_2 _0554_ (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_2 _0555_ (.A(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__inv_2 _0556_ (.A(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__inv_2 _0557_ (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0080_));
 sky130_fd_sc_hd__inv_2 _0558_ (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0559_ (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__inv_2 _0560_ (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__and4_2 _0561_ (.A(net46),
    .B(net48),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__nand4_2 _0562_ (.A(net46),
    .B(net48),
    .C(\driver.decoder.data_reg[5] ),
    .D(\driver.decoder.data_reg[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0085_));
 sky130_fd_sc_hd__and4_2 _0563_ (.A(\driver.decoder.data_reg[3] ),
    .B(net49),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__nand4_2 _0564_ (.A(\driver.decoder.data_reg[3] ),
    .B(net49),
    .C(\driver.decoder.data_reg[1] ),
    .D(\driver.decoder.data_reg[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__and4_2 _0565_ (.A(\driver.decoder.data_reg[11] ),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__nand4_2 _0566_ (.A(\driver.decoder.data_reg[11] ),
    .B(\driver.decoder.data_reg[10] ),
    .C(\driver.decoder.data_reg[9] ),
    .D(\driver.decoder.data_reg[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__or3_2 _0567_ (.A(_0085_),
    .B(_0087_),
    .C(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__o31a_2 _0568_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__nand2_2 _0569_ (.A(\driver.decoder.data_reg[0] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__o31a_2 _0570_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__nor2_2 _0571_ (.A(_0091_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0094_));
 sky130_fd_sc_hd__or2_2 _0572_ (.A(_0091_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__and2_2 _0573_ (.A(\driver.decoder.data_reg[10] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__a31o_2 _0574_ (.A1(_0084_),
    .A2(_0086_),
    .A3(_0088_),
    .B1(_0073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__o31a_2 _0575_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__nand2_2 _0576_ (.A(net49),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0099_));
 sky130_fd_sc_hd__o32a_2 _0577_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(net49),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__o21a_2 _0578_ (.A1(\driver.decoder.data_reg[10] ),
    .A2(net49),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__or2_2 _0579_ (.A(_0098_),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__nor2_2 _0580_ (.A(_0095_),
    .B(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0103_));
 sky130_fd_sc_hd__or2_2 _0581_ (.A(_0095_),
    .B(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__and2_2 _0582_ (.A(tone_ff),
    .B(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(audio));
 sky130_fd_sc_hd__or2_2 _0583_ (.A(\pix_x[8] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__inv_2 _0584_ (.A(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__and2_2 _0585_ (.A(net26),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__and2_2 _0586_ (.A(net33),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__and3_2 _0587_ (.A(net33),
    .B(net32),
    .C(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__a31o_2 _0588_ (.A1(net33),
    .A2(net32),
    .A3(net31),
    .B1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__a21oi_2 _0589_ (.A1(_0107_),
    .A2(_0110_),
    .B1(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__a21o_2 _0590_ (.A1(_0107_),
    .A2(_0110_),
    .B1(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__or2_2 _0591_ (.A(\pix_x[0] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__and2_2 _0592_ (.A(\pix_x[0] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0114_));
 sky130_fd_sc_hd__nand2_2 _0593_ (.A(_0111_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__a2bb2o_2 _0594_ (.A1_N(_0114_),
    .A2_N(_0115_),
    .B1(net34),
    .B2(_0112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__nor2_2 _0595_ (.A(net36),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__or2_2 _0596_ (.A(net36),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__and2_2 _0597_ (.A(net38),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__nand2_2 _0598_ (.A(net38),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__a21oi_2 _0599_ (.A1(net45),
    .A2(net44),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__a211o_2 _0600_ (.A1(net45),
    .A2(net44),
    .B1(net43),
    .C1(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__nand2_2 _0601_ (.A(net40),
    .B(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0123_));
 sky130_fd_sc_hd__nor2_2 _0602_ (.A(_0120_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__nor2_2 _0603_ (.A(_0118_),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0125_));
 sky130_fd_sc_hd__a31o_2 _0604_ (.A1(net40),
    .A2(_0119_),
    .A3(_0122_),
    .B1(_0118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__nor2_2 _0605_ (.A(\pix_y[0] ),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__or2_2 _0606_ (.A(\pix_y[0] ),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__and2_2 _0607_ (.A(\pix_y[0] ),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__nor2_2 _0608_ (.A(_0127_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__nor2_2 _0609_ (.A(_0126_),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__a21o_2 _0610_ (.A1(_0076_),
    .A2(_0126_),
    .B1(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__nor2_2 _0611_ (.A(_0116_),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__or2_2 _0612_ (.A(\pix_y[0] ),
    .B(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__nand3_2 _0613_ (.A(\pix_y[0] ),
    .B(net45),
    .C(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__o21ai_2 _0614_ (.A1(net44),
    .A2(_0129_),
    .B1(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__inv_2 _0615_ (.A(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0137_));
 sky130_fd_sc_hd__nand3_2 _0616_ (.A(_0126_),
    .B(_0134_),
    .C(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__a21o_2 _0617_ (.A1(_0126_),
    .A2(_0134_),
    .B1(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__xnor2_2 _0618_ (.A(_0077_),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0140_));
 sky130_fd_sc_hd__a21oi_2 _0619_ (.A1(_0138_),
    .A2(_0139_),
    .B1(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__nor2_2 _0620_ (.A(_0133_),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__a22oi_2 _0621_ (.A1(\pix_x[0] ),
    .A2(\pix_y[0] ),
    .B1(_0116_),
    .B2(_0132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0143_));
 sky130_fd_sc_hd__nand3_2 _0622_ (.A(_0138_),
    .B(_0139_),
    .C(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__o2111a_2 _0623_ (.A1(\pix_x[0] ),
    .A2(\pix_y[0] ),
    .B1(_0142_),
    .C1(_0143_),
    .D1(_0144_),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__o31a_2 _0624_ (.A1(_0133_),
    .A2(_0141_),
    .A3(_0143_),
    .B1(_0144_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__nand2_2 _0625_ (.A(_0108_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__nor2_2 _0626_ (.A(net33),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__or2_2 _0627_ (.A(net33),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__or2_2 _0628_ (.A(net32),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__a31o_2 _0629_ (.A1(_0147_),
    .A2(_0149_),
    .A3(_0150_),
    .B1(_0112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__or3_2 _0630_ (.A(_0108_),
    .B(_0111_),
    .C(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__and3_2 _0631_ (.A(net45),
    .B(net44),
    .C(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__nand2_2 _0632_ (.A(_0081_),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__nor2_2 _0633_ (.A(_0081_),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__or2_2 _0634_ (.A(_0081_),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__a21o_2 _0635_ (.A1(_0154_),
    .A2(_0156_),
    .B1(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__o31ai_2 _0636_ (.A1(_0121_),
    .A2(_0125_),
    .A3(_0153_),
    .B1(_0157_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__and3_2 _0637_ (.A(_0151_),
    .B(_0152_),
    .C(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__a21oi_2 _0638_ (.A1(_0151_),
    .A2(_0152_),
    .B1(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__nor2_2 _0639_ (.A(_0159_),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__xnor2_2 _0640_ (.A(_0146_),
    .B(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__and2_2 _0641_ (.A(_0109_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _0642_ (.A(_0112_),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__a21o_2 _0643_ (.A1(_0109_),
    .A2(_0112_),
    .B1(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__xnor2_2 _0644_ (.A(_0078_),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__or2_2 _0645_ (.A(net42),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__o2bb2a_2 _0646_ (.A1_N(_0125_),
    .A2_N(_0167_),
    .B1(_0117_),
    .B2(_0122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__xnor2_2 _0647_ (.A(net40),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0169_));
 sky130_fd_sc_hd__and2_2 _0648_ (.A(net40),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__a21oi_2 _0649_ (.A1(net39),
    .A2(_0170_),
    .B1(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__o21ai_2 _0650_ (.A1(net39),
    .A2(_0170_),
    .B1(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0172_));
 sky130_fd_sc_hd__or3b_2 _0651_ (.A(net39),
    .B(_0117_),
    .C_N(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__and3_2 _0652_ (.A(net38),
    .B(net39),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__nor2_2 _0653_ (.A(_0118_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__or3b_2 _0654_ (.A(_0175_),
    .B(_0123_),
    .C_N(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0176_));
 sky130_fd_sc_hd__nor2_2 _0655_ (.A(net28),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__o22a_2 _0656_ (.A1(_0106_),
    .A2(_0110_),
    .B1(_0112_),
    .B2(_0177_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__xor2_2 _0657_ (.A(net26),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__a31o_2 _0658_ (.A1(_0172_),
    .A2(_0173_),
    .A3(_0176_),
    .B1(_0179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__o21bai_2 _0659_ (.A1(_0166_),
    .A2(_0169_),
    .B1_N(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__o21bai_2 _0660_ (.A1(_0146_),
    .A2(_0159_),
    .B1_N(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__a21o_2 _0661_ (.A1(_0108_),
    .A2(_0113_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__nor2_2 _0662_ (.A(net31),
    .B(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__o21a_2 _0663_ (.A1(_0109_),
    .A2(_0184_),
    .B1(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__a21oi_2 _0664_ (.A1(_0164_),
    .A2(_0183_),
    .B1(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__nand2_2 _0665_ (.A(net42),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__or2_2 _0666_ (.A(_0082_),
    .B(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__a21oi_2 _0667_ (.A1(_0122_),
    .A2(_0188_),
    .B1(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__a31o_2 _0668_ (.A1(_0125_),
    .A2(_0167_),
    .A3(_0187_),
    .B1(_0189_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__and2_2 _0669_ (.A(_0186_),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__or2_2 _0670_ (.A(_0186_),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _0671_ (.A(_0166_),
    ...
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__o211a_2 _0672_ (.A1(_0182_),
    .A2(_0191_),
    .B1(_0192_),
    .C1(_0193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__o22a_2 _0673_ (.A1(_0145_),
    .A2(_0162_),
    .B1(_0181_),
    .B2(_0194_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__a21o_2 _0674_ (.A1(_0182_),
    .A2(_0191_),
    .B1(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__or2_2 _0675_ (.A(_0182_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__and4_2 _0676_ (.A(_0172_),
    .B(_0173_),
    .C(_0176_),
    .D(_0179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__and2b_2 _0677_ (.A_N(_0171_),
    .B(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__a21o_2 _0678_ (.A1(net26),
    .A2(_0110_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__a211oi_2 _0679_ (.A1(\pix_x[8] ),
    .A2(_0200_),
    .B1(net35),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__or2_2 _0680_ (.A(net25),
    .B(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__o21a_2 _0681_ (.A1(net28),
    .A2(_0163_),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__o2bb2a_2 _0682_ (.A1_N(net36),
    .A2_N(_0124_),
    .B1(_0202_),
    .B2(_0203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__o211a_2 _0683_ (.A1(net38),
    .A2(_0199_),
    .B1(_0201_),
    .C1(_0204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__a21bo_2 _0684_ (.A1(net38),
    .A2(_0199_),
    .B1_N(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__a221o_2 _0685_ (.A1(_0193_),
    .A2(_0196_),
    .B1(_0197_),
    .B2(_0181_),
    .C1(_0206_),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__or3_2 _0686_ (.A(_0195_),
    .B(_0198_),
    .C(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__and3_2 _0687_ (.A(net26),
    .B(net25),
    .C(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__nand2_2 _0688_ (.A(\pix_x[8] ),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__or3b_2 _0689_ (.A(\pix_x[0] ),
    .B(net23),
    .C_N(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__o22a_2 _0690_ (.A1(net34),
    .A2(net23),
    .B1(_0210_),
    .B2(_0211_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0212_));
 sky130_fd_sc_hd__nor2_2 _0691_ (.A(net32),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__or2_2 _0692_ (.A(net31),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__o32a_2 _0693_ (.A1(net28),
    .A2(_0212_),
    .A3(_0214_),
    .B1(net23),
    .B2(_0209_),
    ...
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__or2_2 _0694_ (.A(_0079_),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__or3b_2 _0695_ (.A(_0216_),
    .B(net26),
    .C_N(net25),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _0696_ (.A(_0217_),
    ...
    .VPWR(VPWR),
    .Y(_0218_));
 sky130_fd_sc_hd__a311o_2 _0697_ (.A1(net28),
    .A2(_0214_),
    .A3(_0218_),
    .B1(net23),
    .C1(_0209_),
    ...
    .VPWR(VPWR),
    .X(_0219_));
 sky130_fd_sc_hd__or2_2 _0698_ (.A(net30),
    .B(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__o41a_2 _0699_ (.A1(_0077_),
    .A2(_0150_),
    .A3(_0217_),
    .A4(_0220_),
    .B1(_0219_),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__a311o_2 _0700_ (.A1(net44),
    .A2(net43),
    .A3(_0128_),
    .B1(net40),
    .C1(net42),
    ...
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__nand2_2 _0701_ (.A(_0221_),
    .B(_0222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__and2_2 _0702_ (.A(net42),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__and3_2 _0703_ (.A(net42),
    .B(net38),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__a211oi_2 _0704_ (.A1(_0153_),
    .A2(_0225_),
    .B1(net36),
    .C1(_0119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__nor3_2 _0705_ (.A(net38),
    .B(\pix_y[6] ),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__or3_2 _0706_ (.A(net38),
    .B(\pix_y[6] ),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__a31o_2 _0707_ (.A1(net42),
    .A2(net36),
    .A3(_0227_),
    .B1(_0226_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__and3_2 _0708_ (.A(net36),
    .B(_0153_),
    .C(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__a21o_2 _0709_ (.A1(net36),
    .A2(_0228_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__or2_2 _0710_ (.A(\pix_y[0] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__mux2_1 _0711_ (.A0(_0231_),
    .A1(_0232_),
    .S(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__or4_2 _0712_ (.A(_0111_),
    .B(_0221_),
    .C(_0229_),
    .D(_0233_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__o41a_2 _0713_ (.A1(_0118_),
    .A2(_0120_),
    .A3(_0215_),
    .A4(_0223_),
    .B1(_0234_),
    ...
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__nand2_2 _0714_ (.A(_0208_),
    .B(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__or4b_2 _0715_ (.A(net44),
    .B(net43),
    .C(net35),
    .D_N(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__or4bb_2 _0716_ (.A(net45),
    .B(net42),
    .C_N(net40),
    .D_N(\pix_y[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__o311a_2 _0717_ (.A1(net44),
    .A2(net43),
    .A3(_0128_),
    .B1(net40),
    .C1(_0082_),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__o32a_2 _0718_ (.A1(net35),
    .A2(_0224_),
    .A3(_0239_),
    .B1(_0238_),
    .B2(_0237_),
    ...
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__nand3_2 _0719_ (.A(net30),
    .B(net28),
    .C(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0241_));
 sky130_fd_sc_hd__a2111oi_1 _0720_ (.A1(net34),
    .A2(_0108_),
    .B1(_0148_),
    .C1(_0216_),
    .D1(_0241_),
    ...
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__a21oi_2 _0721_ (.A1(net43),
    .A2(\pix_y[4] ),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__or4b_2 _0722_ (.A(\pix_y[7] ),
    .B(\pix_y[6] ),
    .C(_0243_),
    .D_N(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__or3b_2 _0723_ (.A(_0244_),
    .B(_0240_),
    .C_N(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__o211a_2 _0724_ (.A1(\pix_y[2] ),
    .A2(net43),
    .B1(_0083_),
    .C1(_0225_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__nand3_2 _0725_ (.A(_0226_),
    .B(net12),
    .C(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__nand2_2 _0726_ (.A(_0245_),
    .B(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0248_));
 sky130_fd_sc_hd__nand2_2 _0727_ (.A(_0082_),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0249_));
 sky130_fd_sc_hd__or3_2 _0728_ (.A(\pix_y[1] ),
    .B(\pix_y[2] ),
    .C(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__or4_2 _0729_ (.A(\pix_y[3] ),
    .B(net35),
    .C(_0228_),
    .D(_0250_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__o311a_2 _0730_ (.A1(_0134_),
    .A2(_0237_),
    .A3(_0249_),
    .B1(_0251_),
    .C1(_0118_),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__a21oi_2 _0731_ (.A1(_0119_),
    .A2(_0224_),
    .B1(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__a311o_2 _0732_ (.A1(_0081_),
    .A2(_0117_),
    .A3(_0135_),
    .B1(_0252_),
    .C1(_0253_),
    ...
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__a211o_2 _0733_ (.A1(net34),
    .A2(net33),
    .B1(net32),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__or3b_2 _0734_ (.A(net29),
    .B(_0217_),
    .C_N(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__or4b_2 _0735_ (.A(net34),
    .B(_0079_),
    .C(_0149_),
    .D_N(\pix_x[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__o211a_2 _0736_ (.A1(_0113_),
    .A2(_0149_),
    .B1(_0257_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__or3_2 _0737_ (.A(_0254_),
    .B(_0256_),
    .C(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__o21ai_2 _0738_ (.A1(net34),
    .A2(net33),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0260_));
 sky130_fd_sc_hd__or3_2 _0739_ (.A(_0105_),
    .B(_0241_),
    .C(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__or2_2 _0740_ (.A(net25),
    .B(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__or4_2 _0741_ (.A(net29),
    .B(net26),
    .C(_0255_),
    .D(_0262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__a21o_2 _0742_ (.A1(_0261_),
    .A2(_0263_),
    .B1(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__or3b_2 _0743_ (.A(_0262_),
    .B(net29),
    .C_N(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0265_));
 sky130_fd_sc_hd__or4_2 _0744_ (.A(net30),
    .B(_0108_),
    .C(_0254_),
    .D(_0265_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__and4_2 _0745_ (.A(_0078_),
    .B(net27),
    .C(net25),
    .D(_0079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__o21a_2 _0746_ (.A1(\pix_x[2] ),
    .A2(_0113_),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0268_));
 sky130_fd_sc_hd__a41o_2 _0747_ (.A1(net30),
    .A2(net29),
    .A3(net25),
    .A4(_0268_),
    .B1(_0107_),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__o21ai_2 _0748_ (.A1(\pix_y[3] ),
    .A2(\pix_y[4] ),
    .B1(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0270_));
 sky130_fd_sc_hd__and4_2 _0749_ (.A(\pix_y[1] ),
    .B(_0080_),
    .C(\pix_y[3] ),
    .D(_0082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__or3_2 _0750_ (.A(net41),
    .B(_0118_),
    .C(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__or3b_2 _0751_ (.A(_0272_),
    .B(_0270_),
    .C_N(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__o21a_2 _0752_ (.A1(net30),
    .A2(_0268_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__or3_2 _0753_ (.A(net27),
    .B(_0177_),
    .C(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0275_));
 sky130_fd_sc_hd__or3_2 _0754_ (.A(_0273_),
    .B(_0274_),
    .C(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__nor2_2 _0755_ (.A(_0114_),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__and2_2 _0756_ (.A(_0108_),
    .B(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__or2_2 _0757_ (.A(net30),
    .B(_0278_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__or4b_2 _0758_ (.A(_0078_),
    .B(net25),
    .C(_0216_),
    .D_N(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__or4_2 _0759_ (.A(_0273_),
    .B(_0277_),
    .C(_0279_),
    .D(_0280_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__and4bb_2 _0760_ (.A_N(_0232_),
    .B_N(net37),
    .C(_0174_),
    .D(_0271_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__a211o_2 _0761_ (.A1(_0117_),
    .A2(_0270_),
    .B1(_0282_),
    .C1(_0175_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__o41a_2 _0762_ (.A1(net34),
    .A2(\pix_x[2] ),
    .A3(\pix_x[3] ),
    .A4(net30),
    .B1(_0267_),
    ...
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__or3b_2 _0763_ (.A(_0211_),
    .B(_0214_),
    .C_N(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__o21ai_2 _0764_ (.A1(_0112_),
    .A2(_0284_),
    .B1(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__a211o_2 _0765_ (.A1(\pix_x[7] ),
    .A2(_0258_),
    .B1(_0256_),
    .C1(_0254_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__or4_2 _0766_ (.A(_0273_),
    .B(_0277_),
    .C(_0279_),
    .D(_0280_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__and3_2 _0767_ (.A(_0276_),
    .B(_0287_),
    .C(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__and3_2 _0768_ (.A(_0264_),
    .B(_0266_),
    .C(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__and4_2 _0769_ (.A(_0119_),
    .B(_0239_),
    .C(_0269_),
    .D(_0286_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__nand2_2 _0770_ (.A(_0283_),
    .B(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__or4bb_2 _0771_ (.A(_0236_),
    .B(_0248_),
    .C_N(_0290_),
    .D_N(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__nand2_2 _0772_ (.A(_0124_),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0294_));
 sky130_fd_sc_hd__o21a_2 _0773_ (.A1(\pix_x[1] ),
    .A2(_0149_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__or3b_2 _0774_ (.A(net29),
    .B(net27),
    .C_N(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__or3_2 _0775_ (.A(_0202_),
    .B(_0213_),
    .C(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__nor3_2 _0776_ (.A(_0294_),
    .B(_0295_),
    .C(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__nand3b_2 _0777_ (.A_N(_0298_),
    ...
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__or4bb_2 _0778_ (.A(\pix_x[1] ),
    .B(\pix_x[2] ),
    .C_N(\pix_x[3] ),
    .D_N(\pix_x[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__o21a_2 _0779_ (.A1(_0220_),
    .A2(_0300_),
    .B1(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__or4b_2 _0780_ (.A(_0078_),
    .B(_0079_),
    .C(net23),
    .D_N(_0107_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__or3_2 _0781_ (.A(_0294_),
    .B(_0301_),
    .C(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__o31ai_2 _0782_ (.A1(_0294_),
    .A2(_0295_),
    .A3(_0297_),
    .B1(_0303_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__nand2_2 _0783_ (.A(_0299_),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0305_));
 sky130_fd_sc_hd__a21o_2 _0784_ (.A1(net48),
    .A2(net18),
    .B1(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__a21o_2 _0785_ (.A1(net46),
    .A2(net18),
    .B1(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__and3_2 _0786_ (.A(_0305_),
    .B(_0306_),
    .C(_0307_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a21o_2 _0787_ (.A1(_0107_),
    .A2(_0274_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__o41a_2 _0788_ (.A1(net23),
    .A2(_0210_),
    .A3(_0220_),
    .A4(_0300_),
    .B1(_0309_),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__or4_2 _0789_ (.A(_0078_),
    .B(_0210_),
    .C(_0294_),
    .D(_0310_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__a221o_2 _0790_ (.A1(net37),
    .A2(_0174_),
    .B1(_0202_),
    .B2(net24),
    .C1(net35),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__and3_2 _0791_ (.A(\driver.decoder.data_reg[4] ),
    .B(net18),
    .C(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__or2_2 _0792_ (.A(_0312_),
    .B(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__nor2_2 _0793_ (.A(_0299_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__a211oi_4 _0794_ (.A1(_0293_),
    .A2(_0308_),
    .B1(_0314_),
    .C1(_0315_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__or2_2 _0795_ (.A(_0098_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__nand2b_2 _0796_ (.A_N(_0266_),
    .B(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__or2_2 _0797_ (.A(_0096_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__mux2_1 _0798_ (.A0(_0091_),
    .A1(net17),
    .S(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__a21bo_2 _0799_ (.A1(_0276_),
    .A2(_0281_),
    .B1_N(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__nand2_2 _0800_ (.A(_0264_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__a21bo_2 _0801_ (.A1(_0318_),
    .A2(_0321_),
    .B1_N(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__a21bo_2 _0802_ (.A1(_0317_),
    .A2(_0322_),
    .B1_N(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0323_));
 sky130_fd_sc_hd__a21o_2 _0803_ (.A1(_0316_),
    .A2(_0323_),
    .B1(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__or2_2 _0804_ (.A(_0304_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__and2_2 _0805_ (.A(_0236_),
    .B(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__o221a_2 _0806_ (.A1(_0098_),
    .A2(_0287_),
    .B1(_0288_),
    .B2(_0091_),
    .C1(_0276_),
    ...
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__and4_2 _0807_ (.A(_0317_),
    .B(_0318_),
    .C(_0325_),
    .D(_0326_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__o21a_2 _0808_ (.A1(_0324_),
    .A2(_0327_),
    .B1(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__or3_2 _0809_ (.A(_0313_),
    .B(_0315_),
    .C(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__nand2_2 _0810_ (.A(_0290_),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__inv_2 _0811_ (.A(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uo_out[0]));
 sky130_fd_sc_hd__a21oi_2 _0812_ (.A1(_0308_),
    .A2(_0329_),
    .B1(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net7));
 sky130_fd_sc_hd__and2_2 _0813_ (.A(\driver.decoder.data_reg[5] ),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__nand2_2 _0814_ (.A(net48),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__and3_2 _0815_ (.A(net48),
    .B(\driver.decoder.data_reg[5] ),
    .C(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__nand2_2 _0816_ (.A(net48),
    .B(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__nand2_2 _0817_ (.A(net46),
    .B(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__o311a_2 _0818_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[0] ),
    .C1(net48),
    ...
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__and2_2 _0819_ (.A(net46),
    .B(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__nand2_2 _0820_ (.A(net46),
    .B(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__nand2_2 _0821_ (.A(\driver.decoder.data_reg[4] ),
    .B(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__and3_2 _0822_ (.A(\driver.decoder.data_reg[10] ),
    .B(net46),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__nand2_2 _0823_ (.A(net46),
    .B(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__o311a_2 _0824_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[3] ),
    .C1(net46),
    ...
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__nand2_2 _0825_ (.A(net46),
    .B(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__o311a_2 _0826_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(net49),
    .C1(net47),
    ...
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__nand3_2 _0827_ (.A(net47),
    .B(net49),
    .C(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__o311a_2 _0828_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[3] ),
    .C1(\driver.decoder.data_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__a311o_2 _0829_ (.A1(_0084_),
    .A2(_0086_),
    .A3(_0088_),
    .B1(_0075_),
    .C1(_0074_),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__and2b_2 _0830_ (.A_N(_0345_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__inv_2 _0831_ (.A(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__or4b_2 _0832_ (.A(_0341_),
    .B(_0343_),
    .C(_0345_),
    .D_N(_0346_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _0833_ (.A(_0339_),
    ...
    .VPWR(VPWR),
    .Y(_0350_));
 sky130_fd_sc_hd__o311a_2 _0834_ (.A1(_0085_),
    .A2(_0087_),
    .A3(_0089_),
    .B1(\driver.decoder.data_reg[6] ),
    .C1(\driver.decoder.data_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__inv_2 _0835_ (.A(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__a211o_2 _0836_ (.A1(_0094_),
    .A2(_0101_),
    .B1(_0339_),
    .C1(_0349_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__o21ai_2 _0837_ (.A1(_0351_),
    .A2(_0353_),
    .B1(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__a21o_2 _0838_ (.A1(_0337_),
    .A2(_0354_),
    .B1(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__o21a_2 _0839_ (.A1(net48),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__nand2_2 _0840_ (.A(\driver.decoder.data_reg[4] ),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__a21oi_2 _0841_ (.A1(_0334_),
    .A2(_0355_),
    .B1(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0358_));
 sky130_fd_sc_hd__a31oi_2 _0842_ (.A1(_0090_),
    .A2(net11),
    .A3(_0358_),
    .B1(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__a21oi_2 _0843_ (.A1(net47),
    .A2(_0093_),
    .B1(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__inv_2 _0844_ (.A(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__or3_2 _0845_ (.A(_0336_),
    .B(_0356_),
    .C(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__or4bb_2 _0846_ (.A(_0336_),
    .B(_0356_),
    .C_N(net11),
    .D_N(_0360_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__o21a_2 _0847_ (.A1(_0075_),
    .A2(net49),
    .B1(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__o21ai_2 _0848_ (.A1(_0095_),
    .A2(_0364_),
    .B1(_0342_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__a31o_2 _0849_ (.A1(_0344_),
    .A2(_0347_),
    .A3(_0365_),
    .B1(_0339_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _0850_ (.A1(_0352_),
    ...
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__a22o_2 _0851_ (.A1(\tone_counter[4] ),
    .A2(_0359_),
    .B1(_0367_),
    .B2(\tone_counter[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__a31o_2 _0852_ (.A1(_0092_),
    .A2(_0097_),
    .A3(_0099_),
    .B1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__a211o_2 _0853_ (.A1(_0342_),
    .A2(_0369_),
    .B1(_0348_),
    .C1(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__a21o_2 _0854_ (.A1(_0340_),
    .A2(_0370_),
    .B1(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__a31o_2 _0855_ (.A1(_0337_),
    .A2(_0338_),
    .A3(_0371_),
    .B1(_0335_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__a31o_2 _0856_ (.A1(_0331_),
    .A2(_0334_),
    .A3(_0372_),
    .B1(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__a21oi_2 _0857_ (.A1(\driver.decoder.data_reg[4] ),
    .A2(_0091_),
    .B1(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__or2_2 _0858_ (.A(_0093_),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__nand3_2 _0859_ (.A(_0073_),
    .B(net49),
    .C(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0376_));
 sky130_fd_sc_hd__a31o_2 _0860_ (.A1(_0094_),
    .A2(_0342_),
    .A3(_0376_),
    .B1(_0345_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__a22o_2 _0861_ (.A1(net47),
    .A2(_0101_),
    .B1(_0346_),
    .B2(_0377_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__a21o_2 _0862_ (.A1(_0374_),
    .A2(_0378_),
    .B1(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__and2b_2 _0863_ (.A_N(_0330_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__and2b_2 _0864_ (.A_N(_0339_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__a21oi_2 _0865_ (.A1(_0097_),
    .A2(_0100_),
    .B1(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__o31a_2 _0866_ (.A1(_0345_),
    .A2(_0375_),
    .A3(_0382_),
    .B1(_0346_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__o21ai_2 _0867_ (.A1(_0343_),
    .A2(_0383_),
    .B1(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__a32o_2 _0868_ (.A1(_0337_),
    .A2(_0360_),
    .A3(_0384_),
    .B1(_0093_),
    .B2(net48),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__o31a_2 _0869_ (.A1(_0094_),
    .A2(_0339_),
    .A3(_0349_),
    .B1(_0374_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__or2_2 _0870_ (.A(_0363_),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__or2_2 _0871_ (.A(\tone_counter[1] ),
    .B(\tone_counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__nor2_2 _0872_ (.A(_0387_),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__a211o_2 _0873_ (.A1(_0380_),
    .A2(_0385_),
    .B1(_0389_),
    .C1(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0390_));
 sky130_fd_sc_hd__nand2_2 _0874_ (.A(\tone_counter[1] ),
    .B(\tone_counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__nand2_2 _0875_ (.A(_0090_),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__a31o_2 _0876_ (.A1(\tone_counter[1] ),
    .A2(_0333_),
    .A3(_0387_),
    .B1(_0392_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__a21oi_2 _0877_ (.A1(\tone_counter[2] ),
    .A2(_0379_),
    .B1(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0394_));
 sky130_fd_sc_hd__o2bb2a_2 _0878_ (.A1_N(_0394_),
    .A2_N(_0390_),
    .B1(_0379_),
    .B2(\tone_counter[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__a41o_2 _0879_ (.A1(\tone_counter[3] ),
    .A2(_0333_),
    .A3(net11),
    .A4(_0373_),
    .B1(_0395_),
    ...
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__a31o_2 _0880_ (.A1(_0333_),
    .A2(net11),
    .A3(_0373_),
    .B1(\tone_counter[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__or2_2 _0881_ (.A(\tone_counter[4] ),
    .B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__a31o_2 _0882_ (.A1(_0396_),
    .A2(_0397_),
    .A3(_0398_),
    .B1(_0368_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__o31a_2 _0883_ (.A1(_0095_),
    .A2(_0101_),
    .A3(_0341_),
    .B1(_0347_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__o21ai_2 _0884_ (.A1(_0343_),
    .A2(_0400_),
    .B1(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0401_));
 sky130_fd_sc_hd__a21o_2 _0885_ (.A1(_0337_),
    .A2(_0401_),
    .B1(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__a21o_2 _0886_ (.A1(_0334_),
    .A2(_0402_),
    .B1(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__a21o_2 _0887_ (.A1(_0357_),
    .A2(_0403_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__o22a_2 _0888_ (.A1(\tone_counter[5] ),
    .A2(_0367_),
    .B1(_0404_),
    .B2(\tone_counter[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__o211a_2 _0889_ (.A1(_0349_),
    .A2(_0369_),
    .B1(_0381_),
    .C1(_0337_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__o21ai_2 _0890_ (.A1(_0335_),
    .A2(_0406_),
    .B1(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__a21boi_2 _0891_ (.A1(_0331_),
    .A2(_0407_),
    .B1_N(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__a22o_2 _0892_ (.A1(\tone_counter[6] ),
    .A2(_0404_),
    .B1(_0408_),
    .B2(\tone_counter[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__a21o_2 _0893_ (.A1(_0399_),
    .A2(_0405_),
    .B1(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__or3_2 _0894_ (.A(\driver.decoder.data_reg[10] ),
    .B(_0075_),
    ...
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__a211o_2 _0895_ (.A1(_0092_),
    .A2(_0411_),
    .B1(_0375_),
    .C1(_0348_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__a21oi_2 _0896_ (.A1(_0344_),
    .A2(_0412_),
    .B1(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__o21ai_2 _0897_ (.A1(_0351_),
    .A2(_0413_),
    .B1(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0414_));
 sky130_fd_sc_hd__a211o_2 _0898_ (.A1(_0337_),
    .A2(_0414_),
    .B1(_0361_),
    .C1(_0356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__and3_2 _0899_ (.A(_0333_),
    .B(net11),
    .C(_0415_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__o22a_2 _0900_ (.A1(\tone_counter[7] ),
    .A2(_0408_),
    .B1(_0416_),
    .B2(\tone_counter[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__and3_2 _0901_ (.A(net18),
    .B(_0333_),
    .C(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__a41o_2 _0902_ (.A1(_0104_),
    .A2(_0344_),
    .A3(_0346_),
    .A4(_0381_),
    .B1(_0336_),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__a31o_2 _0903_ (.A1(_0331_),
    .A2(_0360_),
    .A3(_0419_),
    .B1(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__nand2_2 _0904_ (.A(_0418_),
    .B(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0421_));
 sky130_fd_sc_hd__a22o_2 _0905_ (.A1(\tone_counter[8] ),
    .A2(_0416_),
    .B1(_0421_),
    .B2(\tone_counter[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__a21o_2 _0906_ (.A1(_0410_),
    .A2(_0417_),
    .B1(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__o21bai_2 _0907_ (.A1(_0073_),
    ...
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__a21oi_2 _0908_ (.A1(_0347_),
    .A2(_0424_),
    .B1(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__o21ai_2 _0909_ (.A1(_0339_),
    .A2(_0425_),
    .B1(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__a21oi_2 _0910_ (.A1(_0337_),
    .A2(_0426_),
    .B1(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__o211a_2 _0911_ (.A1(_0356_),
    .A2(_0427_),
    .B1(net11),
    .C1(_0333_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__o22a_2 _0912_ (.A1(\tone_counter[9] ),
    .A2(_0421_),
    .B1(_0428_),
    .B2(\tone_counter[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__a21o_2 _0913_ (.A1(_0092_),
    .A2(_0097_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__a21o_2 _0914_ (.A1(_0350_),
    .A2(_0430_),
    .B1(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__a21o_2 _0915_ (.A1(_0338_),
    .A2(_0431_),
    .B1(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__o21ai_2 _0916_ (.A1(_0336_),
    .A2(_0432_),
    .B1(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__a21o_2 _0917_ (.A1(_0331_),
    .A2(_0433_),
    .B1(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__nand2_2 _0918_ (.A(_0418_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__a22o_2 _0919_ (.A1(\tone_counter[10] ),
    .A2(_0428_),
    .B1(_0435_),
    .B2(\tone_counter[11] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__a21o_2 _0920_ (.A1(_0423_),
    .A2(_0429_),
    .B1(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__a31o_2 _0921_ (.A1(_0095_),
    .A2(_0350_),
    .A3(_0374_),
    .B1(_0362_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__and2b_2 _0922_ (.A_N(_0102_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__o211a_2 _0923_ (.A1(_0438_),
    .A2(_0439_),
    .B1(_0333_),
    .C1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a21oi_2 _0924_ (.A1(net11),
    .A2(_0438_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__a22o_2 _0925_ (.A1(\tone_counter[14] ),
    .A2(_0440_),
    .B1(_0441_),
    .B2(\tone_counter[15] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__or2_2 _0926_ (.A(\tone_counter[15] ),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__a21oi_2 _0927_ (.A1(_0092_),
    .A2(_0101_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__o21ai_2 _0928_ (.A1(_0349_),
    .A2(_0444_),
    .B1(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__a31o_2 _0929_ (.A1(_0337_),
    .A2(_0360_),
    .A3(_0445_),
    .B1(_0356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__nand2_2 _0930_ (.A(_0418_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__o22a_2 _0931_ (.A1(\tone_counter[14] ),
    .A2(_0440_),
    .B1(_0447_),
    .B2(\tone_counter[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__and3b_2 _0932_ (.A_N(_0442_),
    .B(_0443_),
    .C(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__or4_2 _0933_ (.A(\driver.decoder.data_reg[4] ),
    .B(_0095_),
    .C(_0341_),
    .D(_0411_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__a31o_2 _0934_ (.A1(_0344_),
    .A2(_0346_),
    .A3(_0450_),
    .B1(_0339_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__a21oi_2 _0935_ (.A1(_0374_),
    .A2(_0451_),
    .B1(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0452_));
 sky130_fd_sc_hd__o31ai_2 _0936_ (.A1(_0356_),
    .A2(_0361_),
    .A3(_0452_),
    .B1(_0418_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0453_));
 sky130_fd_sc_hd__a22o_2 _0937_ (.A1(\tone_counter[13] ),
    .A2(_0447_),
    .B1(_0453_),
    .B2(\tone_counter[12] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__o21ba_2 _0938_ (.A1(\tone_counter[12] ),
    .A2(_0453_),
    .B1_N(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__o211a_2 _0939_ (.A1(\tone_counter[11] ),
    .A2(_0435_),
    .B1(_0449_),
    .C1(_0455_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__a22o_2 _0940_ (.A1(_0442_),
    .A2(_0443_),
    .B1(_0449_),
    .B2(_0454_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__or4_2 _0941_ (.A(\tone_counter[16] ),
    .B(\tone_counter[17] ),
    .C(_0103_),
    .D(_0457_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__a21oi_2 _0942_ (.A1(_0437_),
    .A2(_0456_),
    .B1(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__and2b_2 _0943_ (.A_N(\tone_counter[0] ),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__and3_2 _0944_ (.A(_0388_),
    .B(_0391_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__and3_2 _0945_ (.A(\tone_counter[2] ),
    .B(\tone_counter[1] ),
    .C(\tone_counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__a21o_2 _0946_ (.A1(\tone_counter[1] ),
    .A2(\tone_counter[0] ),
    .B1(\tone_counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__and3b_2 _0947_ (.A_N(_0460_),
    .B(_0461_),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__and2_2 _0948_ (.A(\tone_counter[3] ),
    .B(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__or2_2 _0949_ (.A(\tone_counter[3] ),
    .B(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__and3b_2 _0950_ (.A_N(_0462_),
    .B(_0463_),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__nand2_2 _0951_ (.A(\tone_counter[4] ),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__or2_2 _0952_ (.A(\tone_counter[4] ),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__and3_2 _0953_ (.A(net6),
    .B(_0464_),
    .C(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__and3_2 _0954_ (.A(\tone_counter[5] ),
    .B(\tone_counter[4] ),
    .C(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__a31o_2 _0955_ (.A1(\tone_counter[4] ),
    .A2(\tone_counter[3] ),
    .A3(_0460_),
    .B1(\tone_counter[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__and3b_2 _0956_ (.A_N(_0466_),
    .B(_0467_),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__and2_2 _0957_ (.A(\tone_counter[6] ),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__or2_2 _0958_ (.A(\tone_counter[6] ),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__and3b_2 _0959_ (.A_N(_0468_),
    .B(_0469_),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__nand2_2 _0960_ (.A(\tone_counter[7] ),
    .B(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0470_));
 sky130_fd_sc_hd__or2_2 _0961_ (.A(\tone_counter[7] ),
    .B(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__and3_2 _0962_ (.A(net6),
    .B(_0470_),
    .C(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__and3_2 _0963_ (.A(\tone_counter[8] ),
    .B(\tone_counter[7] ),
    .C(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__a31o_2 _0964_ (.A1(\tone_counter[7] ),
    .A2(\tone_counter[6] ),
    .A3(_0466_),
    .B1(\tone_counter[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__and3b_2 _0965_ (.A_N(_0472_),
    .B(_0473_),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__and2_2 _0966_ (.A(\tone_counter[9] ),
    .B(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__or2_2 _0967_ (.A(\tone_counter[9] ),
    .B(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__and3b_2 _0968_ (.A_N(_0474_),
    .B(_0475_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__nand2_2 _0969_ (.A(\tone_counter[10] ),
    .B(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0476_));
 sky130_fd_sc_hd__or2_2 _0970_ (.A(\tone_counter[10] ),
    .B(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__and3_2 _0971_ (.A(net5),
    .B(_0476_),
    .C(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__and3_2 _0972_ (.A(\tone_counter[11] ),
    .B(\tone_counter[10] ),
    .C(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__a31o_2 _0973_ (.A1(\tone_counter[10] ),
    .A2(\tone_counter[9] ),
    .A3(_0472_),
    .B1(\tone_counter[11] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__and3b_2 _0974_ (.A_N(_0478_),
    .B(_0479_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__and2_2 _0975_ (.A(\tone_counter[12] ),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__or2_2 _0976_ (.A(\tone_counter[12] ),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__and3b_2 _0977_ (.A_N(_0480_),
    .B(_0481_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__and3_2 _0978_ (.A(\tone_counter[13] ),
    .B(\tone_counter[12] ),
    .C(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__or2_2 _0979_ (.A(\tone_counter[13] ),
    .B(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0483_));
 sky130_fd_sc_hd__and3b_2 _0980_ (.A_N(_0482_),
    .B(_0483_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__nand2_2 _0981_ (.A(\tone_counter[14] ),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__or2_2 _0982_ (.A(\tone_counter[14] ),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__and3_2 _0983_ (.A(net5),
    .B(_0484_),
    .C(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__nand3_2 _0984_ (.A(\tone_counter[15] ),
    .B(\tone_counter[14] ),
    .C(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__a21o_2 _0985_ (.A1(\tone_counter[14] ),
    .A2(_0482_),
    .B1(\tone_counter[15] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__and3_2 _0986_ (.A(net5),
    .B(_0486_),
    .C(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__nand4_2 _0987_ (.A(net37),
    .B(_0083_),
    .C(_0174_),
    .D(_0271_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0019_));
 sky130_fd_sc_hd__and4_2 _0988_ (.A(\pix_x[7] ),
    .B(_0079_),
    .C(net24),
    .D(_0241_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__o31ai_2 _0989_ (.A1(net31),
    .A2(net29),
    .A3(net27),
    .B1(_0488_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__and2b_2 _0990_ (.A_N(\driver.driver.pmod_latch_prev ),
    ...
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__nand2b_2 _0991_ (.A_N(\driver.driver.pmod_latch_prev ),
    .B(net106),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__a21bo_2 _0992_ (.A1(net101),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__a21o_2 _0993_ (.A1(net112),
    .A2(net21),
    .B1(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__a21bo_2 _0994_ (.A1(net96),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__a21o_2 _0995_ (.A1(net108),
    .A2(net21),
    .B1(_0492_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__a21bo_2 _0996_ (.A1(net94),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__a21o_2 _0997_ (.A1(net49),
    .A2(net21),
    .B1(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__a21bo_2 _0998_ (.A1(net86),
    .A2(net22),
    .B1_N(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__a21o_2 _0999_ (.A1(net111),
    .A2(net21),
    .B1(_0494_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__a21bo_2 _1000_ (.A1(net84),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__a21o_2 _1001_ (.A1(\driver.decoder.data_reg[4] ),
    .A2(net21),
    .B1(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__a21bo_2 _1002_ (.A1(net90),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__a21o_2 _1003_ (.A1(net110),
    .A2(net21),
    .B1(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__a21bo_2 _1004_ (.A1(net98),
    .A2(net22),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__a21o_2 _1005_ (.A1(net103),
    .A2(net21),
    .B1(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__a21bo_2 _1006_ (.A1(net88),
    .A2(net22),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__a21o_2 _1007_ (.A1(net47),
    .A2(net21),
    .B1(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__a21bo_2 _1008_ (.A1(net82),
    .A2(net22),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__a21o_2 _1009_ (.A1(net99),
    .A2(net21),
    .B1(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__a21bo_2 _1010_ (.A1(net91),
    .A2(net22),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__a21o_2 _1011_ (.A1(net100),
    .A2(net21),
    .B1(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__a21bo_2 _1012_ (.A1(net92),
    .A2(_0489_),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__a21o_2 _1013_ (.A1(\driver.decoder.data_reg[10] ),
    .A2(_0490_),
    .B1(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__a21bo_2 _1014_ (.A1(net77),
    .A2(_0489_),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__a21o_2 _1015_ (.A1(net104),
    .A2(_0490_),
    .B1(_0502_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__and2_2 _1016_ (.A(net107),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__and2_2 _1017_ (.A(net106),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__and2b_2 _1018_ (.A_N(\driver.driver.pmod_clk_prev ),
    ...
    .VPWR(VPWR),
    .X(_0503_));
 sky130_fd_sc_hd__nand2b_2 _1019_ (.A_N(\driver.driver.pmod_clk_prev ),
    .B(\driver.driver.pmod_clk_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0504_));
 sky130_fd_sc_hd__a21bo_2 _1020_ (.A1(\driver.driver.pmod_data_sync[1] ),
    .A2(net20),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__a21o_2 _1021_ (.A1(net101),
    .A2(net19),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__a21bo_2 _1022_ (.A1(\driver.driver.shift_reg[0] ),
    .A2(net20),
    .B1_N(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__a21o_2 _1023_ (.A1(net96),
    .A2(net19),
    .B1(_0506_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__a21bo_2 _1024_ (.A1(\driver.driver.shift_reg[1] ),
    .A2(net20),
    .B1_N(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__a21o_2 _1025_ (.A1(net94),
    .A2(net19),
    .B1(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__a21bo_2 _1026_ (.A1(\driver.driver.shift_reg[2] ),
    .A2(net20),
    .B1_N(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__a21o_2 _1027_ (.A1(net86),
    .A2(net19),
    .B1(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__a21bo_2 _1028_ (.A1(\driver.driver.shift_reg[3] ),
    .A2(net20),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__a21o_2 _1029_ (.A1(net84),
    .A2(net19),
    .B1(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__a21bo_2 _1030_ (.A1(net84),
    .A2(net20),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__a21o_2 _1031_ (.A1(net90),
    .A2(net19),
    .B1(_0510_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__a21bo_2 _1032_ (.A1(net90),
    .A2(net20),
    .B1_N(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__a21o_2 _1033_ (.A1(net98),
    .A2(net19),
    .B1(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__a21bo_2 _1034_ (.A1(\driver.driver.shift_reg[6] ),
    .A2(net20),
    .B1_N(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0512_));
 sky130_fd_sc_hd__a21o_2 _1035_ (.A1(net88),
    .A2(net19),
    .B1(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__a21bo_2 _1036_ (.A1(\driver.driver.shift_reg[7] ),
    .A2(net20),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__a21o_2 _1037_ (.A1(net82),
    .A2(net19),
    .B1(_0513_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__a21bo_2 _1038_ (.A1(net82),
    .A2(net20),
    .B1_N(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__a21o_2 _1039_ (.A1(net91),
    .A2(net19),
    .B1(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__a21bo_2 _1040_ (.A1(net91),
    .A2(_0503_),
    .B1_N(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__a21o_2 _1041_ (.A1(net92),
    .A2(_0504_),
    .B1(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__a21bo_2 _1042_ (.A1(\driver.driver.shift_reg[10] ),
    .A2(_0503_),
    .B1_N(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__a21o_2 _1043_ (.A1(net77),
    .A2(_0504_),
    .B1(_0516_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__and2_2 _1044_ (.A(net51),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__and2_2 _1045_ (.A(net51),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__and2_2 _1046_ (.A(net54),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__and2_2 _1047_ (.A(net54),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__and2_2 _1048_ (.A(net54),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__and2_2 _1049_ (.A(net54),
    .B(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__and2_2 _1050_ (.A(_0109_),
    .B(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__and4bb_2 _1051_ (.A_N(_0296_),
    .B_N(\pix_x[7] ),
    .C(\pix_x[8] ),
    .D(_0517_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__o21a_2 _1052_ (.A1(_0120_),
    .A2(_0123_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__or4_2 _1053_ (.A(_0080_),
    .B(_0081_),
    .C(_0117_),
    .D(_0128_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__o311a_2 _1054_ (.A1(_0249_),
    .A2(_0519_),
    .A3(_0520_),
    .B1(_0518_),
    .C1(net51),
    ...
    .VPWR(VPWR),
    .X(_0521_));
 sky130_fd_sc_hd__and2b_2 _1055_ (.A_N(_0518_),
    .B(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1056_ (.A0(_0521_),
    ...
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__a22o_2 _1057_ (.A1(_0130_),
    .A2(_0521_),
    .B1(net9),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__a22o_2 _1058_ (.A1(_0137_),
    .A2(_0521_),
    .B1(net9),
    .B2(net44),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__and2_2 _1059_ (.A(net43),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__a31o_2 _1060_ (.A1(_0154_),
    .A2(_0156_),
    .A3(_0521_),
    .B1(_0523_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__nand2_2 _1061_ (.A(_0082_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0524_));
 sky130_fd_sc_hd__nor2_2 _1062_ (.A(_0082_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__and3b_2 _1063_ (.A_N(_0525_),
    .B(_0521_),
    .C(_0524_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0526_));
 sky130_fd_sc_hd__a21o_2 _1064_ (.A1(net42),
    .A2(net10),
    .B1(_0526_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__or2_2 _1065_ (.A(net40),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__nand2_2 _1066_ (.A(_0155_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0528_));
 sky130_fd_sc_hd__and3_2 _1067_ (.A(_0521_),
    .B(_0527_),
    .C(_0528_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__a21o_2 _1068_ (.A1(net40),
    .A2(net10),
    .B1(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__a21oi_2 _1069_ (.A1(_0155_),
    .A2(_0224_),
    .B1(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0530_));
 sky130_fd_sc_hd__and3_2 _1070_ (.A(net39),
    .B(_0155_),
    .C(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0531_));
 sky130_fd_sc_hd__nor2_2 _1071_ (.A(_0530_),
    .B(_0531_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__a22o_2 _1072_ (.A1(net39),
    .A2(net10),
    .B1(_0532_),
    .B2(_0521_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__nor2_2 _1073_ (.A(_0120_),
    .B(_0528_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0533_));
 sky130_fd_sc_hd__o22a_2 _1074_ (.A1(_0120_),
    .A2(_0528_),
    .B1(_0531_),
    .B2(net38),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_2 _1075_ (.A1(net38),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__nand2_2 _1076_ (.A(net36),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0535_));
 sky130_fd_sc_hd__a21o_2 _1077_ (.A1(_0521_),
    .A2(_0535_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0536_));
 sky130_fd_sc_hd__and2_2 _1078_ (.A(_0521_),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0537_));
 sky130_fd_sc_hd__o21a_2 _1079_ (.A1(net37),
    .A2(_0537_),
    .B1(_0536_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__and3_2 _1080_ (.A(net37),
    .B(_0083_),
    .C(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0538_));
 sky130_fd_sc_hd__a21o_2 _1081_ (.A1(net80),
    .A2(_0536_),
    .B1(_0538_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__and2b_2 _1082_ (.A_N(\pix_x[0] ),
    .B(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__and3b_2 _1083_ (.A_N(_0114_),
    .B(net50),
    .C(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__o21ai_2 _1084_ (.A1(net33),
    .A2(_0114_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0539_));
 sky130_fd_sc_hd__a21oi_2 _1085_ (.A1(net33),
    .A2(_0114_),
    .B1(_0539_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__a31o_2 _1086_ (.A1(\pix_x[0] ),
    .A2(\pix_x[1] ),
    .A3(\pix_x[2] ),
    .B1(\pix_x[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0540_));
 sky130_fd_sc_hd__and3b_2 _1087_ (.A_N(_0278_),
    .B(_0540_),
    .C(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__and3b_2 _1088_ (.A_N(_0517_),
    .B(net50),
    .C(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__and3_2 _1089_ (.A(net28),
    .B(_0109_),
    .C(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0541_));
 sky130_fd_sc_hd__nand2_2 _1090_ (.A(net28),
    .B(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0542_));
 sky130_fd_sc_hd__or2_2 _1091_ (.A(net28),
    .B(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0543_));
 sky130_fd_sc_hd__and3_2 _1092_ (.A(net9),
    .B(_0542_),
    .C(_0543_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__o21ai_2 _1093_ (.A1(net26),
    .A2(_0541_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0544_));
 sky130_fd_sc_hd__a21oi_2 _1094_ (.A1(net26),
    .A2(_0541_),
    .B1(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__a21o_2 _1095_ (.A1(net26),
    .A2(_0541_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0545_));
 sky130_fd_sc_hd__and2_2 _1096_ (.A(_0107_),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0546_));
 sky130_fd_sc_hd__and3b_2 _1097_ (.A_N(_0546_),
    .B(net9),
    .C(_0545_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__nor2_2 _1098_ (.A(_0210_),
    .B(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0547_));
 sky130_fd_sc_hd__o221a_2 _1099_ (.A1(_0210_),
    .A2(_0542_),
    .B1(_0546_),
    .B2(\pix_x[8] ),
    .C1(net9),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__a21boi_2 _1100_ (.A1(net23),
    .A2(_0547_),
    .B1_N(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0548_));
 sky130_fd_sc_hd__o21a_2 _1101_ (.A1(net23),
    .A2(_0547_),
    .B1(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__nor2_2 _1102_ (.A(tone_ff),
    .B(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__mux2_1 _1103_ (.A0(_0549_),
    .A1(net109),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__dfxtp_2 _1104_ (.CLK(clknet_4_9_0_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1105_ (.CLK(clknet_4_8_0_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1106_ (.CLK(clknet_4_9_0_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1107_ (.CLK(clknet_4_8_0_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1109_ (.CLK(clknet_4_6_0_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1110_ (.CLK(clknet_4_6_0_clk),
    .D(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1112_ (.CLK(clknet_4_9_0_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1114_ (.CLK(clknet_4_14_0_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1115_ (.CLK(clknet_4_14_0_clk),
    .D(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1117_ (.CLK(clknet_4_15_0_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1120_ (.CLK(clknet_4_8_0_clk),
    .D(net95),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1122_ (.CLK(clknet_4_12_0_clk),
    .D(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1126_ (.CLK(clknet_4_12_0_clk),
    .D(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1128_ (.CLK(clknet_4_13_0_clk),
    .D(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1129_ (.CLK(clknet_4_14_0_clk),
    .D(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1131_ (.CLK(clknet_4_12_0_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1132_ (.CLK(clknet_4_14_0_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1133_ (.CLK(clknet_4_15_0_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1135_ (.CLK(clknet_4_13_0_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1136_ (.CLK(clknet_4_5_0_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1137_ (.CLK(clknet_4_5_0_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1138_ (.CLK(clknet_4_5_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1139_ (.CLK(clknet_4_4_0_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1140_ (.CLK(clknet_4_4_0_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1141_ (.CLK(clknet_4_4_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1142_ (.CLK(clknet_4_5_0_clk),
    .D(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1143_ (.CLK(clknet_4_4_0_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1144_ (.CLK(clknet_4_7_0_clk),
    .D(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1145_ (.CLK(clknet_4_6_0_clk),
    .D(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1146_ (.CLK(clknet_4_0_0_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1147_ (.CLK(clknet_4_0_0_clk),
    .D(_0063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1148_ (.CLK(clknet_4_1_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1149_ (.CLK(clknet_4_0_0_clk),
    .D(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1150_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1151_ (.CLK(clknet_4_1_0_clk),
    .D(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1154_ (.CLK(clknet_4_1_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_x[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1155_ (.CLK(clknet_4_0_0_clk),
    .D(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1156_ (.CLK(clknet_4_3_0_clk),
    .D(_0072_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1158_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1159_ (.CLK(clknet_4_10_0_clk),
    .D(_0010_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1160_ (.CLK(clknet_4_11_0_clk),
    .D(_0011_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1161_ (.CLK(clknet_4_10_0_clk),
    .D(_0012_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1162_ (.CLK(clknet_4_10_0_clk),
    .D(_0013_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1163_ (.CLK(clknet_4_11_0_clk),
    .D(_0014_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1164_ (.CLK(clknet_4_11_0_clk),
    .D(_0015_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1165_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1166_ (.CLK(clknet_4_2_0_clk),
    .D(_0017_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1167_ (.CLK(clknet_4_3_0_clk),
    .D(_0001_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[10] ));
 sky130_fd_sc_hd__dfrtp_2 _1168_ (.CLK(clknet_4_3_0_clk),
    .D(_0002_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[11] ));
 sky130_fd_sc_hd__dfrtp_2 _1169_ (.CLK(clknet_4_2_0_clk),
    .D(_0003_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[12] ));
 sky130_fd_sc_hd__dfrtp_2 _1170_ (.CLK(clknet_4_2_0_clk),
    .D(_0004_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[13] ));
 sky130_fd_sc_hd__dfrtp_2 _1171_ (.CLK(clknet_4_2_0_clk),
    .D(_0005_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[14] ));
 sky130_fd_sc_hd__dfrtp_2 _1172_ (.CLK(clknet_4_0_0_clk),
    .D(_0006_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[15] ));
 sky130_fd_sc_hd__dfrtp_2 _1173_ (.CLK(clknet_4_2_0_clk),
    .D(net74),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[16] ));
 sky130_fd_sc_hd__conb_1 _1173__74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net74));
 sky130_fd_sc_hd__dfrtp_2 _1174_ (.CLK(clknet_4_3_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\tone_counter[17] ));
 sky130_fd_sc_hd__conb_1 _1174__73 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net73));
 sky130_fd_sc_hd__dfxtp_2 _1175_ (.CLK(clknet_4_4_0_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _1176_ (.CLK(clknet_4_7_0_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1195_ (.A(audio),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__buf_2 _1196_ (.A(\vga_sync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1197_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload9 (.A(clknet_4_15_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_0503_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(_0489_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(\pix_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(\pix_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout43 (.A(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout45 (.A(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout46 (.A(\driver.decoder.data_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout47 (.A(\driver.decoder.data_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout48 (.A(\driver.decoder.data_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(\driver.decoder.data_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout58 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_0522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\driver.decoder.data_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\driver.driver.shift_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(_0034_),
    ...
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\driver.decoder.data_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\driver.decoder.data_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\driver.driver.pmod_latch_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\driver.driver.pmod_clk_sync[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\driver.decoder.data_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(tone_ff),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\driver.decoder.data_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\driver.decoder.data_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\driver.decoder.data_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\driver.driver.pmod_data_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\driver.driver.shift_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\driver.driver.pmod_latch_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\driver.driver.pmod_clk_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\driver.driver.shift_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\driver.driver.shift_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(_0038_),
    ...
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\driver.driver.shift_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\driver.driver.shift_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\driver.driver.shift_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\driver.driver.shift_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\driver.driver.shift_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\driver.driver.shift_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\driver.driver.shift_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\driver.driver.shift_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\driver.decoder.data_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input4 (.A(ui_in[6]),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap13 (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_59 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net59));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_60 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net60));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_61 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net61));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_62 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net62));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net63));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_64 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net64));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_65 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net65));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_66 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net66));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_67 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net67));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_68 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net68));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_69 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net69));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_70 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net70));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_71 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net71));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net72));
 sky130_fd_sc_hd__conb_1 tt_um_vga_ocarina_75 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net75));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire15 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire16 (.A(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
