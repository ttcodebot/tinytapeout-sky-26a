module tt_um_ojas_sharma_imperial_ttcpu (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire _222_;
 wire _223_;
 wire \main_cpu.address_extension[0] ;
 wire \main_cpu.address_extension[1] ;
 wire \main_cpu.flagctoalu ;
 wire \main_cpu.main_controlpath.flagz ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[0] ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[1] ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[2] ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[3] ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[4] ;
 wire \main_cpu.main_controlpath.jump_conditions.pcxin[5] ;
 wire \main_cpu.main_datapath.addr_ext.extactive ;
 wire \main_cpu.main_datapath.datapath_decode.memstr ;
 wire \main_cpu.main_datapath.main_registers.regA[0] ;
 wire \main_cpu.main_datapath.main_registers.regA[1] ;
 wire \main_cpu.main_datapath.main_registers.regA[2] ;
 wire \main_cpu.main_datapath.main_registers.regA[3] ;
 wire \main_cpu.main_datapath.main_registers.regB[0] ;
 wire \main_cpu.main_datapath.main_registers.regB[1] ;
 wire \main_cpu.main_datapath.main_registers.regB[2] ;
 wire \main_cpu.main_datapath.main_registers.regB[3] ;
 wire net1;
 wire net2;
 wire net3;
 wire net4;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _224_ (.A(\main_cpu.main_controlpath.flagz ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__inv_2 _225_ (.A(\main_cpu.flagctoalu ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__inv_2 _226_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__inv_2 _227_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__inv_2 _228_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__inv_2 _229_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__and2_2 _230_ (.A(\main_cpu.address_extension[0] ),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__mux2_1 _231_ (.A0(\main_cpu.main_datapath.main_registers.regA[2] ),
    .A1(\main_cpu.main_datapath.main_registers.regB[2] ),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__and2_2 _232_ (.A(net25),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__mux2_1 _233_ (.A0(\main_cpu.main_datapath.main_registers.regA[3] ),
    .A1(\main_cpu.main_datapath.main_registers.regB[3] ),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__and2_2 _234_ (.A(net25),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__mux2_1 _235_ (.A0(\main_cpu.main_datapath.main_registers.regA[0] ),
    .A1(\main_cpu.main_datapath.main_registers.regB[0] ),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__mux2_1 _236_ (.A0(net24),
    .A1(_208_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uio_out[4]));
 sky130_fd_sc_hd__mux2_1 _237_ (.A0(\main_cpu.main_datapath.main_registers.regA[1] ),
    .A1(\main_cpu.main_datapath.main_registers.regB[1] ),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__mux2_1 _238_ (.A0(net22),
    .A1(_209_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uio_out[5]));
 sky130_fd_sc_hd__nand2_2 _239_ (.A(net18),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__and2_2 _240_ (.A(_203_),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__and3_2 _241_ (.A(net19),
    .B(net17),
    .C(_211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\main_cpu.main_datapath.datapath_decode.memstr ));
 sky130_fd_sc_hd__and2_2 _242_ (.A(net25),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__nand2_2 _243_ (.A(net25),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__and3_2 _244_ (.A(net25),
    .B(net2),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__nand2_2 _245_ (.A(net2),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__o21a_2 _246_ (.A1(net19),
    .A2(_214_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__or2_2 _247_ (.A(net3),
    .B(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _248_ (.A(net25),
    ...
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__nand2_2 _249_ (.A(_203_),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__and3b_2 _250_ (.A_N(_216_),
    .B(_217_),
    .C(_219_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__nor2_2 _251_ (.A(_201_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__nand2_2 _252_ (.A(net17),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__mux2_1 _253_ (.A0(\main_cpu.main_datapath.main_registers.regB[3] ),
    .A1(\main_cpu.main_datapath.main_registers.regA[3] ),
    .S(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__or2_2 _254_ (.A(net2),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__or3b_2 _255_ (.A(net25),
    .B(net2),
    .C_N(net19),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _256_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__o22a_2 _257_ (.A1(net19),
    .A2(net17),
    .B1(_207_),
    .B2(_027_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__xnor2_2 _258_ (.A(_025_),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__and2_2 _259_ (.A(_223_),
    .B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__nor2_2 _260_ (.A(_223_),
    .B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__nor2_2 _261_ (.A(_030_),
    .B(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__mux2_1 _262_ (.A0(\main_cpu.main_datapath.main_registers.regB[2] ),
    .A1(\main_cpu.main_datapath.main_registers.regA[2] ),
    .S(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__mux2_1 _263_ (.A0(_206_),
    .A1(net7),
    .S(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__xnor2_2 _264_ (.A(_025_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__and2_2 _265_ (.A(_033_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__mux2_1 _266_ (.A0(\main_cpu.main_datapath.main_registers.regB[1] ),
    .A1(\main_cpu.main_datapath.main_registers.regA[1] ),
    .S(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__mux2_1 _267_ (.A0(_209_),
    .A1(net23),
    .S(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__xnor2_2 _268_ (.A(_025_),
    .B(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__and2_2 _269_ (.A(_037_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__mux2_1 _270_ (.A0(\main_cpu.main_datapath.main_registers.regB[0] ),
    .A1(\main_cpu.main_datapath.main_registers.regA[0] ),
    .S(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand3_2 _271_ (.A(net17),
    .B(_208_),
    .C(_026_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__a21o_2 _272_ (.A1(net17),
    .A2(_026_),
    .B1(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__nand2_2 _273_ (.A(_042_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__a21o_2 _274_ (.A1(_042_),
    .A2(_043_),
    .B1(_025_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__nand3_2 _275_ (.A(_025_),
    .B(_042_),
    .C(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__and3_2 _276_ (.A(_041_),
    .B(_045_),
    .C(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__a21o_2 _277_ (.A1(_045_),
    .A2(_046_),
    .B1(_041_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__and2b_2 _278_ (.A_N(_047_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__o221a_2 _279_ (.A1(net4),
    .A2(net3),
    .B1(_211_),
    .B2(\main_cpu.flagctoalu ),
    .C1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__nand2_2 _280_ (.A(_049_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__a21o_2 _281_ (.A1(_048_),
    .A2(_050_),
    .B1(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__xor2_2 _282_ (.A(_037_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__and2_2 _283_ (.A(_052_),
    .B(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nor2_2 _284_ (.A(_033_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__nor2_2 _285_ (.A(_036_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__o21a_2 _286_ (.A1(_040_),
    .A2(_054_),
    .B1(_056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__o21a_2 _287_ (.A1(_036_),
    .A2(_057_),
    .B1(_032_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__and2_2 _288_ (.A(_205_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__nor2_2 _289_ (.A(net24),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _290_ (.A(net24),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a31o_2 _291_ (.A1(\main_cpu.main_datapath.main_registers.regA[0] ),
    .A2(net20),
    .A3(_060_),
    .B1(_059_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__nand2_2 _292_ (.A(net22),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__a31o_2 _293_ (.A1(net20),
    .A2(_206_),
    .A3(_061_),
    .B1(_062_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__and3_2 _294_ (.A(\main_cpu.flagctoalu ),
    .B(net5),
    .C(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__mux2_1 _295_ (.A0(_207_),
    .A1(_065_),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a31o_2 _296_ (.A1(\main_cpu.main_datapath.main_registers.regA[2] ),
    .A2(net20),
    .A3(_060_),
    .B1(_066_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__mux2_1 _297_ (.A0(\main_cpu.main_datapath.main_registers.regA[3] ),
    .A1(_208_),
    .S(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__a31o_2 _298_ (.A1(_202_),
    .A2(net20),
    .A3(_068_),
    .B1(_215_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__a31o_2 _299_ (.A1(net18),
    .A2(_060_),
    .A3(_067_),
    .B1(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__a31o_2 _300_ (.A1(net18),
    .A2(_061_),
    .A3(_064_),
    .B1(_070_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__o311a_2 _301_ (.A1(_214_),
    .A2(_030_),
    .A3(_058_),
    .B1(_071_),
    .C1(_220_),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o21a_2 _302_ (.A1(_221_),
    .A2(_072_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nor3_2 _303_ (.A(net2),
    .B(net3),
    .C(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__or3_2 _304_ (.A(net2),
    .B(net3),
    .C(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nor3_2 _305_ (.A(_032_),
    .B(_036_),
    .C(_057_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__and2_2 _306_ (.A(_213_),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__nand2_2 _307_ (.A(_213_),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__a21oi_2 _308_ (.A1(_060_),
    .A2(_062_),
    .B1(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__nor2_2 _309_ (.A(net18),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__a211o_2 _310_ (.A1(net18),
    .A2(_078_),
    .B1(_079_),
    .C1(_215_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__o211a_2 _311_ (.A1(_217_),
    .A2(_030_),
    .B1(_080_),
    .C1(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__o31a_2 _312_ (.A1(_058_),
    .A2(_075_),
    .A3(_077_),
    .B1(_081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__o21ai_2 _313_ (.A1(_219_),
    .A2(_028_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__a2bb2o_2 _314_ (.A1_N(_082_),
    .A2_N(_083_),
    .B1(net13),
    .B2(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__o31ai_2 _315_ (.A1(_040_),
    .A2(_054_),
    .A3(_056_),
    .B1(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__and3_2 _316_ (.A(net20),
    .B(_207_),
    .C(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__a21o_2 _317_ (.A1(_205_),
    .A2(_206_),
    .B1(_086_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a31o_2 _318_ (.A1(\main_cpu.main_datapath.main_registers.regA[1] ),
    .A2(net7),
    .A3(_060_),
    .B1(_087_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a31o_2 _319_ (.A1(_205_),
    .A2(_208_),
    .A3(_060_),
    .B1(_065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__mux2_1 _320_ (.A0(_088_),
    .A1(_089_),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__o2bb2a_2 _321_ (.A1_N(_214_),
    .A2_N(_090_),
    .B1(_036_),
    .B2(_217_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__o211a_2 _322_ (.A1(_057_),
    .A2(_085_),
    .B1(_091_),
    .C1(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o21ai_2 _323_ (.A1(_219_),
    .A2(_034_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__a2bb2o_2 _324_ (.A1_N(_092_),
    .A2_N(_093_),
    .B1(net12),
    .B2(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__o21ai_2 _325_ (.A1(_052_),
    .A2(_053_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__and2b_2 _326_ (.A_N(net18),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__a31o_2 _327_ (.A1(net18),
    .A2(_061_),
    .A3(_066_),
    .B1(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__o2bb2a_2 _328_ (.A1_N(_214_),
    .A2_N(_097_),
    .B1(_217_),
    .B2(_040_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__o211a_2 _329_ (.A1(_054_),
    .A2(_095_),
    .B1(_098_),
    .C1(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__o21ai_2 _330_ (.A1(_219_),
    .A2(_038_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__o2bb2a_2 _331_ (.A1_N(net11),
    .A2_N(_073_),
    .B1(_099_),
    .B2(_100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__or2_2 _332_ (.A(_049_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__nor2_2 _333_ (.A(_217_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__and3_2 _334_ (.A(net20),
    .B(_209_),
    .C(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__a211o_2 _335_ (.A1(_205_),
    .A2(_208_),
    .B1(_104_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a21bo_2 _336_ (.A1(_061_),
    .A2(_087_),
    .B1_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__and3_2 _337_ (.A(_214_),
    .B(_105_),
    .C(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__a311o_2 _338_ (.A1(_203_),
    .A2(_218_),
    .A3(_044_),
    .B1(_103_),
    .C1(_107_),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__a31o_2 _339_ (.A1(_051_),
    .A2(_076_),
    .A3(_102_),
    .B1(_108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__mux2_1 _340_ (.A0(net10),
    .A1(_109_),
    .S(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__a21oi_2 _341_ (.A1(_216_),
    .A2(_074_),
    .B1(_110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__and4bb_2 _342_ (.A_N(_084_),
    .B_N(_094_),
    .C(_101_),
    .D(_111_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__and3_2 _343_ (.A(\main_cpu.main_controlpath.flagz ),
    .B(_216_),
    .C(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__o21a_2 _344_ (.A1(_112_),
    .A2(_113_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__a22o_2 _345_ (.A1(_201_),
    .A2(net4),
    .B1(net3),
    .B2(_200_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__or2_2 _346_ (.A(net5),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__a21oi_2 _347_ (.A1(net24),
    .A2(_114_),
    .B1(_212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__a211o_2 _348_ (.A1(_115_),
    .A2(_116_),
    .B1(_203_),
    .C1(_210_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__or2_2 _349_ (.A(net24),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__o21a_2 _350_ (.A1(\main_cpu.main_controlpath.jump_conditions.pcxin[0] ),
    .A2(_204_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__or2_2 _351_ (.A(uo_out[2]),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__a21oi_2 _352_ (.A1(uo_out[2]),
    .A2(net22),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__a221o_2 _353_ (.A1(net16),
    .A2(_119_),
    .B1(_120_),
    .B2(_121_),
    .C1(net14),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__nand2_2 _354_ (.A(uo_out[2]),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__and3_2 _355_ (.A(net26),
    .B(_122_),
    .C(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__nand2_2 _356_ (.A(uo_out[3]),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__inv_2 _357_ (.A(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__or2_2 _358_ (.A(uo_out[3]),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a22o_2 _359_ (.A1(uo_out[2]),
    .A2(net22),
    .B1(_124_),
    .B2(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__and4_2 _360_ (.A(uo_out[2]),
    .B(net22),
    .C(_124_),
    .D(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nor2_2 _361_ (.A(net16),
    .B(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__mux2_1 _362_ (.A0(\main_cpu.main_controlpath.jump_conditions.pcxin[1] ),
    .A1(_037_),
    .S(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__a22o_2 _363_ (.A1(_127_),
    .A2(_129_),
    .B1(_130_),
    .B2(net16),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__xnor2_2 _364_ (.A(uo_out[2]),
    .B(uo_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__nand2_2 _365_ (.A(net14),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__o211a_2 _366_ (.A1(_117_),
    .A2(_131_),
    .B1(_133_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or2_2 _367_ (.A(uo_out[4]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__nand2_2 _368_ (.A(uo_out[4]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__a211o_2 _369_ (.A1(_134_),
    .A2(_135_),
    .B1(_125_),
    .C1(_128_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__o211a_2 _370_ (.A1(_125_),
    .A2(_128_),
    .B1(_134_),
    .C1(_135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__nor2_2 _371_ (.A(net16),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__mux2_1 _372_ (.A0(\main_cpu.main_controlpath.jump_conditions.pcxin[2] ),
    .A1(_033_),
    .S(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__a221o_2 _373_ (.A1(_136_),
    .A2(_138_),
    .B1(_139_),
    .B2(net16),
    .C1(net14),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__and3_2 _374_ (.A(uo_out[2]),
    .B(uo_out[3]),
    .C(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a21oi_2 _375_ (.A1(uo_out[2]),
    .A2(uo_out[3]),
    .B1(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__or2_2 _376_ (.A(_141_),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__nand2_2 _377_ (.A(net14),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__and3_2 _378_ (.A(net26),
    .B(_140_),
    .C(_144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__a21o_2 _379_ (.A1(uo_out[4]),
    .A2(net21),
    .B1(_137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__xnor2_2 _380_ (.A(uo_out[5]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__xnor2_2 _381_ (.A(_145_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__mux2_1 _382_ (.A0(\main_cpu.main_controlpath.jump_conditions.pcxin[3] ),
    .A1(_223_),
    .S(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__mux2_1 _383_ (.A0(_147_),
    .A1(_148_),
    .S(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__and2_2 _384_ (.A(uo_out[5]),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nor2_2 _385_ (.A(uo_out[5]),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__or2_2 _386_ (.A(_150_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__nand2_2 _387_ (.A(net14),
    .B(_152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__o211a_2 _388_ (.A1(net14),
    .A2(_149_),
    .B1(_153_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__or2_2 _389_ (.A(uo_out[6]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__nand2_2 _390_ (.A(uo_out[6]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__nand2_2 _391_ (.A(_154_),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__a21o_2 _392_ (.A1(uo_out[5]),
    .A2(net21),
    .B1(_145_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__o21ai_2 _393_ (.A1(uo_out[5]),
    .A2(net21),
    .B1(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__xnor2_2 _394_ (.A(_156_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__nor2_2 _395_ (.A(net16),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__mux2_1 _396_ (.A0(\main_cpu.address_extension[0] ),
    .A1(\main_cpu.main_controlpath.jump_conditions.pcxin[4] ),
    .S(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a211o_2 _397_ (.A1(net16),
    .A2(_161_),
    .B1(_160_),
    .C1(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__nand2_2 _398_ (.A(uo_out[6]),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__or2_2 _399_ (.A(uo_out[6]),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__nand2_2 _400_ (.A(_163_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__nand2_2 _401_ (.A(net14),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__and3_2 _402_ (.A(net26),
    .B(_162_),
    .C(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__xor2_2 _403_ (.A(uo_out[7]),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__inv_2 _404_ (.A(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__o21ai_2 _405_ (.A1(_156_),
    .A2(_158_),
    .B1(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__xnor2_2 _406_ (.A(uo_out[7]),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__xnor2_2 _407_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__mux2_1 _408_ (.A0(\main_cpu.address_extension[1] ),
    .A1(\main_cpu.main_controlpath.jump_conditions.pcxin[5] ),
    .S(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__mux2_1 _409_ (.A0(_171_),
    .A1(_172_),
    .S(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__mux2_1 _410_ (.A0(_173_),
    .A1(_168_),
    .S(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__and2_2 _411_ (.A(net26),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and3b_2 _412_ (.A_N(_210_),
    .B(_214_),
    .C(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nand2_2 _413_ (.A(uo_out[2]),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__o211a_2 _414_ (.A1(net45),
    .A2(net15),
    .B1(_176_),
    .C1(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__nand2_2 _415_ (.A(_132_),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__o211a_2 _416_ (.A1(net42),
    .A2(_175_),
    .B1(_177_),
    .C1(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__nand2_2 _417_ (.A(_143_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__o211a_2 _418_ (.A1(net41),
    .A2(net15),
    .B1(_178_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2_2 _419_ (.A(_152_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _420_ (.A1(net40),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nand2_2 _421_ (.A(_165_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__o211a_2 _422_ (.A1(net44),
    .A2(net15),
    .B1(_180_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_2 _423_ (.A(_167_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__o211a_2 _424_ (.A1(net43),
    .A2(net15),
    .B1(_181_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__and3b_2 _425_ (.A_N(net18),
    .B(net17),
    .C(_214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__nand2_2 _426_ (.A(_061_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__mux2_1 _427_ (.A0(net20),
    .A1(_037_),
    .S(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__mux2_1 _428_ (.A0(_184_),
    .A1(\main_cpu.address_extension[1] ),
    .S(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__and3b_2 _429_ (.A_N(net48),
    .B(net27),
    .C(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__a22o_2 _430_ (.A1(net20),
    .A2(_060_),
    .B1(_118_),
    .B2(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__and3b_2 _431_ (.A_N(net48),
    .B(net27),
    .C(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__mux2_1 _432_ (.A0(\main_cpu.address_extension[0] ),
    .A1(_186_),
    .S(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__and3b_2 _433_ (.A_N(net48),
    .B(net27),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__o21a_2 _434_ (.A1(net17),
    .A2(_203_),
    .B1(_212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__a31o_2 _435_ (.A1(net19),
    .A2(net9),
    .A3(_074_),
    .B1(_188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__and2b_2 _436_ (.A_N(_189_),
    .B(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__mux2_1 _437_ (.A0(\main_cpu.main_datapath.main_registers.regA[0] ),
    .A1(_110_),
    .S(_190_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__and2_2 _438_ (.A(net28),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nand2_2 _439_ (.A(_101_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__o211a_2 _440_ (.A1(net47),
    .A2(_190_),
    .B1(_192_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _441_ (.A0(\main_cpu.main_datapath.main_registers.regA[2] ),
    .A1(_094_),
    .S(_190_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__and2_2 _442_ (.A(net28),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _443_ (.A0(\main_cpu.main_datapath.main_registers.regA[3] ),
    .A1(_084_),
    .S(_190_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__and2_2 _444_ (.A(net28),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__nor2_2 _445_ (.A(_222_),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_195_));
 sky130_fd_sc_hd__or2_2 _446_ (.A(net49),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__o311a_2 _447_ (.A1(_222_),
    .A2(_110_),
    .A3(_189_),
    .B1(_196_),
    .C1(net28),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__nand2_2 _448_ (.A(_101_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__o211a_2 _449_ (.A1(net46),
    .A2(_195_),
    .B1(_197_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__or2_2 _450_ (.A(net50),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__o311a_2 _451_ (.A1(_222_),
    .A2(_094_),
    .A3(_189_),
    .B1(_198_),
    .C1(net1),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__or2_2 _452_ (.A(net51),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__o311a_2 _453_ (.A1(_222_),
    .A2(_084_),
    .A3(_189_),
    .B1(_199_),
    .C1(net1),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__dfxtp_2 _454_ (.CLK(clknet_2_3__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.flagctoalu ));
 sky130_fd_sc_hd__dfxtp_2 _455_ (.CLK(clknet_2_3__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.flagz ));
 sky130_fd_sc_hd__dfxtp_2 _456_ (.CLK(clknet_2_1__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _457_ (.CLK(clknet_2_1__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _458_ (.CLK(clknet_2_1__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _459_ (.CLK(clknet_2_1__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _460_ (.CLK(clknet_2_0__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfxtp_2 _461_ (.CLK(clknet_2_0__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _462_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[0] ));
 sky130_fd_sc_hd__dfxtp_2 _463_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[1] ));
 sky130_fd_sc_hd__dfxtp_2 _464_ (.CLK(clknet_2_0__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[2] ));
 sky130_fd_sc_hd__dfxtp_2 _465_ (.CLK(clknet_2_0__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[3] ));
 sky130_fd_sc_hd__dfxtp_2 _466_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[4] ));
 sky130_fd_sc_hd__dfxtp_2 _467_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_controlpath.jump_conditions.pcxin[5] ));
 sky130_fd_sc_hd__dfxtp_2 _468_ (.CLK(clknet_2_0__leaf_clk),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.address_extension[1] ));
 sky130_fd_sc_hd__dfxtp_2 _469_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.address_extension[0] ));
 sky130_fd_sc_hd__dfxtp_2 _470_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.addr_ext.extactive ));
 sky130_fd_sc_hd__dfxtp_2 _471_ (.CLK(clknet_2_2__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regA[0] ));
 sky130_fd_sc_hd__dfxtp_2 _472_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regA[1] ));
 sky130_fd_sc_hd__dfxtp_2 _473_ (.CLK(clknet_2_2__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regA[2] ));
 sky130_fd_sc_hd__dfxtp_2 _474_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regA[3] ));
 sky130_fd_sc_hd__dfxtp_2 _475_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regB[0] ));
 sky130_fd_sc_hd__dfxtp_2 _476_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regB[1] ));
 sky130_fd_sc_hd__dfxtp_2 _477_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regB[2] ));
 sky130_fd_sc_hd__dfxtp_2 _478_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\main_cpu.main_datapath.main_registers.regB[3] ));
 sky130_fd_sc_hd__buf_2 _491_ (.A(\main_cpu.main_datapath.datapath_decode.memstr ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload2 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net19),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net6),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\main_cpu.main_controlpath.jump_conditions.pcxin[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\main_cpu.main_datapath.main_registers.regB[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\main_cpu.main_datapath.main_registers.regA[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\main_cpu.main_datapath.addr_ext.extactive ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\main_cpu.main_datapath.main_registers.regB[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\main_cpu.main_datapath.main_registers.regB[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\main_cpu.main_datapath.main_registers.regB[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_2 max_cap24 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net36));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net37));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net38));
 sky130_fd_sc_hd__conb_1 tt_um_ojas_sharma_imperial_ttcpu_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net39));
