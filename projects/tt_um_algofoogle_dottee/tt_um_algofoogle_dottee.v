module tt_um_algofoogle_dottee (clk,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(\bgen.dy[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0703_ (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0691_));
 sky130_fd_sc_hd__inv_2 _0704_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0692_));
 sky130_fd_sc_hd__inv_2 _0705_ (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0693_));
 sky130_fd_sc_hd__inv_2 _0706_ (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0694_));
 sky130_fd_sc_hd__inv_2 _0707_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0695_));
 sky130_fd_sc_hd__inv_2 _0708_ (.A(\bgen.v[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0696_));
 sky130_fd_sc_hd__inv_2 _0709_ (.A(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0697_));
 sky130_fd_sc_hd__inv_2 _0710_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0698_));
 sky130_fd_sc_hd__inv_2 _0711_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0699_));
 sky130_fd_sc_hd__inv_2 _0712_ (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0700_));
 sky130_fd_sc_hd__inv_2 _0713_ (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0701_));
 sky130_fd_sc_hd__inv_2 _0714_ (.A(\bgen.h[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0702_));
 sky130_fd_sc_hd__inv_2 _0715_ (.A(\bgen.counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0009_));
 sky130_fd_sc_hd__xor2_2 _0716_ (.A(\bgen.counter[1] ),
    .B(\bgen.counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__and3_2 _0717_ (.A(\bgen.counter[1] ),
    .B(\bgen.counter[0] ),
    .C(\bgen.counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__a21oi_2 _0718_ (.A1(\bgen.counter[1] ),
    .A2(\bgen.counter[0] ),
    .B1(\bgen.counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__nor2_2 _0719_ (.A(_0054_),
    .B(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0011_));
 sky130_fd_sc_hd__and2_2 _0720_ (.A(\bgen.counter[3] ),
    .B(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__nor2_2 _0721_ (.A(\bgen.counter[3] ),
    .B(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0057_));
 sky130_fd_sc_hd__nor2_2 _0722_ (.A(_0056_),
    .B(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0012_));
 sky130_fd_sc_hd__nand2_2 _0723_ (.A(\bgen.counter[4] ),
    .B(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0058_));
 sky130_fd_sc_hd__or2_2 _0724_ (.A(\bgen.counter[4] ),
    .B(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__and2_2 _0725_ (.A(_0058_),
    .B(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__xnor2_2 _0726_ (.A(\bgen.counter[5] ),
    .B(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0014_));
 sky130_fd_sc_hd__nand2_2 _0727_ (.A(\bgen.v[7] ),
    .B(_0697_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0060_));
 sky130_fd_sc_hd__and2_2 _0728_ (.A(net16),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__nand2_2 _0729_ (.A(net16),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0062_));
 sky130_fd_sc_hd__xnor2_2 _0730_ (.A(net16),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__or2_2 _0731_ (.A(net15),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__mux2_1 _0732_ (.A0(_0700_),
    .A1(net16),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__and2_2 _0733_ (.A(net12),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__nor2_2 _0734_ (.A(net12),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__xnor2_2 _0735_ (.A(net12),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__mux2_1 _0736_ (.A0(net10),
    .A1(_0068_),
    .S(_0700_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__and4_2 _0737_ (.A(net11),
    .B(_0062_),
    .C(_0063_),
    .D(_0065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__and4bb_2 _0738_ (.A_N(_0061_),
    .B_N(_0065_),
    .C(_0063_),
    .D(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__and2_2 _0739_ (.A(_0043_),
    .B(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__nand2_2 _0740_ (.A(net16),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__or2_2 _0741_ (.A(net16),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__and4_2 _0742_ (.A(_0700_),
    .B(net10),
    .C(_0073_),
    .D(_0074_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__and3_2 _0743_ (.A(_0701_),
    .B(net10),
    .C(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__a221o_2 _0744_ (.A1(_0041_),
    .A2(_0075_),
    .B1(_0076_),
    .B2(_0052_),
    .C1(_0072_),
    ...
    .VPWR(VPWR),
    .X(_0077_));
 sky130_fd_sc_hd__a21oi_2 _0745_ (.A1(_0051_),
    .A2(_0070_),
    .B1(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__nor2_2 _0746_ (.A(_0069_),
    .B(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__nor2_2 _0747_ (.A(net10),
    .B(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0080_));
 sky130_fd_sc_hd__nand2_2 _0748_ (.A(net24),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__a221oi_2 _0749_ (.A1(_0049_),
    .A2(_0079_),
    .B1(_0080_),
    .B2(_0043_),
    .C1(_0081_),
    ...
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__nand2_2 _0750_ (.A(_0078_),
    .B(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__and2_2 _0751_ (.A(_0042_),
    .B(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__a22o_2 _0752_ (.A1(_0041_),
    .A2(_0075_),
    .B1(_0080_),
    .B2(_0044_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__a211o_2 _0753_ (.A1(_0050_),
    .A2(_0076_),
    .B1(_0084_),
    .C1(_0085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__nand2_2 _0754_ (.A(_0692_),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__a2111o_2 _0755_ (.A1(_0050_),
    .A2(_0079_),
    .B1(_0086_),
    .C1(_0087_),
    .D1(_0072_),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__and2_2 _0756_ (.A(_0051_),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__a221o_2 _0757_ (.A1(_0053_),
    .A2(_0076_),
    .B1(_0080_),
    .B2(_0045_),
    .C1(_0089_),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__a211o_2 _0758_ (.A1(net24),
    .A2(_0090_),
    .B1(_0084_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__or2_2 _0759_ (.A(_0071_),
    .B(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__a221o_2 _0760_ (.A1(_0042_),
    .A2(_0076_),
    .B1(_0080_),
    .B2(_0046_),
    .C1(_0089_),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__a221o_2 _0761_ (.A1(_0051_),
    .A2(_0092_),
    .B1(_0093_),
    .B2(_0692_),
    .C1(_0091_),
    ...
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__a31o_2 _0762_ (.A1(_0083_),
    .A2(_0088_),
    .A3(_0094_),
    .B1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__a22o_2 _0763_ (.A1(_0048_),
    .A2(_0079_),
    .B1(_0080_),
    .B2(_0043_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__or3b_2 _0764_ (.A(_0096_),
    .B(net22),
    .C_N(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__a211o_2 _0765_ (.A1(_0043_),
    .A2(_0075_),
    .B1(_0084_),
    .C1(_0699_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__a211o_2 _0766_ (.A1(_0045_),
    .A2(_0071_),
    .B1(_0090_),
    .C1(_0098_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__nand2_2 _0767_ (.A(net18),
    .B(_0699_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__a211o_2 _0768_ (.A1(_0046_),
    .A2(_0071_),
    .B1(_0093_),
    .C1(_0098_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__a221o_2 _0769_ (.A1(_0044_),
    .A2(_0071_),
    .B1(_0079_),
    .B2(_0047_),
    .C1(net22),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__o211a_2 _0770_ (.A1(_0086_),
    .A2(_0102_),
    .B1(_0101_),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__a311o_2 _0771_ (.A1(_0692_),
    .A2(_0097_),
    .A3(_0099_),
    .B1(_0103_),
    .C1(_0698_),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__mux2_1 _0772_ (.A0(_0066_),
    .A1(_0067_),
    .S(_0700_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__or4b_2 _0773_ (.A(net29),
    .B(\bgen.v[9] ),
    .C(\bgen.h[9] ),
    .D_N(\bgen.v[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__or4_2 _0774_ (.A(net27),
    .B(net25),
    .C(\bgen.h[7] ),
    .D(_0702_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__nor3_2 _0775_ (.A(_0105_),
    .B(_0106_),
    .C(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__a31o_2 _0776_ (.A1(_0095_),
    .A2(_0104_),
    .A3(_0108_),
    .B1(_0060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__and2_2 _0777_ (.A(net25),
    .B(\bgen.v[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__nand2_2 _0778_ (.A(net25),
    .B(\bgen.v[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__nor2_2 _0779_ (.A(_0696_),
    .B(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__nand2_2 _0780_ (.A(\bgen.v[8] ),
    .B(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__o21ai_2 _0781_ (.A1(\bgen.h[7] ),
    .A2(\bgen.h[8] ),
    .B1(\bgen.h[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__nand4b_2 _0782_ (.A_N(\bgen.v[9] ),
    .B(_0109_),
    .C(_0113_),
    .D(_0114_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__nor2_2 _0783_ (.A(net35),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__nor2_2 _0784_ (.A(net31),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__a22o_2 _0785_ (.A1(net35),
    .A2(net23),
    .B1(net31),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__or4b_2 _0786_ (.A(_0116_),
    .B(_0118_),
    .C(_0117_),
    .D_N(_0060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__a21oi_2 _0787_ (.A1(net12),
    .A2(net10),
    .B1(\bgen.h[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__and3_2 _0788_ (.A(net12),
    .B(\bgen.h[6] ),
    .C(\bgen.h[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__nor2_2 _0789_ (.A(\bgen.v[7] ),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__nor4_2 _0790_ (.A(_0112_),
    .B(_0120_),
    .C(_0121_),
    .D(_0122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0123_));
 sky130_fd_sc_hd__or4_2 _0791_ (.A(_0112_),
    .B(_0120_),
    .C(_0121_),
    .D(_0122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__o22a_2 _0792_ (.A1(_0120_),
    .A2(_0121_),
    .B1(_0122_),
    .B2(_0112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__nor2_2 _0793_ (.A(net25),
    .B(\bgen.v[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__or2_2 _0794_ (.A(_0110_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__or2_2 _0795_ (.A(_0068_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__nand2_2 _0796_ (.A(_0068_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__nand2_2 _0797_ (.A(_0128_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__nor2_2 _0798_ (.A(net26),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__or3_2 _0799_ (.A(net26),
    .B(net12),
    .C(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__a211o_2 _0800_ (.A1(_0128_),
    .A2(_0132_),
    .B1(_0123_),
    .C1(_0125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__o211ai_2 _0801_ (.A1(_0123_),
    .A2(_0125_),
    .B1(_0128_),
    .C1(_0132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__and2_2 _0802_ (.A(_0133_),
    .B(_0134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__nand2_2 _0803_ (.A(\bgen.counter[3] ),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__or2_2 _0804_ (.A(\bgen.counter[3] ),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__nand2_2 _0805_ (.A(_0136_),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__nand2_2 _0806_ (.A(net33),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__and2_2 _0807_ (.A(net29),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__nand2_2 _0808_ (.A(net29),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__nand2_2 _0809_ (.A(net33),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__and2_2 _0810_ (.A(net31),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__nor2_2 _0811_ (.A(_0139_),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__nand2_2 _0812_ (.A(net35),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__a21oi_2 _0813_ (.A1(net33),
    .A2(net27),
    .B1(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__nor2_2 _0814_ (.A(_0144_),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__o21bai_2 _0815_ (.A1(_0145_),
    .A2(_0146_),
    .B1_N(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__nand2_2 _0816_ (.A(net15),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0149_));
 sky130_fd_sc_hd__nand2_2 _0817_ (.A(net18),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__and2b_2 _0818_ (.A_N(net21),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__xnor2_2 _0819_ (.A(_0150_),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__xnor2_2 _0820_ (.A(net16),
    .B(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0153_));
 sky130_fd_sc_hd__and2b_2 _0821_ (.A_N(_0153_),
    .B(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__xnor2_2 _0822_ (.A(_0148_),
    .B(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__and2_2 _0823_ (.A(net21),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__nand2_2 _0824_ (.A(net21),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__and2b_2 _0825_ (.A_N(net23),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__nand2_2 _0826_ (.A(net16),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__nor2_2 _0827_ (.A(_0156_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_2 _0828_ (.A(_0157_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__o22a_2 _0829_ (.A1(_0087_),
    .A2(_0149_),
    .B1(_0159_),
    .B2(_0160_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__and2b_2 _0830_ (.A_N(_0162_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _0831_ (.A(_0154_),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__and3_2 _0832_ (.A(net18),
    .B(net13),
    .C(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__nand2_2 _0833_ (.A(net23),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__o21a_2 _0834_ (.A1(_0699_),
    .A2(_0701_),
    .B1(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__or2_2 _0835_ (.A(_0165_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__o21ba_2 _0836_ (.A1(_0166_),
    .A2(_0167_),
    .B1_N(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__or2_2 _0837_ (.A(net23),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__a21oi_2 _0838_ (.A1(_0081_),
    .A2(_0170_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__a31o_2 _0839_ (.A1(net18),
    .A2(_0081_),
    .A3(_0170_),
    .B1(_0701_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__or2_2 _0840_ (.A(_0171_),
    .B(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__xor2_2 _0841_ (.A(_0169_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__xor2_2 _0842_ (.A(_0166_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__nand2_2 _0843_ (.A(net19),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__nor2_2 _0844_ (.A(_0157_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__nand2_2 _0845_ (.A(_0157_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__and2b_2 _0846_ (.A_N(_0177_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__a31o_2 _0847_ (.A1(net23),
    .A2(net14),
    .A3(_0178_),
    .B1(_0177_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__nand2_2 _0848_ (.A(_0175_),
    .B(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__xnor2_2 _0849_ (.A(_0164_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__nor2_2 _0850_ (.A(_0181_),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__a21oi_2 _0851_ (.A1(_0164_),
    .A2(_0174_),
    .B1(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__nand2_2 _0852_ (.A(net28),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__nand2_2 _0853_ (.A(net31),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__nor2_2 _0854_ (.A(_0139_),
    .B(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__o21ai_2 _0855_ (.A1(_0693_),
    .A2(_0695_),
    .B1(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__nand2b_2 _0856_ (.A_N(_0187_),
    .B(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__a31o_2 _0857_ (.A1(net35),
    .A2(net26),
    .A3(_0188_),
    .B1(_0187_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _0858_ (.A(net18),
    ...
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__xnor2_2 _0859_ (.A(_0190_),
    .B(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__a2bb2oi_2 _0860_ (.A1_N(_0100_),
    .A2_N(_0149_),
    .B1(_0152_),
    .B2(net16),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__nor2_2 _0861_ (.A(_0192_),
    .B(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0194_));
 sky130_fd_sc_hd__a21o_2 _0862_ (.A1(_0190_),
    .A2(_0191_),
    .B1(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__o21a_2 _0863_ (.A1(net18),
    .A2(_0170_),
    .B1(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__nand2_2 _0864_ (.A(_0195_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__or2_2 _0865_ (.A(_0195_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand2_2 _0866_ (.A(_0197_),
    .B(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__or2_2 _0867_ (.A(net33),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__and3b_2 _0868_ (.A_N(_0145_),
    .B(_0200_),
    .C(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__a31o_2 _0869_ (.A1(net33),
    .A2(net31),
    .A3(net26),
    .B1(_0201_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__and2_2 _0870_ (.A(_0064_),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__and2_2 _0871_ (.A(_0202_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__xnor2_2 _0872_ (.A(_0202_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__nor2_2 _0873_ (.A(_0062_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__and2_2 _0874_ (.A(_0062_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__or2_2 _0875_ (.A(_0206_),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__a21oi_2 _0876_ (.A1(_0139_),
    .A2(_0200_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__or3_4 _0877_ (.A(_0695_),
    .B(_0201_),
    .C(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__a21oi_2 _0878_ (.A1(_0694_),
    .A2(_0695_),
    .B1(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__nor2_2 _0879_ (.A(net25),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__a22o_2 _0880_ (.A1(net25),
    .A2(_0140_),
    .B1(_0185_),
    .B2(_0211_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__and2b_2 _0881_ (.A_N(_0210_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__xor2_2 _0882_ (.A(_0210_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__nor2_2 _0883_ (.A(net31),
    .B(_0695_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__and2b_2 _0884_ (.A_N(net33),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__and3_2 _0885_ (.A(net31),
    .B(net28),
    .C(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__xnor2_2 _0886_ (.A(_0186_),
    .B(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__nand2_2 _0887_ (.A(net29),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__a21oi_2 _0888_ (.A1(net29),
    .A2(_0219_),
    .B1(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__and2b_2 _0889_ (.A_N(_0216_),
    .B(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__xnor2_2 _0890_ (.A(_0216_),
    .B(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__o32a_2 _0891_ (.A1(net31),
    .A2(_0695_),
    .A3(_0220_),
    .B1(_0222_),
    .B2(_0210_),
    ...
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__xnor2_2 _0892_ (.A(_0215_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__xnor2_2 _0893_ (.A(_0208_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__xnor2_2 _0894_ (.A(_0210_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__xnor2_2 _0895_ (.A(net30),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__and2b_2 _0896_ (.A_N(net35),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__and3_2 _0897_ (.A(net33),
    .B(net28),
    .C(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__xnor2_2 _0898_ (.A(_0142_),
    .B(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0231_));
 sky130_fd_sc_hd__a21oi_2 _0899_ (.A1(_0143_),
    .A2(_0231_),
    .B1(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__or2_2 _0900_ (.A(_0228_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__xnor2_2 _0901_ (.A(_0145_),
    .B(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__xnor2_2 _0902_ (.A(_0228_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__o21a_2 _0903_ (.A1(_0234_),
    .A2(_0235_),
    .B1(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__nand2b_2 _0904_ (.A_N(_0236_),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0237_));
 sky130_fd_sc_hd__and2_2 _0905_ (.A(_0192_),
    .B(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__nor2_2 _0906_ (.A(_0194_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0239_));
 sky130_fd_sc_hd__xnor2_2 _0907_ (.A(_0227_),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__a21bo_2 _0908_ (.A1(_0239_),
    .A2(_0240_),
    .B1_N(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__nand2b_2 _0909_ (.A_N(_0226_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__xor2_2 _0910_ (.A(_0226_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__xnor2_2 _0911_ (.A(_0199_),
    .B(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0244_));
 sky130_fd_sc_hd__xor2_2 _0912_ (.A(_0239_),
    .B(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__xnor2_2 _0913_ (.A(_0234_),
    .B(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(net35),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__and4_2 _0915_ (.A(net35),
    .B(net33),
    .C(net30),
    .D(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__xor2_2 _0916_ (.A(_0143_),
    .B(_0231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__and2_2 _0917_ (.A(_0248_),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__xor2_2 _0918_ (.A(_0248_),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__xnor2_2 _0919_ (.A(_0145_),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__a21oi_2 _0920_ (.A1(_0251_),
    .A2(_0252_),
    .B1(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__nor2_2 _0921_ (.A(_0246_),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__and2b_2 _0922_ (.A_N(_0155_),
    .B(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__or2_2 _0923_ (.A(_0163_),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__xnor2_2 _0924_ (.A(_0246_),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0257_));
 sky130_fd_sc_hd__o21ba_2 _0925_ (.A1(_0256_),
    .A2(_0257_),
    .B1_N(_0254_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_2 _0926_ (.A_N(_0258_),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__xor2_2 _0927_ (.A(_0181_),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__xnor2_2 _0928_ (.A(_0245_),
    .B(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__a21o_2 _0929_ (.A1(_0260_),
    .A2(_0261_),
    .B1(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__and2b_2 _0930_ (.A_N(_0244_),
    .B(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__xnor2_2 _0931_ (.A(_0244_),
    .B(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0264_));
 sky130_fd_sc_hd__and2b_2 _0932_ (.A_N(_0184_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0265_));
 sky130_fd_sc_hd__xnor2_2 _0933_ (.A(_0184_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__xnor2_2 _0934_ (.A(_0260_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__xnor2_2 _0935_ (.A(_0256_),
    .B(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__xnor2_2 _0936_ (.A(_0251_),
    .B(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__a22o_2 _0937_ (.A1(net34),
    .A2(net30),
    .B1(net28),
    .B2(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__or2_2 _0938_ (.A(net32),
    .B(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__or3b_2 _0939_ (.A(net32),
    .B(_0248_),
    .C_N(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__or2_2 _0940_ (.A(_0269_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__and3_2 _0941_ (.A(net23),
    .B(net16),
    .C(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__inv_2 _0942_ (.A(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__xnor2_2 _0943_ (.A(_0159_),
    .B(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__nand2_2 _0944_ (.A(_0270_),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__and3_2 _0945_ (.A(_0270_),
    .B(_0271_),
    .C(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__xor2_2 _0946_ (.A(_0276_),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__nor2_2 _0947_ (.A(_0275_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__and2_2 _0948_ (.A(_0275_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__or2_2 _0949_ (.A(_0280_),
    .B(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__xnor2_2 _0950_ (.A(_0269_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__or2_2 _0951_ (.A(_0282_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__o21a_2 _0952_ (.A1(_0282_),
    .A2(_0283_),
    .B1(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__nor2_2 _0953_ (.A(_0268_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__xor2_2 _0954_ (.A(_0175_),
    .B(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__or3_2 _0955_ (.A(_0278_),
    .B(_0280_),
    .C(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__o21ai_2 _0956_ (.A1(_0278_),
    .A2(_0280_),
    .B1(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0289_));
 sky130_fd_sc_hd__and2_2 _0957_ (.A(_0288_),
    .B(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__xnor2_2 _0958_ (.A(_0166_),
    .B(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__a22o_2 _0959_ (.A1(net17),
    .A2(net21),
    .B1(net15),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__o21ai_2 _0960_ (.A1(net19),
    .A2(_0274_),
    .B1(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0293_));
 sky130_fd_sc_hd__and2b_2 _0961_ (.A_N(_0293_),
    .B(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__xnor2_2 _0962_ (.A(_0291_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__a21oi_2 _0963_ (.A1(\bgen.dy[5] ),
    .A2(_0295_),
    .B1(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0296_));
 sky130_fd_sc_hd__nand2b_2 _0964_ (.A_N(_0296_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__xnor2_2 _0965_ (.A(_0290_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__xor2_2 _0966_ (.A(_0268_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__a21oi_2 _0967_ (.A1(_0298_),
    .A2(_0299_),
    .B1(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0300_));
 sky130_fd_sc_hd__nand2_2 _0968_ (.A(_0289_),
    .B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__xnor2_2 _0969_ (.A(_0267_),
    .B(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__nand2b_2 _0970_ (.A_N(_0302_),
    .B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__o21a_2 _0971_ (.A1(_0267_),
    .A2(_0300_),
    .B1(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__and2b_2 _0972_ (.A_N(_0304_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__nor2_2 _0973_ (.A(net29),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0306_));
 sky130_fd_sc_hd__o21ai_2 _0974_ (.A1(_0140_),
    .A2(_0306_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__xnor2_2 _0975_ (.A(_0210_),
    .B(_0307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__o21ba_2 _0976_ (.A1(_0212_),
    .A2(_0214_),
    .B1_N(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__or3b_2 _0977_ (.A(_0212_),
    .B(_0214_),
    .C_N(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__nand2b_2 _0978_ (.A_N(_0309_),
    .B(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__and3_2 _0979_ (.A(net11),
    .B(_0073_),
    .C(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__a21oi_2 _0980_ (.A1(net11),
    .A2(_0073_),
    .B1(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__or2_2 _0981_ (.A(_0312_),
    .B(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__nor2_2 _0982_ (.A(_0149_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__and2_2 _0983_ (.A(_0149_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__nor2_2 _0984_ (.A(_0315_),
    .B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__and2b_2 _0985_ (.A_N(_0311_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__xnor2_2 _0986_ (.A(_0311_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__o32a_2 _0987_ (.A1(_0206_),
    .A2(_0207_),
    .A3(_0225_),
    .B1(_0224_),
    .B2(_0215_),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__nand2b_2 _0988_ (.A_N(_0320_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__xnor2_2 _0989_ (.A(_0319_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__o21ai_2 _0990_ (.A1(_0204_),
    .A2(_0206_),
    .B1(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__or3_2 _0991_ (.A(_0196_),
    .B(_0204_),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__and2_2 _0992_ (.A(_0323_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__nand2_2 _0993_ (.A(_0322_),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _0994_ (.A(_0322_),
    ...
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__o21a_2 _0995_ (.A1(_0199_),
    .A2(_0243_),
    .B1(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__or2_2 _0996_ (.A(_0327_),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__xnor2_2 _0997_ (.A(_0327_),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__xor2_2 _0998_ (.A(_0197_),
    .B(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__o21ai_2 _0999_ (.A1(_0263_),
    .A2(_0265_),
    .B1(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__or3_2 _1000_ (.A(_0263_),
    .B(_0265_),
    .C(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__and2_2 _1001_ (.A(_0332_),
    .B(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__nand2_2 _1002_ (.A(_0305_),
    .B(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__or2_2 _1003_ (.A(_0305_),
    .B(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__and2_2 _1004_ (.A(_0335_),
    .B(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__xor2_2 _1005_ (.A(_0301_),
    .B(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__xnor2_2 _1006_ (.A(_0298_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__nand2_2 _1007_ (.A(_0282_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__xnor2_2 _1008_ (.A(_0282_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__and3_2 _1009_ (.A(net36),
    .B(net32),
    .C(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__a21oi_2 _1010_ (.A1(net36),
    .A2(net30),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__nand2b_2 _1011_ (.A_N(_0274_),
    .B(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__or2_2 _1012_ (.A(_0139_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__xnor2_2 _1013_ (.A(_0139_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__or3_2 _1014_ (.A(_0342_),
    .B(_0343_),
    .C(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__nand2b_2 _1015_ (.A_N(_0342_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__xnor2_2 _1016_ (.A(_0341_),
    .B(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__and3_2 _1017_ (.A(net19),
    .B(net21),
    .C(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__xnor2_2 _1018_ (.A(\bgen.dy[5] ),
    .B(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0351_));
 sky130_fd_sc_hd__xnor2_2 _1019_ (.A(_0345_),
    .B(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__or3b_2 _1020_ (.A(_0176_),
    .B(_0351_),
    .C_N(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__xnor2_2 _1021_ (.A(_0350_),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__a32o_2 _1022_ (.A1(_0284_),
    .A2(_0340_),
    .A3(_0348_),
    .B1(_0349_),
    .B2(_0354_),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__and2b_2 _1023_ (.A_N(_0339_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__o21ai_2 _1024_ (.A1(_0345_),
    .A2(_0351_),
    .B1(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__xnor2_2 _1025_ (.A(_0339_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0358_));
 sky130_fd_sc_hd__a21oi_2 _1026_ (.A1(_0357_),
    .A2(_0358_),
    .B1(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__or2_2 _1027_ (.A(_0338_),
    .B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__xnor2_2 _1028_ (.A(_0266_),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__and2b_2 _1029_ (.A_N(_0360_),
    .B(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__xor2_2 _1030_ (.A(_0360_),
    .B(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__xnor2_2 _1031_ (.A(_0357_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__xnor2_2 _1032_ (.A(_0349_),
    .B(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__and4_2 _1033_ (.A(net36),
    .B(net23),
    .C(net32),
    .D(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__a21oi_2 _1034_ (.A1(net23),
    .A2(net15),
    .B1(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__a31o_2 _1035_ (.A1(_0100_),
    .A2(_0275_),
    .A3(_0292_),
    .B1(_0367_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__and2_2 _1036_ (.A(_0366_),
    .B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__xor2_2 _1037_ (.A(_0366_),
    .B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__nor2_2 _1038_ (.A(_0692_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__xor2_2 _1039_ (.A(_0370_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__o21ai_2 _1040_ (.A1(_0342_),
    .A2(_0343_),
    .B1(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__and2_2 _1041_ (.A(_0347_),
    .B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__and2_2 _1042_ (.A(_0372_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__nand2b_2 _1043_ (.A_N(_0365_),
    .B(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0376_));
 sky130_fd_sc_hd__a21oi_2 _1044_ (.A1(_0370_),
    .A2(_0371_),
    .B1(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0377_));
 sky130_fd_sc_hd__xnor2_2 _1045_ (.A(_0365_),
    .B(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__nand2b_2 _1046_ (.A_N(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0379_));
 sky130_fd_sc_hd__a21oi_2 _1047_ (.A1(_0376_),
    .A2(_0379_),
    .B1(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__xor2_2 _1048_ (.A(_0338_),
    .B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__nand2_2 _1049_ (.A(_0380_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__and3_2 _1050_ (.A(_0364_),
    .B(_0376_),
    .C(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__or2_2 _1051_ (.A(_0380_),
    .B(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__xnor2_2 _1052_ (.A(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__nor2_2 _1053_ (.A(_0372_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__or2_2 _1054_ (.A(_0375_),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__a22o_2 _1055_ (.A1(net35),
    .A2(net32),
    .B1(net17),
    .B2(net24),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1056_ (.A(_0388_),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__nor3_2 _1057_ (.A(_0247_),
    .B(_0366_),
    .C(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__or2_2 _1058_ (.A(net17),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__and3_2 _1059_ (.A(net24),
    .B(_0159_),
    .C(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__and2_2 _1060_ (.A(net21),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__mux2_1 _1061_ (.A0(_0081_),
    .A1(net22),
    .S(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__o21a_2 _1062_ (.A1(_0366_),
    .A2(_0389_),
    .B1(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__nor2_2 _1063_ (.A(_0390_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__o21ba_2 _1064_ (.A1(_0394_),
    .A2(_0395_),
    .B1_N(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__xor2_2 _1065_ (.A(_0387_),
    .B(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__and2_2 _1066_ (.A(_0393_),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__o21ba_2 _1067_ (.A1(_0387_),
    .A2(_0397_),
    .B1_N(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__and2b_2 _1068_ (.A_N(_0400_),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__xnor2_2 _1069_ (.A(_0385_),
    .B(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__a21oi_2 _1070_ (.A1(net14),
    .A2(_0402_),
    .B1(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0403_));
 sky130_fd_sc_hd__or2_2 _1071_ (.A(_0384_),
    .B(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__xnor2_2 _1072_ (.A(_0380_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__o31a_2 _1073_ (.A1(_0384_),
    .A2(_0403_),
    .A3(_0405_),
    .B1(_0382_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__nor2_2 _1074_ (.A(_0363_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__nor2_2 _1075_ (.A(_0362_),
    .B(_0407_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__o21ai_2 _1076_ (.A1(_0362_),
    .A2(_0407_),
    .B1(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__xnor2_2 _1077_ (.A(_0337_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0410_));
 sky130_fd_sc_hd__xor2_2 _1078_ (.A(\bgen.counter[3] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__or2_2 _1079_ (.A(\bgen.counter[2] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__nand2_2 _1080_ (.A(\bgen.counter[2] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__xnor2_2 _1081_ (.A(\bgen.h[8] ),
    .B(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0414_));
 sky130_fd_sc_hd__and3_2 _1082_ (.A(_0412_),
    .B(_0413_),
    .C(_0414_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__xor2_2 _1083_ (.A(\bgen.counter[1] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__nand4_2 _1084_ (.A(net12),
    .B(\bgen.h[6] ),
    .C(\bgen.h[7] ),
    .D(\bgen.h[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__a31o_2 _1085_ (.A1(net13),
    .A2(\bgen.h[6] ),
    .A3(\bgen.h[7] ),
    .B1(\bgen.h[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__and2_2 _1086_ (.A(_0417_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__a21bo_2 _1087_ (.A1(_0417_),
    .A2(_0418_),
    .B1_N(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__or2_2 _1088_ (.A(_0702_),
    .B(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__and3_2 _1089_ (.A(_0416_),
    .B(_0420_),
    .C(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__or2_2 _1090_ (.A(\bgen.counter[0] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__nand2_2 _1091_ (.A(\bgen.counter[0] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__nor2_2 _1092_ (.A(net13),
    .B(\bgen.h[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__a31o_2 _1093_ (.A1(net13),
    .A2(_0417_),
    .A3(_0418_),
    .B1(_0425_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__a21oi_2 _1094_ (.A1(_0423_),
    .A2(_0424_),
    .B1(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__a21oi_2 _1095_ (.A1(_0420_),
    .A2(_0421_),
    .B1(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__or2_2 _1096_ (.A(_0422_),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__o21bai_2 _1097_ (.A1(_0427_),
    .A2(_0428_),
    .B1_N(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0430_));
 sky130_fd_sc_hd__a21oi_2 _1098_ (.A1(_0412_),
    .A2(_0413_),
    .B1(_0414_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__nor2_2 _1099_ (.A(_0415_),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0432_));
 sky130_fd_sc_hd__and2_2 _1100_ (.A(_0411_),
    .B(_0415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__a31o_2 _1101_ (.A1(_0411_),
    .A2(_0430_),
    .A3(_0432_),
    .B1(_0433_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__xor2_2 _1102_ (.A(\bgen.counter[4] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__nand2_2 _1103_ (.A(_0434_),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0436_));
 sky130_fd_sc_hd__and3_2 _1104_ (.A(_0423_),
    .B(_0424_),
    .C(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__nor2_2 _1105_ (.A(_0427_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0438_));
 sky130_fd_sc_hd__nor2_2 _1106_ (.A(_0436_),
    .B(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__xor2_2 _1107_ (.A(_0427_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__xnor2_2 _1108_ (.A(_0427_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__xnor2_2 _1109_ (.A(_0434_),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0442_));
 sky130_fd_sc_hd__nor2_2 _1110_ (.A(_0441_),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__xnor2_2 _1111_ (.A(_0430_),
    .B(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__a211oi_2 _1112_ (.A1(_0430_),
    .A2(_0432_),
    .B1(_0411_),
    .C1(_0415_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__nor2_2 _1113_ (.A(_0434_),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0446_));
 sky130_fd_sc_hd__inv_2 _1114_ (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__nand2b_2 _1115_ (.A_N(_0444_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0448_));
 sky130_fd_sc_hd__or2_2 _1116_ (.A(_0438_),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__inv_2 _1117_ (.A(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__a21oi_2 _1118_ (.A1(_0440_),
    .A2(net8),
    .B1(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__or2_2 _1119_ (.A(_0441_),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__or2_2 _1120_ (.A(_0451_),
    .B(_0452_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__nor2_2 _1121_ (.A(_0438_),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__o21ba_2 _1122_ (.A1(_0440_),
    .A2(_0454_),
    .B1_N(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__mux2_1 _1123_ (.A0(_0452_),
    .A1(_0455_),
    .S(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__a21o_2 _1124_ (.A1(_0443_),
    .A2(_0450_),
    .B1(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__xor2_2 _1125_ (.A(_0439_),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__nor2_2 _1126_ (.A(_0441_),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__o21ai_2 _1127_ (.A1(net9),
    .A2(_0459_),
    .B1(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__o211a_2 _1128_ (.A1(net9),
    .A2(_0459_),
    .B1(_0458_),
    .C1(_0454_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__xnor2_2 _1129_ (.A(_0458_),
    .B(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__a21o_2 _1130_ (.A1(_0450_),
    .A2(_0462_),
    .B1(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__nand2_2 _1131_ (.A(net9),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__xnor2_2 _1132_ (.A(_0443_),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__xnor2_2 _1133_ (.A(_0453_),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__a21o_2 _1134_ (.A1(_0439_),
    .A2(_0457_),
    .B1(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__nand2_2 _1135_ (.A(_0463_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__nand2_2 _1136_ (.A(_0435_),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0469_));
 sky130_fd_sc_hd__nand2_2 _1137_ (.A(_0468_),
    .B(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0470_));
 sky130_fd_sc_hd__and3_2 _1138_ (.A(_0410_),
    .B(_0468_),
    .C(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__xor2_4 _1139_ (.A(_0470_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__o22a_2 _1140_ (.A1(_0436_),
    .A2(_0441_),
    .B1(_0442_),
    .B2(_0444_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__mux2_1 _1141_ (.A0(_0446_),
    .A1(_0448_),
    .S(_0473_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__inv_2 _1142_ (.A(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__a31o_2 _1143_ (.A1(_0435_),
    .A2(_0440_),
    .A3(_0446_),
    .B1(_0475_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__nand2_2 _1144_ (.A(_0468_),
    .B(_0476_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0477_));
 sky130_fd_sc_hd__xor2_2 _1145_ (.A(_0404_),
    .B(_0405_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__and3_2 _1146_ (.A(_0468_),
    .B(_0476_),
    .C(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__xor2_2 _1147_ (.A(_0463_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__nand2_2 _1148_ (.A(_0384_),
    .B(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__xnor2_2 _1149_ (.A(_0384_),
    .B(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__xnor2_2 _1150_ (.A(net14),
    .B(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__xnor2_2 _1151_ (.A(_0449_),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__and2b_2 _1152_ (.A_N(_0483_),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__xnor2_2 _1153_ (.A(_0483_),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__nor2_2 _1154_ (.A(_0393_),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__or2_2 _1155_ (.A(_0399_),
    .B(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__nand2_2 _1156_ (.A(_0429_),
    .B(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__o21ai_2 _1157_ (.A1(_0438_),
    .A2(_0447_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__and3_2 _1158_ (.A(_0449_),
    .B(_0489_),
    .C(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__and2b_2 _1159_ (.A_N(_0488_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__nand2_2 _1160_ (.A(_0488_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0493_));
 sky130_fd_sc_hd__or2_2 _1161_ (.A(_0488_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__nand2_2 _1162_ (.A(_0493_),
    .B(_0494_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__and4_2 _1163_ (.A(_0691_),
    .B(_0692_),
    .C(net34),
    .D(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__xnor2_2 _1164_ (.A(_0394_),
    .B(_0396_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__nor2_2 _1165_ (.A(_0496_),
    .B(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0498_));
 sky130_fd_sc_hd__nand2_2 _1166_ (.A(_0441_),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__and3b_2 _1167_ (.A_N(_0438_),
    .B(_0452_),
    .C(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__o21a_2 _1168_ (.A1(net36),
    .A2(_0693_),
    .B1(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__or2_2 _1169_ (.A(_0496_),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__nor2_2 _1170_ (.A(_0489_),
    .B(_0502_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__o21ba_2 _1171_ (.A1(_0500_),
    .A2(_0503_),
    .B1_N(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__a21o_2 _1172_ (.A1(_0495_),
    .A2(_0504_),
    .B1(_0492_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__a21o_2 _1173_ (.A1(_0486_),
    .A2(_0505_),
    .B1(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__xnor2_2 _1174_ (.A(_0480_),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0507_));
 sky130_fd_sc_hd__a32o_2 _1175_ (.A1(_0404_),
    .A2(_0480_),
    .A3(_0481_),
    .B1(_0506_),
    .B2(_0507_),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__nand2_2 _1176_ (.A(_0477_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__nor2_2 _1177_ (.A(_0477_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0510_));
 sky130_fd_sc_hd__xnor2_2 _1178_ (.A(_0477_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__a21o_2 _1179_ (.A1(_0508_),
    .A2(_0511_),
    .B1(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0512_));
 sky130_fd_sc_hd__o22a_2 _1180_ (.A1(_0436_),
    .A2(_0444_),
    .B1(net8),
    .B2(_0442_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__o21ai_2 _1181_ (.A1(_0447_),
    .A2(_0473_),
    .B1(_0513_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0514_));
 sky130_fd_sc_hd__and2_2 _1182_ (.A(_0468_),
    .B(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__xnor2_2 _1183_ (.A(_0363_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__and2_2 _1184_ (.A(_0515_),
    .B(_0516_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__or2_2 _1185_ (.A(_0515_),
    .B(_0516_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__nand2b_2 _1186_ (.A_N(_0517_),
    .B(_0518_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0519_));
 sky130_fd_sc_hd__and3b_2 _1187_ (.A_N(_0516_),
    .B(_0514_),
    .C(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__a21oi_2 _1188_ (.A1(_0512_),
    .A2(_0519_),
    .B1(_0520_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0521_));
 sky130_fd_sc_hd__xnor2_4 _1189_ (.A(_0472_),
    .B(_0521_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__nand2b_2 _1190_ (.A_N(_0138_),
    .B(_0522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0523_));
 sky130_fd_sc_hd__xnor2_2 _1191_ (.A(_0138_),
    .B(_0522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0524_));
 sky130_fd_sc_hd__xnor2_2 _1192_ (.A(_0130_),
    .B(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__nand2_2 _1193_ (.A(\bgen.counter[2] ),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__xnor2_2 _1194_ (.A(_0512_),
    .B(_0519_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0527_));
 sky130_fd_sc_hd__or2_2 _1195_ (.A(\bgen.counter[2] ),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__nand2_2 _1196_ (.A(_0526_),
    .B(_0528_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0529_));
 sky130_fd_sc_hd__o21a_2 _1197_ (.A1(_0527_),
    .A2(_0529_),
    .B1(_0526_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__nand2b_2 _1198_ (.A_N(_0530_),
    .B(_0524_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0531_));
 sky130_fd_sc_hd__xnor2_2 _1199_ (.A(_0527_),
    .B(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__nor2_2 _1200_ (.A(_0695_),
    .B(_0701_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0533_));
 sky130_fd_sc_hd__nor2_2 _1201_ (.A(_0131_),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0534_));
 sky130_fd_sc_hd__nand2_2 _1202_ (.A(\bgen.counter[1] ),
    .B(_0534_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0535_));
 sky130_fd_sc_hd__xnor2_2 _1203_ (.A(_0508_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0536_));
 sky130_fd_sc_hd__xnor2_2 _1204_ (.A(\bgen.counter[1] ),
    .B(_0534_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0537_));
 sky130_fd_sc_hd__o21a_2 _1205_ (.A1(_0536_),
    .A2(_0537_),
    .B1(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0538_));
 sky130_fd_sc_hd__nor2_2 _1206_ (.A(_0532_),
    .B(_0538_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0539_));
 sky130_fd_sc_hd__xnor2_2 _1207_ (.A(_0536_),
    .B(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0540_));
 sky130_fd_sc_hd__xor2_2 _1208_ (.A(_0506_),
    .B(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0541_));
 sky130_fd_sc_hd__nand2_2 _1209_ (.A(\bgen.counter[0] ),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0542_));
 sky130_fd_sc_hd__or2_2 _1210_ (.A(_0540_),
    .B(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0543_));
 sky130_fd_sc_hd__xnor2_2 _1211_ (.A(_0532_),
    .B(_0538_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0544_));
 sky130_fd_sc_hd__nor2_2 _1212_ (.A(_0543_),
    .B(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0545_));
 sky130_fd_sc_hd__xnor2_2 _1213_ (.A(_0524_),
    .B(_0530_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0546_));
 sky130_fd_sc_hd__o21ai_2 _1214_ (.A1(_0539_),
    .A2(_0545_),
    .B1(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0547_));
 sky130_fd_sc_hd__or2_2 _1215_ (.A(\bgen.v[8] ),
    .B(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0548_));
 sky130_fd_sc_hd__nand2_2 _1216_ (.A(_0113_),
    .B(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__xor2_2 _1217_ (.A(_0419_),
    .B(_0549_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0550_));
 sky130_fd_sc_hd__and3_2 _1218_ (.A(_0124_),
    .B(_0133_),
    .C(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0551_));
 sky130_fd_sc_hd__a21oi_2 _1219_ (.A1(_0124_),
    .A2(_0133_),
    .B1(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0552_));
 sky130_fd_sc_hd__nor2_2 _1220_ (.A(_0551_),
    .B(_0552_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0553_));
 sky130_fd_sc_hd__nand2_2 _1221_ (.A(\bgen.counter[4] ),
    .B(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0554_));
 sky130_fd_sc_hd__or2_2 _1222_ (.A(\bgen.counter[4] ),
    .B(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__nand2_2 _1223_ (.A(_0554_),
    .B(_0555_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0556_));
 sky130_fd_sc_hd__a21oi_2 _1224_ (.A1(_0136_),
    .A2(_0523_),
    .B1(_0556_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0557_));
 sky130_fd_sc_hd__and3_2 _1225_ (.A(_0136_),
    .B(_0523_),
    .C(_0556_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0558_));
 sky130_fd_sc_hd__or2_2 _1226_ (.A(_0557_),
    .B(_0558_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0559_));
 sky130_fd_sc_hd__a21oi_2 _1227_ (.A1(_0531_),
    .A2(_0547_),
    .B1(_0559_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0560_));
 sky130_fd_sc_hd__mux2_1 _1228_ (.A0(_0116_),
    .A1(_0429_),
    .S(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__o211a_2 _1229_ (.A1(_0498_),
    .A2(_0500_),
    .B1(_0502_),
    .C1(_0561_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0562_));
 sky130_fd_sc_hd__a21o_2 _1230_ (.A1(_0498_),
    .A2(_0500_),
    .B1(_0562_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0563_));
 sky130_fd_sc_hd__a21bo_2 _1231_ (.A1(_0494_),
    .A2(_0563_),
    .B1_N(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0564_));
 sky130_fd_sc_hd__a21o_2 _1232_ (.A1(_0483_),
    .A2(_0484_),
    .B1(_0564_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__o221a_2 _1233_ (.A1(_0480_),
    .A2(_0482_),
    .B1(_0483_),
    .B2(_0484_),
    .C1(_0565_),
    ...
    .VPWR(VPWR),
    .X(_0566_));
 sky130_fd_sc_hd__a211o_2 _1234_ (.A1(_0480_),
    .A2(_0482_),
    .B1(_0510_),
    .C1(_0566_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__a311oi_2 _1235_ (.A1(_0509_),
    .A2(_0518_),
    .A3(_0567_),
    .B1(_0517_),
    .C1(_0472_),
    ...
    .VPWR(VPWR),
    .Y(_0568_));
 sky130_fd_sc_hd__o21ai_2 _1236_ (.A1(_0312_),
    .A2(_0315_),
    .B1(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0569_));
 sky130_fd_sc_hd__or3_2 _1237_ (.A(_0196_),
    .B(_0312_),
    .C(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0570_));
 sky130_fd_sc_hd__nand2_2 _1238_ (.A(_0569_),
    .B(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0571_));
 sky130_fd_sc_hd__nand2_2 _1239_ (.A(_0073_),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0572_));
 sky130_fd_sc_hd__nand2_2 _1240_ (.A(_0062_),
    .B(_0572_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0573_));
 sky130_fd_sc_hd__xor2_2 _1241_ (.A(_0202_),
    .B(_0573_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0574_));
 sky130_fd_sc_hd__nor2_2 _1242_ (.A(_0073_),
    .B(_0574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0575_));
 sky130_fd_sc_hd__xnor2_2 _1243_ (.A(_0073_),
    .B(_0574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0576_));
 sky130_fd_sc_hd__a21oi_2 _1244_ (.A1(net25),
    .A2(_0306_),
    .B1(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0577_));
 sky130_fd_sc_hd__a21o_2 _1245_ (.A1(net25),
    .A2(_0140_),
    .B1(_0577_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0578_));
 sky130_fd_sc_hd__nand2_2 _1246_ (.A(_0576_),
    .B(_0578_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0579_));
 sky130_fd_sc_hd__or2_2 _1247_ (.A(_0576_),
    .B(_0578_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__nand2_2 _1248_ (.A(_0579_),
    .B(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0581_));
 sky130_fd_sc_hd__o21a_2 _1249_ (.A1(_0309_),
    .A2(_0318_),
    .B1(_0581_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0582_));
 sky130_fd_sc_hd__nor3_2 _1250_ (.A(_0309_),
    .B(_0318_),
    .C(_0581_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0583_));
 sky130_fd_sc_hd__nor2_2 _1251_ (.A(_0582_),
    .B(_0583_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0584_));
 sky130_fd_sc_hd__xor2_2 _1252_ (.A(_0571_),
    .B(_0584_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0585_));
 sky130_fd_sc_hd__a21oi_2 _1253_ (.A1(_0321_),
    .A2(_0326_),
    .B1(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0586_));
 sky130_fd_sc_hd__and3_2 _1254_ (.A(_0321_),
    .B(_0326_),
    .C(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0587_));
 sky130_fd_sc_hd__or2_2 _1255_ (.A(_0586_),
    .B(_0587_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0588_));
 sky130_fd_sc_hd__nor2_2 _1256_ (.A(_0323_),
    .B(_0588_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0589_));
 sky130_fd_sc_hd__and2_2 _1257_ (.A(_0323_),
    .B(_0588_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0590_));
 sky130_fd_sc_hd__nor2_2 _1258_ (.A(_0589_),
    .B(_0590_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0591_));
 sky130_fd_sc_hd__o21a_2 _1259_ (.A1(_0197_),
    .A2(_0330_),
    .B1(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0592_));
 sky130_fd_sc_hd__and2b_2 _1260_ (.A_N(_0592_),
    .B(_0591_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0593_));
 sky130_fd_sc_hd__and2b_2 _1261_ (.A_N(_0591_),
    .B(_0592_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0594_));
 sky130_fd_sc_hd__or2_2 _1262_ (.A(_0593_),
    .B(_0594_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0595_));
 sky130_fd_sc_hd__nor2_2 _1263_ (.A(_0332_),
    .B(_0595_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0596_));
 sky130_fd_sc_hd__and2_2 _1264_ (.A(_0332_),
    .B(_0595_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0597_));
 sky130_fd_sc_hd__or2_2 _1265_ (.A(_0596_),
    .B(_0597_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0598_));
 sky130_fd_sc_hd__a21oi_2 _1266_ (.A1(_0335_),
    .A2(_0409_),
    .B1(_0598_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0599_));
 sky130_fd_sc_hd__and3_2 _1267_ (.A(_0335_),
    .B(_0409_),
    .C(_0598_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0600_));
 sky130_fd_sc_hd__nor2_2 _1268_ (.A(_0599_),
    .B(_0600_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0601_));
 sky130_fd_sc_hd__o22a_2 _1269_ (.A1(_0471_),
    .A2(_0568_),
    .B1(_0601_),
    .B2(_0436_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0602_));
 sky130_fd_sc_hd__a31o_2 _1270_ (.A1(_0569_),
    .A2(_0570_),
    .A3(_0584_),
    .B1(_0582_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0603_));
 sky130_fd_sc_hd__a31o_2 _1271_ (.A1(_0062_),
    .A2(_0202_),
    .A3(_0572_),
    .B1(_0575_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0604_));
 sky130_fd_sc_hd__xor2_2 _1272_ (.A(_0196_),
    .B(_0572_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0605_));
 sky130_fd_sc_hd__xnor2_2 _1273_ (.A(_0202_),
    .B(_0605_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0606_));
 sky130_fd_sc_hd__xnor2_2 _1274_ (.A(_0604_),
    .B(_0606_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0607_));
 sky130_fd_sc_hd__xnor2_2 _1275_ (.A(_0579_),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0608_));
 sky130_fd_sc_hd__xnor2_2 _1276_ (.A(_0603_),
    .B(_0608_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__o22a_2 _1277_ (.A1(_0586_),
    .A2(_0589_),
    .B1(_0609_),
    .B2(_0569_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0610_));
 sky130_fd_sc_hd__a211o_2 _1278_ (.A1(_0569_),
    .A2(_0609_),
    .B1(_0610_),
    .C1(_0593_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0611_));
 sky130_fd_sc_hd__o21a_2 _1279_ (.A1(_0596_),
    .A2(_0599_),
    .B1(_0611_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0612_));
 sky130_fd_sc_hd__a211o_2 _1280_ (.A1(_0436_),
    .A2(_0601_),
    .B1(_0602_),
    .C1(_0612_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0613_));
 sky130_fd_sc_hd__a311o_2 _1281_ (.A1(_0531_),
    .A2(_0547_),
    .A3(_0559_),
    .B1(_0560_),
    .C1(_0613_),
    ...
    .VPWR(VPWR),
    .X(_0614_));
 sky130_fd_sc_hd__or4b_2 _1282_ (.A(net30),
    .B(net17),
    .C(_0698_),
    .D_N(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0615_));
 sky130_fd_sc_hd__or3_2 _1283_ (.A(_0149_),
    .B(_0185_),
    .C(_0615_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0616_));
 sky130_fd_sc_hd__nand2b_2 _1284_ (.A_N(_0527_),
    .B(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0617_));
 sky130_fd_sc_hd__a31o_2 _1285_ (.A1(_0614_),
    .A2(_0616_),
    .A3(_0617_),
    .B1(_0119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0618_));
 sky130_fd_sc_hd__a21oi_2 _1286_ (.A1(_0060_),
    .A2(_0618_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net7));
 sky130_fd_sc_hd__a31o_2 _1287_ (.A1(_0113_),
    .A2(_0419_),
    .A3(_0548_),
    .B1(_0552_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0619_));
 sky130_fd_sc_hd__nor2_2 _1288_ (.A(\bgen.v[9] ),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0620_));
 sky130_fd_sc_hd__and2_2 _1289_ (.A(\bgen.v[9] ),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0621_));
 sky130_fd_sc_hd__nor2_2 _1290_ (.A(_0620_),
    .B(_0621_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0622_));
 sky130_fd_sc_hd__xor2_2 _1291_ (.A(\bgen.h[9] ),
    .B(\bgen.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0623_));
 sky130_fd_sc_hd__xnor2_2 _1292_ (.A(_0417_),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0624_));
 sky130_fd_sc_hd__xnor2_2 _1293_ (.A(_0622_),
    .B(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0625_));
 sky130_fd_sc_hd__xnor2_2 _1294_ (.A(_0619_),
    .B(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0626_));
 sky130_fd_sc_hd__xnor2_2 _1295_ (.A(_0554_),
    .B(_0626_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0627_));
 sky130_fd_sc_hd__o21ba_2 _1296_ (.A1(_0557_),
    .A2(_0560_),
    .B1_N(_0627_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0628_));
 sky130_fd_sc_hd__or3b_2 _1297_ (.A(_0557_),
    .B(_0560_),
    .C_N(_0627_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0629_));
 sky130_fd_sc_hd__or3b_2 _1298_ (.A(_0613_),
    .B(_0628_),
    .C_N(_0629_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0630_));
 sky130_fd_sc_hd__nand2_2 _1299_ (.A(_0522_),
    .B(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__a31o_2 _1300_ (.A1(_0616_),
    .A2(_0630_),
    .A3(_0631_),
    .B1(_0119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__a21oi_2 _1301_ (.A1(_0060_),
    .A2(_0632_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net2));
 sky130_fd_sc_hd__and2_2 _1302_ (.A(_0543_),
    .B(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__or3_2 _1303_ (.A(_0545_),
    .B(_0613_),
    .C(_0633_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0634_));
 sky130_fd_sc_hd__nand2_2 _1304_ (.A(_0541_),
    .B(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0635_));
 sky130_fd_sc_hd__a31o_2 _1305_ (.A1(_0616_),
    .A2(_0634_),
    .A3(_0635_),
    .B1(_0119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0636_));
 sky130_fd_sc_hd__a21oi_2 _1306_ (.A1(_0060_),
    .A2(_0636_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__or3_2 _1307_ (.A(_0539_),
    .B(_0545_),
    .C(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0637_));
 sky130_fd_sc_hd__nand2_2 _1308_ (.A(_0547_),
    .B(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0638_));
 sky130_fd_sc_hd__mux2_1 _1309_ (.A0(_0638_),
    .A1(_0536_),
    .S(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__a21o_2 _1310_ (.A1(_0616_),
    .A2(_0639_),
    .B1(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0640_));
 sky130_fd_sc_hd__a21oi_2 _1311_ (.A1(_0060_),
    .A2(_0640_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__xnor2_2 _1312_ (.A(_0495_),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0641_));
 sky130_fd_sc_hd__or2_2 _1313_ (.A(\bgen.counter[0] ),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0642_));
 sky130_fd_sc_hd__nand2_2 _1314_ (.A(_0542_),
    .B(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0643_));
 sky130_fd_sc_hd__mux2_1 _1315_ (.A0(_0643_),
    .A1(_0641_),
    .S(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0644_));
 sky130_fd_sc_hd__a21o_2 _1316_ (.A1(_0616_),
    .A2(_0644_),
    .B1(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0645_));
 sky130_fd_sc_hd__a21oi_2 _1317_ (.A1(_0060_),
    .A2(_0645_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net4));
 sky130_fd_sc_hd__nand2_2 _1318_ (.A(_0540_),
    .B(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0646_));
 sky130_fd_sc_hd__nand2_2 _1319_ (.A(_0543_),
    .B(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0647_));
 sky130_fd_sc_hd__xnor2_2 _1320_ (.A(_0486_),
    .B(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0648_));
 sky130_fd_sc_hd__mux2_1 _1321_ (.A0(_0647_),
    .A1(_0648_),
    .S(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0649_));
 sky130_fd_sc_hd__a21o_2 _1322_ (.A1(_0616_),
    .A2(_0649_),
    .B1(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0650_));
 sky130_fd_sc_hd__a21oi_2 _1323_ (.A1(_0060_),
    .A2(_0650_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net3));
 sky130_fd_sc_hd__nor2_2 _1324_ (.A(_0698_),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0651_));
 sky130_fd_sc_hd__nand2_2 _1325_ (.A(net20),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0652_));
 sky130_fd_sc_hd__and3b_2 _1326_ (.A_N(\bgen.h[7] ),
    .B(\bgen.h[8] ),
    .C(\bgen.h[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0653_));
 sky130_fd_sc_hd__and3_2 _1327_ (.A(_0067_),
    .B(_0651_),
    .C(_0653_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__and2b_2 _1328_ (.A_N(_0654_),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0655_));
 sky130_fd_sc_hd__nand2b_2 _1329_ (.A_N(_0654_),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0656_));
 sky130_fd_sc_hd__nand2_2 _1330_ (.A(net37),
    .B(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0657_));
 sky130_fd_sc_hd__or4b_2 _1331_ (.A(net27),
    .B(\bgen.v[7] ),
    .C(\bgen.v[8] ),
    .D_N(\bgen.v[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0658_));
 sky130_fd_sc_hd__or2_2 _1332_ (.A(net37),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0659_));
 sky130_fd_sc_hd__nand2_2 _1333_ (.A(_0126_),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0660_));
 sky130_fd_sc_hd__o31a_2 _1334_ (.A1(_0658_),
    .A2(_0659_),
    .A3(_0660_),
    .B1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0661_));
 sky130_fd_sc_hd__and2_2 _1335_ (.A(_0654_),
    .B(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0662_));
 sky130_fd_sc_hd__o21ai_2 _1336_ (.A1(net37),
    .A2(_0662_),
    .B1(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0663_));
 sky130_fd_sc_hd__inv_2 _1337_ (.A(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__nor2_2 _1338_ (.A(_0139_),
    .B(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0664_));
 sky130_fd_sc_hd__or2_2 _1339_ (.A(_0655_),
    .B(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0665_));
 sky130_fd_sc_hd__a31o_2 _1340_ (.A1(net37),
    .A2(net34),
    .A3(_0656_),
    .B1(\bgen.dy[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0666_));
 sky130_fd_sc_hd__o211a_2 _1341_ (.A1(_0139_),
    .A2(_0657_),
    .B1(_0665_),
    .C1(_0666_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__a32oi_2 _1342_ (.A1(_0247_),
    .A2(_0659_),
    .A3(_0662_),
    .B1(_0655_),
    .B2(net34),
    ...
    .VPWR(VPWR),
    .Y(_0667_));
 sky130_fd_sc_hd__inv_2 _1343_ (.A(_0667_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__and2_2 _1344_ (.A(_0017_),
    .B(_0667_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__nand2_2 _1345_ (.A(_0663_),
    .B(_0667_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0668_));
 sky130_fd_sc_hd__or2_2 _1346_ (.A(_0663_),
    .B(_0667_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0669_));
 sky130_fd_sc_hd__a2bb2o_2 _1347_ (.A1_N(_0669_),
    .A2_N(_0017_),
    .B1(_0663_),
    .B2(_0040_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__nor2_2 _1348_ (.A(_0017_),
    .B(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0035_));
 sky130_fd_sc_hd__and2_2 _1349_ (.A(_0017_),
    .B(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0670_));
 sky130_fd_sc_hd__and2_2 _1350_ (.A(_0015_),
    .B(_0670_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0671_));
 sky130_fd_sc_hd__inv_2 _1351_ (.A(_0671_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0037_));
 sky130_fd_sc_hd__nor2_2 _1352_ (.A(_0035_),
    .B(_0671_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0000_));
 sky130_fd_sc_hd__nor2_2 _1353_ (.A(_0017_),
    .B(_0667_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0038_));
 sky130_fd_sc_hd__nor2_2 _1354_ (.A(_0017_),
    .B(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0036_));
 sky130_fd_sc_hd__o21a_2 _1355_ (.A1(_0035_),
    .A2(_0670_),
    .B1(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__o21bai_2 _1356_ (.A1(_0017_),
    .A2(_0669_),
    .B1_N(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0006_));
 sky130_fd_sc_hd__a21o_2 _1357_ (.A1(_0663_),
    .A2(_0040_),
    .B1(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__nor2_2 _1358_ (.A(_0670_),
    .B(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0003_));
 sky130_fd_sc_hd__nor2_2 _1359_ (.A(_0671_),
    .B(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0004_));
 sky130_fd_sc_hd__or4b_2 _1360_ (.A(_0693_),
    .B(\bgen.dy[2] ),
    .C(net27),
    .D_N(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0672_));
 sky130_fd_sc_hd__or4b_2 _1361_ (.A(_0697_),
    .B(_0672_),
    .C(net57),
    .D_N(_0112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__or4bb_2 _1362_ (.A(\bgen.h[8] ),
    .B(_0105_),
    .C_N(\bgen.h[9] ),
    .D_N(\bgen.h[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__or2_2 _1363_ (.A(net29),
    .B(_0664_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0673_));
 sky130_fd_sc_hd__nand2_2 _1364_ (.A(net29),
    .B(_0664_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0674_));
 sky130_fd_sc_hd__and3_2 _1365_ (.A(_0665_),
    .B(_0673_),
    .C(_0674_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__and4b_2 _1366_ (.A_N(_0247_),
    .B(_0694_),
    .C(_0143_),
    .D(_0662_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0675_));
 sky130_fd_sc_hd__a31o_2 _1367_ (.A1(net27),
    .A2(_0665_),
    .A3(_0674_),
    .B1(_0675_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__nor2_2 _1368_ (.A(_0185_),
    .B(_0674_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0676_));
 sky130_fd_sc_hd__and3_2 _1369_ (.A(net37),
    .B(_0144_),
    .C(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0677_));
 sky130_fd_sc_hd__nand2_2 _1370_ (.A(_0140_),
    .B(_0664_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0678_));
 sky130_fd_sc_hd__o221a_2 _1371_ (.A1(_0185_),
    .A2(_0674_),
    .B1(_0677_),
    .B2(net26),
    .C1(_0665_),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__o221a_2 _1372_ (.A1(net59),
    .A2(_0676_),
    .B1(_0678_),
    .B2(_0111_),
    .C1(_0665_),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__o211a_2 _1373_ (.A1(_0111_),
    .A2(_0678_),
    .B1(_0665_),
    .C1(\bgen.v[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0679_));
 sky130_fd_sc_hd__and3_2 _1374_ (.A(net37),
    .B(_0144_),
    .C(_0662_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0680_));
 sky130_fd_sc_hd__a31o_2 _1375_ (.A1(_0696_),
    .A2(_0110_),
    .A3(_0680_),
    .B1(_0679_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__o21a_2 _1376_ (.A1(_0113_),
    .A2(_0678_),
    .B1(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0681_));
 sky130_fd_sc_hd__o211a_2 _1377_ (.A1(net58),
    .A2(_0677_),
    .B1(_0681_),
    .C1(_0548_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__a22o_2 _1378_ (.A1(_0620_),
    .A2(_0680_),
    .B1(_0681_),
    .B2(net57),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__nor2_2 _1379_ (.A(net24),
    .B(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0025_));
 sky130_fd_sc_hd__and3_2 _1380_ (.A(_0081_),
    .B(_0170_),
    .C(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__nand2_2 _1381_ (.A(_0698_),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0682_));
 sky130_fd_sc_hd__o211a_2 _1382_ (.A1(_0692_),
    .A2(_0176_),
    .B1(_0655_),
    .C1(_0682_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__nor2_2 _1383_ (.A(_0081_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0683_));
 sky130_fd_sc_hd__a31o_2 _1384_ (.A1(net24),
    .A2(net19),
    .A3(net21),
    .B1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0684_));
 sky130_fd_sc_hd__and3b_2 _1385_ (.A_N(_0683_),
    .B(_0684_),
    .C(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__o211a_2 _1386_ (.A1(net54),
    .A2(_0683_),
    .B1(_0652_),
    .C1(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__a21o_2 _1387_ (.A1(_0701_),
    .A2(_0652_),
    .B1(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0685_));
 sky130_fd_sc_hd__a21oi_2 _1388_ (.A1(net12),
    .A2(_0651_),
    .B1(_0685_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0030_));
 sky130_fd_sc_hd__a21oi_2 _1389_ (.A1(net12),
    .A2(_0651_),
    .B1(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0686_));
 sky130_fd_sc_hd__a211oi_2 _1390_ (.A1(_0066_),
    .A2(_0651_),
    .B1(_0656_),
    .C1(_0686_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0031_));
 sky130_fd_sc_hd__a31o_2 _1391_ (.A1(net20),
    .A2(_0066_),
    .A3(_0274_),
    .B1(\bgen.h[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0687_));
 sky130_fd_sc_hd__nand2_2 _1392_ (.A(_0121_),
    .B(_0651_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0688_));
 sky130_fd_sc_hd__and3_2 _1393_ (.A(_0655_),
    .B(_0687_),
    .C(_0688_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__nor2_2 _1394_ (.A(_0417_),
    .B(_0652_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0689_));
 sky130_fd_sc_hd__a211oi_2 _1395_ (.A1(_0702_),
    .A2(_0688_),
    .B1(_0689_),
    .C1(_0656_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0033_));
 sky130_fd_sc_hd__o21ai_2 _1396_ (.A1(\bgen.h[9] ),
    .A2(_0689_),
    .B1(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0690_));
 sky130_fd_sc_hd__a21oi_2 _1397_ (.A1(net55),
    .A2(_0689_),
    .B1(_0690_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0034_));
 sky130_fd_sc_hd__and3b_2 _1398_ (.A_N(_0017_),
    .B(_0668_),
    .C(_0669_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__dfxtp_2 _1399_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1400_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1401_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1402_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1403_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1404_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dy[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1405_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.v[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1406_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.v[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1407_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.v[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1408_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.v[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1409_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1410_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\bgen.dx[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1411_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dx[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1412_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dx[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1413_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dx[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1414_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.dx[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1415_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.h[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1416_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.h[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1417_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.h[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1418_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bgen.h[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1419_ (.CLK(\hvsync_gen.vsync ),
    .D(_0009_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1420_ (.CLK(\hvsync_gen.vsync ),
    .D(_0010_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1421_ (.CLK(\hvsync_gen.vsync ),
    .D(_0011_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1422_ (.CLK(\hvsync_gen.vsync ),
    .D(_0012_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1423_ (.CLK(\hvsync_gen.vsync ),
    .D(_0013_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1424_ (.CLK(\hvsync_gen.vsync ),
    .D(_0014_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\bgen.counter[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1425_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1427_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(_0052_));
 sky130_fd_sc_hd__dfxtp_2 _1428_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0041_));
 sky130_fd_sc_hd__dfxtp_2 _1429_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0046_));
 sky130_fd_sc_hd__dfxtp_2 _1430_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0045_));
 sky130_fd_sc_hd__dfxtp_2 _1431_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0044_));
 sky130_fd_sc_hd__dfxtp_2 _1432_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0043_));
 sky130_fd_sc_hd__dfxtp_2 _1433_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0053_));
 sky130_fd_sc_hd__dfxtp_2 _1434_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0042_));
 sky130_fd_sc_hd__dfxtp_2 _1435_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0051_));
 sky130_fd_sc_hd__dfxtp_2 _1436_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0048_));
 sky130_fd_sc_hd__dfxtp_2 _1437_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0049_));
 sky130_fd_sc_hd__dfxtp_2 _1438_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0050_));
 sky130_fd_sc_hd__dfxtp_2 _1439_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0047_));
 sky130_fd_sc_hd__buf_2 _1456_ (.A(\hvsync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1457_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(\bgen.h[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout13 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\bgen.dx[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\bgen.dx[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(\bgen.dx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(\bgen.dx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net20),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\bgen.dx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout21 (.A(net22),
    ...
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\bgen.dx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net24),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\bgen.dx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s15_2 fanout25 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\bgen.dy[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\bgen.dy[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\bgen.dy[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(\bgen.dy[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(\bgen.dy[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\bgen.dy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(\bgen.dy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout33 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(\bgen.dy[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(\bgen.dy[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\bgen.dx[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\bgen.h[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\bgen.h[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\bgen.v[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\bgen.v[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\bgen.v[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input1 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__buf_2 max_cap38 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__buf_2 max_cap8 (.A(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__buf_2 max_cap9 (.A(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net51));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net52));
 sky130_fd_sc_hd__conb_1 tt_um_algofoogle_dottee_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net53));
