module tt_um_wokwi_457579594627462145 (clk,
 ...
 sky130_fd_sc_hd__conb_1 tt_um_wokwi_457579594627462145_19 (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_wokwi_457579594627462145_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 ...
 sky130_fd_sc_hd__and2_2 \and11/_0_  (.A(net20),
    ...
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__and2_2 \and12/_0_  (.A(net18),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 \and14/_0_  (.A(net3),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__and2_2 \and15/_0_  (.A(net30),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__and2_2 \and16/_0_  (.A(net20),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 \and4/_0_  (.A(net17),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__and2_2 \and5/_0_  (.A(net23),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 \and6/_0_  (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__and2_2 \and7/_0_  (.A(net24),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
